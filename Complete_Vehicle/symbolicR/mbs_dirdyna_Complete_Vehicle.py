...
# Backward Dynamics 
  ...
  CF110 = -(s.trq[1,10]-CF11_112-CF13_114-s.In[1,10]*OpF110+FA210*s.l[3,10]+OM210*OM310*(s.In[5,10]-s.In[9,10])+\
   s.dpt[3,14]*(FA212*C11-FA312*S11))
  CF210 = -(s.trq[2,10]-s.In[5,10]*OpF29-CF11_212*C11+CF13_314*S13-CF214*C13+CF312*S11-FA110*s.l[3,10]-FA112*s.dpt[3,14]\
  ...
  CM210_4 = s.In[5,10]*OpM29_4+CM114_212*C11-CM134_314*S13+CM214_4*C13-CM312_4*S11+FB110_4*s.l[3,10]+FB112_4*s.dpt[3,14]
  ...
  CM210_5 = s.In[5,10]*OpM29_5+CM115_212*C11-CM135_314*S13+CM214_5*C13-CM312_5*S11+FB110_5*s.l[3,10]+FB112_5*s.dpt[3,14]
  ...
  CM210_6 = s.In[5,10]*OpM29_6+CM116_212*C11-CM136_314*S13+CM214_6*C13-CM312_6*S11+FB110_6*s.l[3,10]+FB112_6*s.dpt[3,14]
  ...
  CM210_7 = s.In[5,10]*OpM29_7+CM117_212*C11-CM137_314*S13+CM214_7*C13-CM312_7*S11+FB110_7*s.l[3,10]+FB112_7*s.dpt[3,14]
  ...
  CM110_8 = CM118_112+CM138_114+s.In[1,10]*OpM110_8+s.m[10]*OpM110_8*s.l[3,10]*s.l[3,10]-s.dpt[3,14]*(FB212_8*C11-\
   FB312_8*S11)
  CM210_8 = CM118_212*C11-CM138_314*S13+CM214_8*C13-CM312_8*S11+FB112_8*s.dpt[3,14]+S9*(s.In[5,10]+s.m[10]*s.l[3,10]*\
   s.l[3,10])
  ...
  CM210_10 = s.In[5,10]+s.In[9,12]*S11*S11+s.m[10]*s.l[3,10]*s.l[3,10]+CM214_10*C13+FB112_10*s.dpt[3,14]+C11*(q[12]*\
   FB112_10+s.In[5,12]*C11+FB112_10*s.l[3,12])+S13*(CM114_10*S14-CM314_10*C14)
...
# Backward Dynamics 
  ...
  CM118_16 = CM1916_120+CM2116_122+s.In[1,18]*OpM118_16+s.m[18]*OpM118_16*s.l[3,18]*s.l[3,18]-s.dpt[3,19]*(FB220_16*C19-\
   FB320_16*S19)
  CM218_16 = CM1916_220*C19-CM2116_322*S21+CM222_16*C21-CM320_16*S19+FB120_16*s.dpt[3,19]+S17*(s.In[5,18]+s.m[18]*\
   s.l[3,18]*s.l[3,18])
  ...
  CM218_18 = s.In[5,18]+s.In[9,20]*S19*S19+s.m[18]*s.l[3,18]*s.l[3,18]+CM222_18*C21+FB120_18*s.dpt[3,19]+C19*(q[20]*\
   FB120_18+s.In[5,20]*C19+FB120_18*s.l[3,20])+S21*(CM122_18*S22-CM322_18*C22)
...
# Backward Dynamics 
  ...
  CF124 = -(s.trq[1,24]-CF25_126-s.In[1,24]*OpF124-s.In[9,24]*OM224*OM324-FA324*s.l[2,24]-s.dpt[2,23]*(FF25_226*S25+\
   FF326*C25))
  CF224 = -(s.trq[2,24]-CF25_226*C25+CF326*S25-OM124*OM324*(s.In[1,24]-s.In[9,24]))
  CF324 = -(s.trq[3,24]+s.In[1,24]*OM124*OM224-s.In[9,24]*OpF323-CF25_226*S25-CF326*C25+FA124*s.l[2,24]+FF25_126*\
   s.dpt[2,23])
  ...
  CM244_225 = CM254_226*C25-CM326_4*S25
  ...
  CM245_225 = CM255_226*C25-CM326_5*S25
  ...
  CM236_124 = C24*(CM256_126+s.In[1,24]*C24+FB324_6*s.l[2,24]+s.dpt[2,23]*(FM256_226*S25+FM326_6*C25))-S24*(CM256_226*\
   C25-CM326_6*S25)
  CM2323_124 = C24*(CM2523_126+s.In[1,24]*C24+s.m[24]*s.l[2,24]*s.l[2,24]*C24+s.dpt[2,23]*(C25*(s.m[26]*AlM325_23+\
   FB228_23*S27+FB230_23*S29+FB328_23*C27+FM2923_330*C29)+S25*(FM126_23*S26+FM226_23*C26)))-S24*(CM2523_226*C25-CM326_23*S25)
...
# Backward Dynamics 
  ...
  CF132 = -(s.trq[1,32]-CF33_134-s.In[1,32]*OpF132-s.In[9,32]*OM232*OM332-FA332*s.l[2,32]-s.dpt[2,30]*(FF334*C33+\
   FF33_234*S33))
  CF232 = -(s.trq[2,32]+CF334*S33-CF33_234*C33-OM132*OM332*(s.In[1,32]-s.In[9,32]))
  CF332 = -(s.trq[3,32]+s.In[1,32]*OM132*OM232-s.In[9,32]*OpF331-CF334*C33-CF33_234*S33+FA132*s.l[2,32]+FF33_134*\
   s.dpt[2,30])
  ...
  CM324_233 = CM334_234*C33-CM334_4*S33
  ...
  CM325_233 = -(CM334_5*S33-CM335_234*C33)
  ...
  CM314_132 = CM132_4*C32-CM324_233*S32
  CM314_232 = CM132_4*S32+CM324_233*C32
  FM315_232 = FM132_5*S32+FM232_5*C32
  CM315_132 = CM132_5*C32-CM325_233*S32
  CM315_232 = CM132_5*S32+CM325_233*C32
  CM316_132 = C32*(CM336_134+s.In[1,32]*C32+FB332_6*s.l[2,32]+s.dpt[2,30]*(FM334_6*C33+FM336_234*S33))+S32*(CM334_6*S33-\
   CM336_234*C33)
  CM3131_132 = C32*(CM3331_134+s.In[1,32]*C32+s.m[32]*s.l[2,32]*s.l[2,32]*C32+s.dpt[2,30]*(C33*(s.m[34]*AlM333_31+\
   FB236_31*S35+FB238_31*S37+FB336_31*C35+FM3731_338*C37)+S33*(FM134_31*S34+FM234_31*C34)))-S32*(CM3331_234*C33-CM334_31*S33)
