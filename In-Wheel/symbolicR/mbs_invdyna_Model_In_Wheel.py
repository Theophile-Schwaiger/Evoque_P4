...
#
#	==> Generation Date : Sat May  2 23:53:35 2020
#
...
# Forward Kinematics 
  ...
  OMp38 = qdd[8]+OMp37
  ALPHA18 = C8*(ALPHA17+BETA27*s.dpt[2,16])+S8*(ALPHA27+BS57*s.dpt[2,16])
  ALPHA28 = C8*(ALPHA27+BS57*s.dpt[2,16])-S8*(ALPHA17+BETA27*s.dpt[2,16])
  ALPHA38 = ALPHA37+BETA87*s.dpt[2,16]
  ...
  ALPHA113 = ALPHA110+BETA210*s.dpt[2,18]+BETA310*s.dpt[3,18]
  ALPHA313 = C13*(ALPHA310+BETA810*s.dpt[2,18]+BS910*s.dpt[3,18])-S13*(ALPHA29+BETA610*s.dpt[3,18]+BS510*s.dpt[2,18])
  ...
  ALPHA116 = C16*(ALPHA115+BETA215*s.dpt[2,23])+S16*(ALPHA215+BS515*s.dpt[2,23])
  ALPHA216 = C16*(ALPHA215+BS515*s.dpt[2,23])-S16*(ALPHA115+BETA215*s.dpt[2,23])
  ALPHA316 = ALPHA315+BETA815*s.dpt[2,23]
  ...
  ALPHA121 = ALPHA118+BETA218*s.dpt[2,25]+BETA318*s.dpt[3,25]
  ALPHA321 = C21*(ALPHA318+BETA818*s.dpt[2,25]+BS918*s.dpt[3,25])-S21*(ALPHA217+BETA618*s.dpt[3,25]+BS518*s.dpt[2,25])
  ...
  ALPHA131 = ALPHA130+BETA230*s.dpt[2,33]
  ALPHA231 = C31*(ALPHA230+BS530*s.dpt[2,33])+S31*(ALPHA329+BETA830*s.dpt[2,33])
  ALPHA331 = C31*(ALPHA329+BETA830*s.dpt[2,33])-S31*(ALPHA230+BS530*s.dpt[2,33])
  ...
  ALPHA136 = ALPHA133+BETA233*s.dpt[2,35]+BETA333*s.dpt[3,35]
  ALPHA336 = C36*(ALPHA332+BETA833*s.dpt[2,35]+BS933*s.dpt[3,35])-S36*(ALPHA233+BETA633*s.dpt[3,35]+BS533*s.dpt[2,35])
  ...
  ALPHA142 = ALPHA141+BETA241*s.dpt[2,42]
  ALPHA242 = C42*(ALPHA241+BS541*s.dpt[2,42])+S42*(ALPHA340+BETA841*s.dpt[2,42])
  ALPHA342 = C42*(ALPHA340+BETA841*s.dpt[2,42])-S42*(ALPHA241+BS541*s.dpt[2,42])
  ...
  ALPHA147 = ALPHA144+BETA244*s.dpt[2,46]+BETA344*s.dpt[3,46]
  ALPHA347 = C47*(ALPHA343+BETA844*s.dpt[2,46]+BS944*s.dpt[3,46])-S47*(ALPHA244+BETA644*s.dpt[3,46]+BS544*s.dpt[2,46])
  ...
  OM350 = qd[50]+OM36
  ALPHA250 = C50*(ALPHA249+BS549*s.dpt[2,50])-S50*(ALPHA149+BETA249*s.dpt[2,50])
  ALPHA350 = ALPHA349+BETA849*s.dpt[2,50]
  ...
  OM352 = qd[52]+OM36
  ALPHA252 = C52*(ALPHA249+BS549*s.dpt[2,51])-S52*(ALPHA149+BETA249*s.dpt[2,51])
  ALPHA352 = ALPHA349+BETA849*s.dpt[2,51]
  ...
  ALPHA256 = ALPHA254+BETA455*s.dpt[1,55]+BS555*s.dpt[2,55]
  ALPHA356 = C56*(ALPHA355+BETA755*s.dpt[1,55]+BETA855*s.dpt[2,55])+S56*(ALPHA155+BETA255*s.dpt[2,55]+BS155*s.dpt[1,55])
  ...
  ALPHA258 = ALPHA254+BETA454*s.dpt[1,54]+BS554*s.dpt[2,54]
  ALPHA358 = C58*(ALPHA354+BETA754*s.dpt[1,54]+BETA854*s.dpt[2,54])+S58*(ALPHA154+BETA254*s.dpt[2,54]+BS154*s.dpt[1,54])
  ...
  ALPHA262 = ALPHA260+BETA461*s.dpt[1,59]+BS561*s.dpt[2,59]
  ALPHA362 = C62*(ALPHA361+BETA761*s.dpt[1,59]+BETA861*s.dpt[2,59])+S62*(ALPHA161+BETA261*s.dpt[2,59]+BS161*s.dpt[1,59])
  ...
  ALPHA264 = ALPHA260+BETA460*s.dpt[1,58]+BS560*s.dpt[2,58]
  ALPHA364 = C64*(ALPHA360+BETA760*s.dpt[1,58]+BETA860*s.dpt[2,58])+S64*(ALPHA160+BETA260*s.dpt[2,58]+BS160*s.dpt[1,58])
...
# Backward Dynamics 
  ...
  Fs165 = -(s.frc[1,65]-s.m[65]*(s.l[3,65]*(OMp265+OM165*OM365)+C64*(ALPHA160+BETA260*s.dpt[2,58]+BS160*s.dpt[1,58])-S64\
   *(ALPHA360+BETA760*s.dpt[1,58]+BETA860*s.dpt[2,58])))
  ...
  Fs163 = -(s.frc[1,63]-s.m[63]*(s.l[3,63]*(OMp263+OM163*OM363)+C62*(ALPHA161+BETA261*s.dpt[2,59]+BS161*s.dpt[1,59])-S62\
   *(ALPHA361+BETA761*s.dpt[1,59]+BETA861*s.dpt[2,59])))
  ...
  Cq161 = -(s.trq[1,61]+s.In[5,61]*OM261*OM361-Cq163*C62-Cq362*S62-Fs361*s.l[2,61]-s.dpt[2,59]*(Fq362*C62-Fs163*S62))
  Cq261 = -(s.trq[2,61]-Cq262-s.In[5,61]*OMp261+Fs361*s.l[1,61]+s.dpt[1,59]*(Fq362*C62-Fs163*S62))
  Cq361 = -(s.trq[3,61]-s.In[5,61]*OM161*OM261+Cq163*S62-Cq362*C62-Fq262*s.dpt[1,59]+Fs161*s.l[2,61]-Fs261*s.l[1,61]+\
   s.dpt[2,59]*(Fq362*S62+Fs163*C62))
  ...
  Cq160 = -(s.trq[1,60]+s.In[5,60]*OM260*OM360-Cq161*C61-Cq165*C64-Cq361*S61-Cq364*S64-Fs360*s.l[2,60]-s.dpt[2,58]*(\
   Fq364*C64-Fs165*S64))
  Cq260 = -(s.trq[2,60]-Cq261-Cq264-s.In[5,60]*OMp260+Fs360*s.l[1,60]+s.dpt[1,58]*(Fq364*C64-Fs165*S64))
  Cq360 = -(s.trq[3,60]-s.In[5,60]*OM160*OM260+Cq161*S61+Cq165*S64-Cq361*C61-Cq364*C64-Fq264*s.dpt[1,58]+Fs160*s.l[2,60]\
   -Fs260*s.l[1,60]+s.dpt[2,58]*(Fq364*S64+Fs165*C64))
  Fs159 = -(s.frc[1,59]-s.m[59]*(s.l[3,59]*(OMp259+OM159*OM359)+C58*(ALPHA154+BETA254*s.dpt[2,54]+BS154*s.dpt[1,54])-S58\
   *(ALPHA354+BETA754*s.dpt[1,54]+BETA854*s.dpt[2,54])))
  ...
  Fs157 = -(s.frc[1,57]-s.m[57]*(s.l[3,57]*(OMp257+OM157*OM357)+C56*(ALPHA155+BETA255*s.dpt[2,55]+BS155*s.dpt[1,55])-S56\
   *(ALPHA355+BETA755*s.dpt[1,55]+BETA855*s.dpt[2,55])))
  ...
  Cq155 = -(s.trq[1,55]+s.In[5,55]*OM255*OM355-Cq157*C56-Cq356*S56-Fs355*s.l[2,55]-s.dpt[2,55]*(Fq356*C56-Fs157*S56))
  Cq255 = -(s.trq[2,55]-Cq256-s.In[5,55]*OMp255+Fs355*s.l[1,55]+s.dpt[1,55]*(Fq356*C56-Fs157*S56))
  Cq355 = -(s.trq[3,55]-s.In[5,55]*OM155*OM255+Cq157*S56-Cq356*C56-Fq256*s.dpt[1,55]+Fs155*s.l[2,55]-Fs255*s.l[1,55]+\
   s.dpt[2,55]*(Fq356*S56+Fs157*C56))
  ...
  Cq154 = -(s.trq[1,54]+s.In[5,54]*OM254*OM354-Cq155*C55-Cq159*C58-Cq355*S55-Cq358*S58-Fs354*s.l[2,54]-s.dpt[2,54]*(\
   Fq358*C58-Fs159*S58))
  Cq254 = -(s.trq[2,54]-Cq255-Cq258-s.In[5,54]*OMp254+Fs354*s.l[1,54]+s.dpt[1,54]*(Fq358*C58-Fs159*S58))
  Cq354 = -(s.trq[3,54]-s.In[5,54]*OM154*OM254+Cq155*S55+Cq159*S58-Cq355*C55-Cq358*C58-Fq258*s.dpt[1,54]+Fs154*s.l[2,54]\
   -Fs254*s.l[1,54]+s.dpt[2,54]*(Fq358*S58+Fs159*C58))
  Fs153 = -(s.frc[1,53]+s.m[53]*(s.l[2,53]*(OMp353-OM153*OM253)-C52*(ALPHA149+BETA249*s.dpt[2,51])-S52*(ALPHA249+BS549*\
   s.dpt[2,51])))
  ...
  Fs151 = -(s.frc[1,51]+s.m[51]*(s.l[2,51]*(OMp351-OM151*OM251)-C50*(ALPHA149+BETA249*s.dpt[2,50])-S50*(ALPHA249+BS549*\
   s.dpt[2,50])))
  ...
  Fs248 = -(s.frc[2,48]-s.m[48]*(C47*(ALPHA244+BETA644*s.dpt[3,46]+BS544*s.dpt[2,46])+S47*(ALPHA343+BETA844*s.dpt[2,46]+\
   BS944*s.dpt[3,46])))
  ...
  Fs146 = -(s.frc[1,46]-s.m[46]*(ALPHA144+q[46]*(OMp245+OM145*OM345)+(2.0)*qd[46]*OM245+BETA244*s.dpt[2,45]+BETA344*\
   s.dpt[3,45]+s.l[3,46]*(OMp245+OM145*OM345)))
  Fs246 = -(s.frc[2,46]+s.m[46]*(q[46]*(OMp145-OM245*OM345)+(2.0)*qd[46]*OM145+s.l[3,46]*(OMp145-OM245*OM345)-C45*(ALPHA244+\
   BETA644*s.dpt[3,45]+BS544*s.dpt[2,45])-S45*(ALPHA343+BETA844*s.dpt[2,45]+BS944*s.dpt[3,45])))
  Fs346 = -(s.frc[3,46]-s.m[46]*(qdd[46]-q[46]*(OM145*OM145+OM245*OM245)-s.l[3,46]*(OM145*OM145+OM245*OM245)+C45*(\
   ALPHA343+BETA844*s.dpt[2,45]+BS944*s.dpt[3,45])-S45*(ALPHA244+BETA644*s.dpt[3,45]+BS544*s.dpt[2,45])))
  ...
  Cq144 = -(s.trq[1,44]-Cq145-Cq147-s.In[1,44]*OMp144+Fs244*s.l[3,44]-Fs344*s.l[2,44]+OM244*OM344*(s.In[5,44]-s.In[9,44]\
   )-s.dpt[2,45]*(Fs246*S45+Fs346*C45)-s.dpt[2,46]*(Fq347*C47+Fs248*S47)+s.dpt[3,45]*(Fs246*C45-Fs346*S45)-s.dpt[3,46]*(Fq347*\
   S47-Fs248*C47))
  Cq244 = -(s.trq[2,44]-s.In[5,44]*OMp244-Cq245*C45-Cq248*C47+Cq346*S45+Cq347*S47-Fq147*s.dpt[3,46]-Fs144*s.l[3,44]-\
   Fs146*s.dpt[3,45]-OM144*OM344*(s.In[1,44]-s.In[9,44]))
  Cq344 = -(s.trq[3,44]-s.In[9,44]*OMp344-Cq245*S45-Cq248*S47-Cq346*C45-Cq347*C47+Fq147*s.dpt[2,46]+Fs144*s.l[2,44]+\
   Fs146*s.dpt[2,45]+OM144*OM244*(s.In[1,44]-s.In[5,44]))
  ...
  Cq141 = -(s.trq[1,41]-Cq142-s.In[1,41]*OMp141-s.In[9,41]*OM241*OM341-Fs341*s.l[2,41]-s.dpt[2,42]*(Fq243*S42+Fq342*C42)\
   )
  Cq241 = -(s.trq[2,41]-Cq243*C42+Cq342*S42-OM141*OM341*(s.In[1,41]-s.In[9,41]))
  Cq341 = -(s.trq[3,41]+s.In[1,41]*OM141*OM241-s.In[9,41]*OMp341-Cq243*S42-Cq342*C42+Fq142*s.dpt[2,42]+Fs141*s.l[2,41])
  ...
  Fs237 = -(s.frc[2,37]-s.m[37]*(C36*(ALPHA233+BETA633*s.dpt[3,35]+BS533*s.dpt[2,35])+S36*(ALPHA332+BETA833*s.dpt[2,35]+\
   BS933*s.dpt[3,35])))
  ...
  Fs135 = -(s.frc[1,35]-s.m[35]*(ALPHA133+q[35]*(OMp234+OM134*OM334)+(2.0)*qd[35]*OM234+BETA233*s.dpt[2,34]+BETA333*\
   s.dpt[3,34]+s.l[3,35]*(OMp234+OM134*OM334)))
  Fs235 = -(s.frc[2,35]+s.m[35]*(q[35]*(OMp134-OM234*OM334)+(2.0)*qd[35]*OM134+s.l[3,35]*(OMp134-OM234*OM334)-C34*(ALPHA233+\
   BETA633*s.dpt[3,34]+BS533*s.dpt[2,34])-S34*(ALPHA332+BETA833*s.dpt[2,34]+BS933*s.dpt[3,34])))
  Fs335 = -(s.frc[3,35]-s.m[35]*(qdd[35]-q[35]*(OM134*OM134+OM234*OM234)-s.l[3,35]*(OM134*OM134+OM234*OM234)+C34*(\
   ALPHA332+BETA833*s.dpt[2,34]+BS933*s.dpt[3,34])-S34*(ALPHA233+BETA633*s.dpt[3,34]+BS533*s.dpt[2,34])))
  ...
  Cq133 = -(s.trq[1,33]-Cq134-Cq136-s.In[1,33]*OMp133+Fs233*s.l[3,33]-Fs333*s.l[2,33]+OM233*OM333*(s.In[5,33]-s.In[9,33]\
   )-s.dpt[2,34]*(Fs235*S34+Fs335*C34)-s.dpt[2,35]*(Fq336*C36+Fs237*S36)+s.dpt[3,34]*(Fs235*C34-Fs335*S34)-s.dpt[3,35]*(Fq336*\
   S36-Fs237*C36))
  Cq233 = -(s.trq[2,33]-s.In[5,33]*OMp233-Cq234*C34-Cq237*C36+Cq335*S34+Cq336*S36-Fq136*s.dpt[3,35]-Fs133*s.l[3,33]-\
   Fs135*s.dpt[3,34]-OM133*OM333*(s.In[1,33]-s.In[9,33]))
  Cq333 = -(s.trq[3,33]-s.In[9,33]*OMp333-Cq234*S34-Cq237*S36-Cq335*C34-Cq336*C36+Fq136*s.dpt[2,35]+Fs133*s.l[2,33]+\
   Fs135*s.dpt[2,34]+OM133*OM233*(s.In[1,33]-s.In[5,33]))
  ...
  Cq130 = -(s.trq[1,30]-Cq131-s.In[1,30]*OMp130-s.In[9,30]*OM230*OM330-Fs330*s.l[2,30]-s.dpt[2,33]*(Fq232*S31+Fq331*C31)\
   )
  Cq230 = -(s.trq[2,30]-Cq232*C31+Cq331*S31-OM130*OM330*(s.In[1,30]-s.In[9,30]))
  Cq330 = -(s.trq[3,30]+s.In[1,30]*OM130*OM230-s.In[9,30]*OMp330-Cq232*S31-Cq331*C31+Fq131*s.dpt[2,33]+Fs130*s.l[2,30])
  ...
  Fs222 = -(s.frc[2,22]-s.m[22]*(C21*(ALPHA217+BETA618*s.dpt[3,25]+BS518*s.dpt[2,25])+S21*(ALPHA318+BETA818*s.dpt[2,25]+\
   BS918*s.dpt[3,25])))
  ...
  Fs120 = -(s.frc[1,20]-s.m[20]*(ALPHA118+q[20]*(OMp219+OM119*OM319)+(2.0)*qd[20]*OM219+BETA218*s.dpt[2,24]+BETA318*\
   s.dpt[3,24]+s.l[3,20]*(OMp219+OM119*OM319)))
  Fs220 = -(s.frc[2,20]+s.m[20]*(q[20]*(OMp119-OM219*OM319)+(2.0)*qd[20]*OM119+s.l[3,20]*(OMp119-OM219*OM319)-C19*(ALPHA217+\
   BETA618*s.dpt[3,24]+BS518*s.dpt[2,24])-S19*(ALPHA318+BETA818*s.dpt[2,24]+BS918*s.dpt[3,24])))
  Fs320 = -(s.frc[3,20]-s.m[20]*(qdd[20]-q[20]*(OM119*OM119+OM219*OM219)-s.l[3,20]*(OM119*OM119+OM219*OM219)+C19*(\
   ALPHA318+BETA818*s.dpt[2,24]+BS918*s.dpt[3,24])-S19*(ALPHA217+BETA618*s.dpt[3,24]+BS518*s.dpt[2,24])))
  ...
  Cq118 = -(s.trq[1,18]-Cq119-Cq121-s.In[1,18]*OMp118+Fs218*s.l[3,18]+OM218*OM318*(s.In[5,18]-s.In[9,18])-s.dpt[2,24]*(\
   Fs220*S19+Fs320*C19)-s.dpt[2,25]*(Fq321*C21+Fs222*S21)+s.dpt[3,24]*(Fs220*C19-Fs320*S19)-s.dpt[3,25]*(Fq321*S21-Fs222*C21))
  Cq218 = -(s.trq[2,18]-s.In[5,18]*OMp218-Cq219*C19-Cq222*C21+Cq320*S19+Cq321*S21-Fq121*s.dpt[3,25]-Fs118*s.l[3,18]-\
   Fs120*s.dpt[3,24]-OM118*OM318*(s.In[1,18]-s.In[9,18]))
  Cq318 = -(s.trq[3,18]-s.In[9,18]*OMp318-Cq219*S19-Cq222*S21-Cq320*C19-Cq321*C21+Fq121*s.dpt[2,25]+Fs120*s.dpt[2,24]+\
  ...
  Fq315 = Fq316+Fs315
  Cq115 = -(s.trq[1,15]-s.In[1,15]*OMp115-Cq117*C16+Cq216*S16-Fq316*s.dpt[2,23]-Fs315*s.l[2,15])
  Cq215 = -(s.trq[2,15]-s.In[1,15]*OM115*OM315-Cq117*S16-Cq216*C16+Fs315*s.l[1,15])
  Cq315 = -(s.trq[3,15]-Cq316+s.In[1,15]*OM115*OM215+Fs115*s.l[2,15]-Fs215*s.l[1,15]+s.dpt[2,23]*(Fq117*C16-Fq216*S16))
  Fs114 = -(s.frc[1,14]-s.m[14]*(ALPHA113*C14-ALPHA313*S14))
  Fs214 = -(s.frc[2,14]-s.m[14]*(C13*(ALPHA29+BETA610*s.dpt[3,18]+BS510*s.dpt[2,18])+S13*(ALPHA310+BETA810*s.dpt[2,18]+\
   BS910*s.dpt[3,18])))
  ...
  Fs112 = -(s.frc[1,12]-s.m[12]*(ALPHA110+q[12]*(OMp211+OM111*OM311)+(2.0)*qd[12]*OM211+BETA210*s.dpt[2,17]+BETA310*\
   s.dpt[3,17]+s.l[3,12]*(OMp211+OM111*OM311)))
  Fs212 = -(s.frc[2,12]+s.m[12]*(q[12]*(OMp111-OM211*OM311)+(2.0)*qd[12]*OM111+s.l[3,12]*(OMp111-OM211*OM311)-C11*(ALPHA29+\
   BETA610*s.dpt[3,17]+BS510*s.dpt[2,17])-S11*(ALPHA310+BETA810*s.dpt[2,17]+BS910*s.dpt[3,17])))
  Fs312 = -(s.frc[3,12]-s.m[12]*(qdd[12]-q[12]*(OM111*OM111+OM211*OM211)-s.l[3,12]*(OM111*OM111+OM211*OM211)+C11*(\
   ALPHA310+BETA810*s.dpt[2,17]+BS910*s.dpt[3,17])-S11*(ALPHA29+BETA610*s.dpt[3,17]+BS510*s.dpt[2,17])))
  ...
  Cq110 = -(s.trq[1,10]-Cq111-Cq113-s.In[1,10]*OMp110+Fs210*s.l[3,10]+OM210*OM310*(s.In[5,10]-s.In[9,10])-s.dpt[2,17]*(\
   Fs212*S11+Fs312*C11)-s.dpt[2,18]*(Fq313*C13+Fs214*S13)+s.dpt[3,17]*(Fs212*C11-Fs312*S11)-s.dpt[3,18]*(Fq313*S13-Fs214*C13))
  Cq210 = -(s.trq[2,10]-s.In[5,10]*OMp210-Cq211*C11-Cq214*C13+Cq312*S11+Cq313*S13-Fq113*s.dpt[3,18]-Fs110*s.l[3,10]-\
   Fs112*s.dpt[3,17]-OM110*OM310*(s.In[1,10]-s.In[9,10]))
  Cq310 = -(s.trq[3,10]-s.In[9,10]*OMp310-Cq211*S11-Cq214*S13-Cq312*C11-Cq313*C13+Fq113*s.dpt[2,18]+Fs112*s.dpt[2,17]+\
  ...
  Fq37 = Fq38+Fs37
  Cq17 = -(s.trq[1,7]-s.In[1,7]*OMp17-Cq19*C8+Cq28*S8-Fq38*s.dpt[2,16]-Fs37*s.l[2,7])
  Cq27 = -(s.trq[2,7]-s.In[1,7]*OM17*OM37-Cq19*S8-Cq28*C8+Fs37*s.l[1,7])
  Cq37 = -(s.trq[3,7]-Cq38+s.In[1,7]*OM17*OM27+Fs17*s.l[2,7]-Fs27*s.l[1,7]+s.dpt[2,16]*(Fq19*C8-Fq28*S8))
  ...
  Cq16 = -(s.trq[1,49]+s.trq[1,6]-Cq115-Cq123-Cq125-Cq127-Cq129-Cq138-Cq140-Cq17-q[49]*Fq349-s.In[1,6]*OMp16-Cq151*C50-\
   Cq153*C52-Cq154*C54-Cq160*C60+Cq250*S50+Cq252*S52-Cq354*S54-Cq360*S60+Fq254*s.dpt[3,14]+Fq260*s.dpt[3,15]-Fq350*s.dpt[2,50]-\
   Fq352*s.dpt[2,51]+Fs26*s.l[3,6]+OM26*OM36*(s.In[5,6]-s.In[9,6])-s.dpt[2,10]*(Fq229*S29+Fq330*C29)-s.dpt[2,11]*(Fq238*S38+\
  ...
  Cq36 = -(s.trq[3,49]+s.trq[3,6]-Cq350-Cq352+q[49]*Fq149-s.In[9,6]*OMp36+Cq154*S54+Cq160*S60-Cq215*S15-Cq223*S23-Cq225*\
   ...
   s.dpt[1,9]*(Fq227*C27-Fs328*S27)-s.dpt[2,50]*(Fq250*S50-Fs151*C50)-s.dpt[2,51]*(Fq252*S52-Fs153*C52))
