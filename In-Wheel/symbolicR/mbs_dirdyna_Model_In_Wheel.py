...
#
#	==> Generation Date : Sat May  2 23:53:36 2020
#
...
# Forward Kinematics 
  ...
  AlF18 = C8*(AlF17+BeF27*s.dpt[2,16])+S8*(AlF27+BS57*s.dpt[2,16])
  AlF28 = C8*(AlF27+BS57*s.dpt[2,16])-S8*(AlF17+BeF27*s.dpt[2,16])
  AlF38 = AlF37+BeF87*s.dpt[2,16]
  ...
  AlM18_4 = AlM27_4*S8+C8*(AlM17_4-OpM37_4*s.dpt[2,16])
  AlM28_4 = AlM27_4*C8-S8*(AlM17_4-OpM37_4*s.dpt[2,16])
  AlM38_4 = AlM37_4-s.dpt[2,16]*S5
  OpM18_5 = C6p7*S8
  OpM28_5 = C6p7*C8
  AlM18_5 = AlM27_5*S8+C8*(AlM17_5+s.dpt[2,16]*S6p7)
  AlM28_5 = AlM27_5*C8-S8*(AlM17_5+s.dpt[2,16]*S6p7)
  AlM18_6 = AlM27_6*S8
  AlM28_6 = AlM27_6*C8
  AlM38_6 = AlM37_6+s.dpt[2,16]
  ...
  OpM29_7 = -S8*C9
  OpM39_7 = S8*S9
  AlM29_7 = s.dpt[2,16]*S9
  AlM39_7 = s.dpt[2,16]*C9
...
# Forward Kinematics 
  ...
  AlF116 = C16*(AlF115+BeF215*s.dpt[2,23])+S16*(AlF215+BS515*s.dpt[2,23])
  AlF216 = C16*(AlF215+BS515*s.dpt[2,23])-S16*(AlF115+BeF215*s.dpt[2,23])
  AlF316 = AlF315+BeF815*s.dpt[2,23]
  ...
  AlM116_4 = AlM215_4*S16+C16*(AlM115_4-OpM315_4*s.dpt[2,23])
  AlM216_4 = AlM215_4*C16-S16*(AlM115_4-OpM315_4*s.dpt[2,23])
  AlM316_4 = AlM315_4-s.dpt[2,23]*S5
  OpM116_5 = C15p6*S16
  OpM216_5 = C15p6*C16
  AlM116_5 = AlM215_5*S16+C16*(AlM115_5+s.dpt[2,23]*S15p6)
  AlM216_5 = AlM215_5*C16-S16*(AlM115_5+s.dpt[2,23]*S15p6)
  AlM116_6 = AlM215_6*S16
  AlM216_6 = AlM215_6*C16
  AlM316_6 = AlM315_6+s.dpt[2,23]
  ...
  OpM217_15 = -S16*C17
  OpM317_15 = S16*S17
  AlM217_15 = s.dpt[2,23]*S17
  AlM317_15 = s.dpt[2,23]*C17
...
# Forward Kinematics 
  ...
  AlF131 = AlF130+BeF230*s.dpt[2,33]
  AlF231 = C31*(AlF230+BS530*s.dpt[2,33])+S31*(AlF329+BeF830*s.dpt[2,33])
  AlF331 = C31*(AlF329+BeF830*s.dpt[2,33])-S31*(AlF230+BS530*s.dpt[2,33])
  ...
  AlM131_4 = AlM130_4-OpM329_4*s.dpt[2,33]
  AlM231_4 = AlM230_4*C31+S31*(AlM329_4+OpM130_4*s.dpt[2,33])
  AlM331_4 = -(AlM230_4*S31-C31*(AlM329_4+OpM130_4*s.dpt[2,33]))
  OpM231_5 = OpM230_5*C31-S29p6*S31
  OpM331_5 = -(OpM230_5*S31+S29p6*C31)
  AlM131_5 = AlM130_5+s.dpt[2,33]*S29p6
  AlM231_5 = AlM230_5*C31+S31*(AlM329_5+OpM130_5*s.dpt[2,33])
  AlM331_5 = -(AlM230_5*S31-C31*(AlM329_5+OpM130_5*s.dpt[2,33]))
  OpM231_6 = -S30*C31
  OpM331_6 = S30*S31
  AlM231_6 = AlM230_6*C31+S31*(AlM329_6+s.dpt[2,33]*C30)
  AlM331_6 = -(AlM230_6*S31-C31*(AlM329_6+s.dpt[2,33]*C30))
  OpM231_29 = -S30*C31
  OpM331_29 = S30*S31
  AlM231_29 = s.dpt[2,33]*C30*S31
  AlM331_29 = s.dpt[2,33]*C30*C31
  ...
  OpM132_30 = -C31*S32
  OpM332_30 = C31*C32
  AlM132_30 = -s.dpt[2,33]*C32
  AlM332_30 = -s.dpt[2,33]*S32
...
# Forward Kinematics 
  ...
  AlF142 = AlF141+BeF241*s.dpt[2,42]
  AlF242 = C42*(AlF241+BS541*s.dpt[2,42])+S42*(AlF340+BeF841*s.dpt[2,42])
  AlF342 = C42*(AlF340+BeF841*s.dpt[2,42])-S42*(AlF241+BS541*s.dpt[2,42])
  ...
  AlM142_4 = AlM141_4-OpM340_4*s.dpt[2,42]
  AlM242_4 = AlM241_4*C42+S42*(AlM340_4+OpM141_4*s.dpt[2,42])
  AlM342_4 = -(AlM241_4*S42-C42*(AlM340_4+OpM141_4*s.dpt[2,42]))
  OpM242_5 = OpM241_5*C42-S40p6*S42
  OpM342_5 = -(OpM241_5*S42+S40p6*C42)
  AlM142_5 = AlM141_5+s.dpt[2,42]*S40p6
  AlM242_5 = AlM241_5*C42+S42*(AlM340_5+OpM141_5*s.dpt[2,42])
  AlM342_5 = -(AlM241_5*S42-C42*(AlM340_5+OpM141_5*s.dpt[2,42]))
  OpM242_6 = -S41*C42
  OpM342_6 = S41*S42
  AlM242_6 = AlM241_6*C42+S42*(AlM340_6+s.dpt[2,42]*C41)
  AlM342_6 = -(AlM241_6*S42-C42*(AlM340_6+s.dpt[2,42]*C41))
  OpM242_40 = -S41*C42
  OpM342_40 = S41*S42
  AlM242_40 = s.dpt[2,42]*C41*S42
  AlM342_40 = s.dpt[2,42]*C41*C42
  ...
  OpM143_41 = -C42*S43
  OpM343_41 = C42*C43
  AlM143_41 = -s.dpt[2,42]*C43
  AlM343_41 = -s.dpt[2,42]*S43
...
# Forward Kinematics 
  ...
  AlF113 = AlF110+BeF210*s.dpt[2,18]+BeF310*s.dpt[3,18]
  AlF313 = C13*(AlF310+BS910*s.dpt[3,18]+BeF810*s.dpt[2,18])-S13*(AlF29+BS510*s.dpt[2,18]+BeF610*s.dpt[3,18])
  ...
  AlM113_4 = AlM110_4+OpM29_4*s.dpt[3,18]-OpM310_4*s.dpt[2,18]
  AlM313_4 = C13*(AlM310_4+OpM110_4*s.dpt[2,18])-S13*(AlM29_4-OpM110_4*s.dpt[3,18])
  OpM313_5 = -(OpM29_5*S13-OpM310_5*C13)
  AlM113_5 = AlM110_5+OpM29_5*s.dpt[3,18]-OpM310_5*s.dpt[2,18]
  AlM313_5 = C13*(AlM310_5+OpM110_5*s.dpt[2,18])-S13*(AlM29_5-OpM110_5*s.dpt[3,18])
  OpM313_6 = -(OpM29_6*S13-OpM310_6*C13)
  AlM113_6 = AlM110_6+OpM29_6*s.dpt[3,18]-OpM310_6*s.dpt[2,18]
  AlM313_6 = C13*(AlM310_6+OpM110_6*s.dpt[2,18])-S13*(AlM29_6-OpM110_6*s.dpt[3,18])
  OpM313_7 = -(OpM29_7*S13-OpM310_7*C13)
  AlM113_7 = AlM110_7+OpM29_7*s.dpt[3,18]-OpM310_7*s.dpt[2,18]
  AlM313_7 = C13*(AlM310_7+OpM110_7*s.dpt[2,18])-S13*(AlM29_7-OpM110_7*s.dpt[3,18])
  OpM313_8 = OpM310_8*C13-S13*S9
  AlM113_8 = -(OpM310_8*s.dpt[2,18]-s.dpt[3,18]*S9)
  AlM313_8 = OpM110_8*(s.dpt[2,18]*C13+s.dpt[3,18]*S13)
  OpM313_9 = S10*C13
  AlM113_9 = -s.dpt[2,18]*S10
  AlM313_9 = C10*(s.dpt[2,18]*C13+s.dpt[3,18]*S13)
...
# Forward Kinematics 
  ...
  AlF121 = AlF118+BeF218*s.dpt[2,25]+BeF318*s.dpt[3,25]
  AlF321 = C21*(AlF318+BS918*s.dpt[3,25]+BeF818*s.dpt[2,25])-S21*(AlF217+BS518*s.dpt[2,25]+BeF618*s.dpt[3,25])
  ...
  AlM121_4 = AlM118_4+OpM217_4*s.dpt[3,25]-OpM318_4*s.dpt[2,25]
  AlM321_4 = C21*(AlM318_4+OpM118_4*s.dpt[2,25])-S21*(AlM217_4-OpM118_4*s.dpt[3,25])
  OpM321_5 = -(OpM217_5*S21-OpM318_5*C21)
  AlM121_5 = AlM118_5+OpM217_5*s.dpt[3,25]-OpM318_5*s.dpt[2,25]
  AlM321_5 = C21*(AlM318_5+OpM118_5*s.dpt[2,25])-S21*(AlM217_5-OpM118_5*s.dpt[3,25])
  OpM321_6 = -(OpM217_6*S21-OpM318_6*C21)
  AlM121_6 = AlM118_6+OpM217_6*s.dpt[3,25]-OpM318_6*s.dpt[2,25]
  AlM321_6 = C21*(AlM318_6+OpM118_6*s.dpt[2,25])-S21*(AlM217_6-OpM118_6*s.dpt[3,25])
  OpM321_15 = -(OpM217_15*S21-OpM318_15*C21)
  AlM121_15 = AlM118_15+OpM217_15*s.dpt[3,25]-OpM318_15*s.dpt[2,25]
  AlM321_15 = C21*(AlM318_15+OpM118_15*s.dpt[2,25])-S21*(AlM217_15-OpM118_15*s.dpt[3,25])
  OpM321_16 = OpM318_16*C21-S17*S21
  AlM121_16 = -(OpM318_16*s.dpt[2,25]-s.dpt[3,25]*S17)
  AlM321_16 = OpM118_16*(s.dpt[2,25]*C21+s.dpt[3,25]*S21)
  OpM321_17 = S18*C21
  AlM121_17 = -s.dpt[2,25]*S18
  AlM321_17 = C18*(s.dpt[2,25]*C21+s.dpt[3,25]*S21)
...
# Forward Kinematics 
  ...
  AlF136 = AlF133+BeF233*s.dpt[2,35]+BeF333*s.dpt[3,35]
  AlF336 = C36*(AlF332+BS933*s.dpt[3,35]+BeF833*s.dpt[2,35])-S36*(AlF233+BS533*s.dpt[2,35]+BeF633*s.dpt[3,35])
  ...
  AlM136_4 = AlM133_4+OpM233_4*s.dpt[3,35]-OpM332_4*s.dpt[2,35]
  AlM336_4 = C36*(AlM332_4+OpM133_4*s.dpt[2,35])-S36*(AlM233_4-OpM133_4*s.dpt[3,35])
  OpM336_5 = -(OpM233_5*S36-OpM332_5*C36)
  AlM136_5 = AlM133_5+OpM233_5*s.dpt[3,35]-OpM332_5*s.dpt[2,35]
  AlM336_5 = C36*(AlM332_5+OpM133_5*s.dpt[2,35])-S36*(AlM233_5-OpM133_5*s.dpt[3,35])
  OpM336_6 = -(OpM233_6*S36-OpM332_6*C36)
  AlM136_6 = AlM133_6+OpM233_6*s.dpt[3,35]-OpM332_6*s.dpt[2,35]
  AlM336_6 = C36*(AlM332_6+OpM133_6*s.dpt[2,35])-S36*(AlM233_6-OpM133_6*s.dpt[3,35])
  OpM336_29 = -(OpM233_29*S36-OpM332_29*C36)
  AlM136_29 = AlM133_29+OpM233_29*s.dpt[3,35]-OpM332_29*s.dpt[2,35]
  AlM336_29 = C36*(AlM332_29+OpM133_29*s.dpt[2,35])-S36*(AlM233_29-OpM133_29*s.dpt[3,35])
  OpM336_30 = -(OpM233_30*S36-OpM332_30*C36)
  AlM136_30 = AlM133_30+OpM233_30*s.dpt[3,35]-OpM332_30*s.dpt[2,35]
  AlM336_30 = C36*(AlM332_30+OpM133_30*s.dpt[2,35])-S36*(AlM233_30-OpM133_30*s.dpt[3,35])
  OpM336_31 = -(OpM233_31*S36-S32*C36)
  AlM136_31 = OpM233_31*s.dpt[3,35]-s.dpt[2,35]*S32
  AlM336_31 = OpM133_31*(s.dpt[2,35]*C36+s.dpt[3,35]*S36)
  OpM336_32 = -C33*S36
  AlM136_32 = s.dpt[3,35]*C33
  AlM336_32 = S33*(s.dpt[2,35]*C36+s.dpt[3,35]*S36)
...
# Forward Kinematics 
  ...
  AlF147 = AlF144+BeF244*s.dpt[2,46]+BeF344*s.dpt[3,46]
  AlF347 = C47*(AlF343+BS944*s.dpt[3,46]+BeF844*s.dpt[2,46])-S47*(AlF244+BS544*s.dpt[2,46]+BeF644*s.dpt[3,46])
  ...
  AlM147_4 = AlM144_4+OpM244_4*s.dpt[3,46]-OpM343_4*s.dpt[2,46]
  AlM347_4 = C47*(AlM343_4+OpM144_4*s.dpt[2,46])-S47*(AlM244_4-OpM144_4*s.dpt[3,46])
  OpM347_5 = -(OpM244_5*S47-OpM343_5*C47)
  AlM147_5 = AlM144_5+OpM244_5*s.dpt[3,46]-OpM343_5*s.dpt[2,46]
  AlM347_5 = C47*(AlM343_5+OpM144_5*s.dpt[2,46])-S47*(AlM244_5-OpM144_5*s.dpt[3,46])
  OpM347_6 = -(OpM244_6*S47-OpM343_6*C47)
  AlM147_6 = AlM144_6+OpM244_6*s.dpt[3,46]-OpM343_6*s.dpt[2,46]
  AlM347_6 = C47*(AlM343_6+OpM144_6*s.dpt[2,46])-S47*(AlM244_6-OpM144_6*s.dpt[3,46])
  OpM347_40 = -(OpM244_40*S47-OpM343_40*C47)
  AlM147_40 = AlM144_40+OpM244_40*s.dpt[3,46]-OpM343_40*s.dpt[2,46]
  AlM347_40 = C47*(AlM343_40+OpM144_40*s.dpt[2,46])-S47*(AlM244_40-OpM144_40*s.dpt[3,46])
  OpM347_41 = -(OpM244_41*S47-OpM343_41*C47)
  AlM147_41 = AlM144_41+OpM244_41*s.dpt[3,46]-OpM343_41*s.dpt[2,46]
  AlM347_41 = C47*(AlM343_41+OpM144_41*s.dpt[2,46])-S47*(AlM244_41-OpM144_41*s.dpt[3,46])
  OpM347_42 = -(OpM244_42*S47-S43*C47)
  AlM147_42 = OpM244_42*s.dpt[3,46]-s.dpt[2,46]*S43
  AlM347_42 = OpM144_42*(s.dpt[2,46]*C47+s.dpt[3,46]*S47)
  OpM347_43 = -C44*S47
  AlM147_43 = s.dpt[3,46]*C44
  AlM347_43 = S44*(s.dpt[2,46]*C47+s.dpt[3,46]*S47)
...
# Forward Kinematics 
  ...
  AlF250 = C50*(AlF249+BS549*s.dpt[2,50])-S50*(AlF149+BeF249*s.dpt[2,50])
  AlF350 = AlF349+BeF849*s.dpt[2,50]
  AlM250_1 = -(AlM15_1*S50-AlM26_1*C50)
  AlM250_2 = -(AlM15_2*S50-AlM26_2*C50)
  AlM250_3 = AlM26_3*C50+S50*S5
  OpM150_4 = OpM26_4*S50-C50*S5
  AlM250_4 = AlM249_4*C50-S50*(AlM149_4-OpM36_4*s.dpt[2,50])
  AlM350_4 = AlM349_4-s.dpt[2,50]*S5
  OpM150_5 = S50*C6
  AlM250_5 = AlM249_5*C50-S50*(AlM149_5+s.dpt[2,50]*S6)
  AlM350_6 = q[49]+s.dpt[2,50]
...
# Forward Kinematics 
  ...
  AlF252 = C52*(AlF249+BS549*s.dpt[2,51])-S52*(AlF149+BeF249*s.dpt[2,51])
  AlF352 = AlF349+BeF849*s.dpt[2,51]
  AlM252_1 = -(AlM15_1*S52-AlM26_1*C52)
  AlM252_2 = -(AlM15_2*S52-AlM26_2*C52)
  AlM252_3 = AlM26_3*C52+S52*S5
  OpM152_4 = OpM26_4*S52-C52*S5
  AlM252_4 = AlM249_4*C52-S52*(AlM149_4-OpM36_4*s.dpt[2,51])
  AlM352_4 = AlM349_4-s.dpt[2,51]*S5
  OpM152_5 = S52*C6
  AlM252_5 = AlM249_5*C52-S52*(AlM149_5+s.dpt[2,51]*S6)
  AlM352_6 = q[49]+s.dpt[2,51]
...
# Forward Kinematics 
  ...
  AlF256 = AlF254+BS555*s.dpt[2,55]+BeF455*s.dpt[1,55]
  AlF356 = C56*(AlF355+BeF755*s.dpt[1,55]+BeF855*s.dpt[2,55])+S56*(AlF155+BS155*s.dpt[1,55]+BeF255*s.dpt[2,55])
  ...
  AlM256_4 = AlM254_4+OpM355_4*s.dpt[1,55]
  AlM356_4 = C56*(AlM355_4+OpM155_4*s.dpt[2,55]-OpM26_4*s.dpt[1,55])+S56*(AlM155_4-OpM355_4*s.dpt[2,55])
  OpM156_5 = S54p55p56*S6
  AlM256_5 = AlM254_5+OpM355_5*s.dpt[1,55]
  AlM356_5 = C56*(AlM355_5+OpM155_5*s.dpt[2,55]-s.dpt[1,55]*C6)+S56*(AlM155_5-OpM355_5*s.dpt[2,55])
  AlM256_6 = -(s.dpt[3,14]-s.dpt[1,55]*S54p55)
  AlM356_6 = s.dpt[2,55]*C54p55p56
  AlM356_54 = -s.dpt[1,55]*C56
  AlM356_55 = -s.dpt[1,55]*C56
...
# Forward Kinematics 
  ...
  AlF258 = AlF254+BS554*s.dpt[2,54]+BeF454*s.dpt[1,54]
  AlF358 = C58*(AlF354+BeF754*s.dpt[1,54]+BeF854*s.dpt[2,54])+S58*(AlF154+BS154*s.dpt[1,54]+BeF254*s.dpt[2,54])
  ...
  AlM258_4 = AlM254_4+OpM354_4*s.dpt[1,54]
  AlM358_4 = C58*(AlM354_4+OpM154_4*s.dpt[2,54]-OpM26_4*s.dpt[1,54])+S58*(AlM154_4-OpM354_4*s.dpt[2,54])
  OpM158_5 = S54p58*S6
  AlM258_5 = AlM254_5+OpM354_5*s.dpt[1,54]
  AlM358_5 = C58*(AlM354_5+OpM154_5*s.dpt[2,54]-s.dpt[1,54]*C6)+S58*(AlM154_5-OpM354_5*s.dpt[2,54])
  AlM258_6 = -(s.dpt[3,14]-s.dpt[1,54]*S54)
  AlM358_6 = s.dpt[2,54]*C54p58
  AlM358_54 = -s.dpt[1,54]*C58
...
# Forward Kinematics 
  ...
  AlF262 = AlF260+BS561*s.dpt[2,59]+BeF461*s.dpt[1,59]
  AlF362 = C62*(AlF361+BeF761*s.dpt[1,59]+BeF861*s.dpt[2,59])+S62*(AlF161+BS161*s.dpt[1,59]+BeF261*s.dpt[2,59])
  ...
  AlM262_4 = AlM260_4+OpM361_4*s.dpt[1,59]
  AlM362_4 = C62*(AlM361_4+OpM161_4*s.dpt[2,59]-OpM26_4*s.dpt[1,59])+S62*(AlM161_4-OpM361_4*s.dpt[2,59])
  OpM162_5 = S60p61p62*S6
  AlM262_5 = AlM260_5+OpM361_5*s.dpt[1,59]
  AlM362_5 = C62*(AlM361_5+OpM161_5*s.dpt[2,59]-s.dpt[1,59]*C6)+S62*(AlM161_5-OpM361_5*s.dpt[2,59])
  AlM262_6 = -(s.dpt[3,15]-s.dpt[1,59]*S60p61)
  AlM362_6 = s.dpt[2,59]*C60p61p62
  AlM362_60 = -s.dpt[1,59]*C62
  AlM362_61 = -s.dpt[1,59]*C62
...
# Forward Kinematics 
  ...
  AlF264 = AlF260+BS560*s.dpt[2,58]+BeF460*s.dpt[1,58]
  AlF364 = C64*(AlF360+BeF760*s.dpt[1,58]+BeF860*s.dpt[2,58])+S64*(AlF160+BS160*s.dpt[1,58]+BeF260*s.dpt[2,58])
  ...
  AlM264_4 = AlM260_4+OpM360_4*s.dpt[1,58]
  AlM364_4 = C64*(AlM360_4+OpM160_4*s.dpt[2,58]-OpM26_4*s.dpt[1,58])+S64*(AlM160_4-OpM360_4*s.dpt[2,58])
  OpM164_5 = S60p64*S6
  AlM264_5 = AlM260_5+OpM360_5*s.dpt[1,58]
  AlM364_5 = C64*(AlM360_5+OpM160_5*s.dpt[2,58]-s.dpt[1,58]*C6)+S64*(AlM160_5-OpM360_5*s.dpt[2,58])
  AlM264_6 = -(s.dpt[3,15]-s.dpt[1,58]*S60)
  AlM364_6 = s.dpt[2,58]*C60p64
  AlM364_60 = -s.dpt[1,58]*C64
...
# Backward Dynamics 
  ...
  FA112 = -(s.frc[1,12]-s.m[12]*(AlF110+q[12]*(OpF211+OM111*OM311)+(2.0)*qd[12]*OM211+BeF210*s.dpt[2,17]+BeF310*s.dpt[3,17]+\
  ...
  FA212 = -(s.frc[2,12]+s.m[12]*(q[12]*(OpF110-OM211*OM311)+(2.0)*qd[12]*OM111+s.l[3,12]*(OpF110-OM211*OM311)-C11*(AlF29+\
   BS510*s.dpt[2,17]+BeF610*s.dpt[3,17])-S11*(AlF310+BS910*s.dpt[3,17]+BeF810*s.dpt[2,17])))
  FA312 = -(s.frc[3,12]-s.m[12]*(C11*(AlF310+BS910*s.dpt[3,17]+BeF810*s.dpt[2,17])-S11*(AlF29+BS510*s.dpt[2,17]+BeF610*\
   s.dpt[3,17])-(q[12]+s.l[3,12])*(OM111*OM111+OM211*OM211)))
  ...
  FB112_4 = s.m[12]*(AlM110_4+q[12]*OpM211_4+OpM211_4*s.l[3,12]+OpM29_4*s.dpt[3,17]-OpM310_4*s.dpt[2,17])
  FB212_4 = -s.m[12]*(OpM110_4*(q[12]+s.l[3,12])-C11*(AlM29_4-OpM110_4*s.dpt[3,17])-S11*(AlM310_4+OpM110_4*s.dpt[2,17]))
  FB312_4 = s.m[12]*(C11*(AlM310_4+OpM110_4*s.dpt[2,17])-S11*(AlM29_4-OpM110_4*s.dpt[3,17]))
  CM312_4 = -s.In[9,12]*(OpM29_4*S11-OpM310_4*C11)
  FB112_5 = s.m[12]*(AlM110_5+q[12]*OpM211_5+OpM211_5*s.l[3,12]+OpM29_5*s.dpt[3,17]-OpM310_5*s.dpt[2,17])
  FB212_5 = -s.m[12]*(OpM110_5*(q[12]+s.l[3,12])-C11*(AlM29_5-OpM110_5*s.dpt[3,17])-S11*(AlM310_5+OpM110_5*s.dpt[2,17]))
  FB312_5 = s.m[12]*(C11*(AlM310_5+OpM110_5*s.dpt[2,17])-S11*(AlM29_5-OpM110_5*s.dpt[3,17]))
  CM312_5 = -s.In[9,12]*(OpM29_5*S11-OpM310_5*C11)
  FB112_6 = s.m[12]*(AlM110_6+q[12]*OpM211_6+OpM211_6*s.l[3,12]+OpM29_6*s.dpt[3,17]-OpM310_6*s.dpt[2,17])
  FB212_6 = -s.m[12]*(OpM110_6*(q[12]+s.l[3,12])-C11*(AlM29_6-OpM110_6*s.dpt[3,17])-S11*(AlM310_6+OpM110_6*s.dpt[2,17]))
  FB312_6 = s.m[12]*(C11*(AlM310_6+OpM110_6*s.dpt[2,17])-S11*(AlM29_6-OpM110_6*s.dpt[3,17]))
  CM312_6 = -s.In[9,12]*(OpM29_6*S11-OpM310_6*C11)
  FB112_7 = s.m[12]*(AlM110_7+q[12]*OpM211_7+OpM211_7*s.l[3,12]+OpM29_7*s.dpt[3,17]-OpM310_7*s.dpt[2,17])
  FB212_7 = -s.m[12]*(OpM110_7*(q[12]+s.l[3,12])-C11*(AlM29_7-OpM110_7*s.dpt[3,17])-S11*(AlM310_7+OpM110_7*s.dpt[2,17]))
  FB312_7 = s.m[12]*(C11*(AlM310_7+OpM110_7*s.dpt[2,17])-S11*(AlM29_7-OpM110_7*s.dpt[3,17]))
  CM312_7 = -s.In[9,12]*(OpM29_7*S11-OpM310_7*C11)
  FB112_8 = s.m[12]*(OpM211_8*(q[12]+s.l[3,12])-OpM310_8*s.dpt[2,17]+s.dpt[3,17]*S9)
  FB212_8 = -s.m[12]*OpM110_8*(q[12]+s.l[3,12]-s.dpt[2,17]*S11+s.dpt[3,17]*C11)
  FB312_8 = s.m[12]*OpM110_8*(s.dpt[2,17]*C11+s.dpt[3,17]*S11)
  CM312_8 = s.In[9,12]*(OpM310_8*C11-S11*S9)
  FB112_9 = s.m[12]*(OpM211_9*(q[12]+s.l[3,12])-s.dpt[2,17]*S10)
  FB212_9 = -s.m[12]*C10*(q[12]+s.l[3,12]-s.dpt[2,17]*S11+s.dpt[3,17]*C11)
  FB312_9 = s.m[12]*C10*(s.dpt[2,17]*C11+s.dpt[3,17]*S11)
  CM312_9 = s.In[9,12]*S10*C11
  FB112_10 = s.m[12]*(s.dpt[3,17]+q[12]*C11+s.l[3,12]*C11)
...
# Backward Dynamics 
  ...
  FA214 = -(s.frc[2,14]-s.m[14]*(C13*(AlF29+BS510*s.dpt[2,18]+BeF610*s.dpt[3,18])+S13*(AlF310+BS910*s.dpt[3,18]+BeF810*\
   s.dpt[2,18])))
  ...
  FB214_4 = s.m[14]*(C13*(AlM29_4-OpM110_4*s.dpt[3,18])+S13*(AlM310_4+OpM110_4*s.dpt[2,18]))
  ...
  FB214_5 = s.m[14]*(C13*(AlM29_5-OpM110_5*s.dpt[3,18])+S13*(AlM310_5+OpM110_5*s.dpt[2,18]))
  ...
  FB214_6 = s.m[14]*(C13*(AlM29_6-OpM110_6*s.dpt[3,18])+S13*(AlM310_6+OpM110_6*s.dpt[2,18]))
  ...
  FB214_7 = s.m[14]*(C13*(AlM29_7-OpM110_7*s.dpt[3,18])+S13*(AlM310_7+OpM110_7*s.dpt[2,18]))
  ...
  FB214_8 = s.m[14]*OpM110_8*(s.dpt[2,18]*S13-s.dpt[3,18]*C13)
  ...
  FB214_9 = s.m[14]*C10*(s.dpt[2,18]*S13-s.dpt[3,18]*C13)
...
# Backward Dynamics 
  ...
  FA120 = -(s.frc[1,20]-s.m[20]*(AlF118+q[20]*(OpF219+OM119*OM319)+(2.0)*qd[20]*OM219+BeF218*s.dpt[2,24]+BeF318*s.dpt[3,24]+\
  ...
  FA220 = -(s.frc[2,20]+s.m[20]*(q[20]*(OpF118-OM219*OM319)+(2.0)*qd[20]*OM119+s.l[3,20]*(OpF118-OM219*OM319)-C19*(AlF217+\
   BS518*s.dpt[2,24]+BeF618*s.dpt[3,24])-S19*(AlF318+BS918*s.dpt[3,24]+BeF818*s.dpt[2,24])))
  FA320 = -(s.frc[3,20]-s.m[20]*(C19*(AlF318+BS918*s.dpt[3,24]+BeF818*s.dpt[2,24])-S19*(AlF217+BS518*s.dpt[2,24]+BeF618*\
   s.dpt[3,24])-(q[20]+s.l[3,20])*(OM119*OM119+OM219*OM219)))
  ...
  FB120_4 = s.m[20]*(AlM118_4+q[20]*OpM219_4+OpM217_4*s.dpt[3,24]+OpM219_4*s.l[3,20]-OpM318_4*s.dpt[2,24])
  FB220_4 = -s.m[20]*(OpM118_4*(q[20]+s.l[3,20])-C19*(AlM217_4-OpM118_4*s.dpt[3,24])-S19*(AlM318_4+OpM118_4*s.dpt[2,24])\
   )
  FB320_4 = s.m[20]*(C19*(AlM318_4+OpM118_4*s.dpt[2,24])-S19*(AlM217_4-OpM118_4*s.dpt[3,24]))
  CM320_4 = -s.In[9,20]*(OpM217_4*S19-OpM318_4*C19)
  FB120_5 = s.m[20]*(AlM118_5+q[20]*OpM219_5+OpM217_5*s.dpt[3,24]+OpM219_5*s.l[3,20]-OpM318_5*s.dpt[2,24])
  FB220_5 = -s.m[20]*(OpM118_5*(q[20]+s.l[3,20])-C19*(AlM217_5-OpM118_5*s.dpt[3,24])-S19*(AlM318_5+OpM118_5*s.dpt[2,24])\
   )
  FB320_5 = s.m[20]*(C19*(AlM318_5+OpM118_5*s.dpt[2,24])-S19*(AlM217_5-OpM118_5*s.dpt[3,24]))
  CM320_5 = -s.In[9,20]*(OpM217_5*S19-OpM318_5*C19)
  FB120_6 = s.m[20]*(AlM118_6+q[20]*OpM219_6+OpM217_6*s.dpt[3,24]+OpM219_6*s.l[3,20]-OpM318_6*s.dpt[2,24])
  FB220_6 = -s.m[20]*(OpM118_6*(q[20]+s.l[3,20])-C19*(AlM217_6-OpM118_6*s.dpt[3,24])-S19*(AlM318_6+OpM118_6*s.dpt[2,24])\
   )
  FB320_6 = s.m[20]*(C19*(AlM318_6+OpM118_6*s.dpt[2,24])-S19*(AlM217_6-OpM118_6*s.dpt[3,24]))
  CM320_6 = -s.In[9,20]*(OpM217_6*S19-OpM318_6*C19)
  FB120_15 = s.m[20]*(AlM118_15+q[20]*OpM219_15+OpM217_15*s.dpt[3,24]+OpM219_15*s.l[3,20]-OpM318_15*s.dpt[2,24])
  FB220_15 = -s.m[20]*(OpM118_15*(q[20]+s.l[3,20])-C19*(AlM217_15-OpM118_15*s.dpt[3,24])-S19*(AlM318_15+OpM118_15*\
   s.dpt[2,24]))
  FB320_15 = s.m[20]*(C19*(AlM318_15+OpM118_15*s.dpt[2,24])-S19*(AlM217_15-OpM118_15*s.dpt[3,24]))
  CM320_15 = -s.In[9,20]*(OpM217_15*S19-OpM318_15*C19)
  FB120_16 = s.m[20]*(OpM219_16*(q[20]+s.l[3,20])-OpM318_16*s.dpt[2,24]+s.dpt[3,24]*S17)
  FB220_16 = -s.m[20]*OpM118_16*(q[20]+s.l[3,20]-s.dpt[2,24]*S19+s.dpt[3,24]*C19)
  FB320_16 = s.m[20]*OpM118_16*(s.dpt[2,24]*C19+s.dpt[3,24]*S19)
  CM320_16 = s.In[9,20]*(OpM318_16*C19-S17*S19)
  FB120_17 = s.m[20]*(OpM219_17*(q[20]+s.l[3,20])-s.dpt[2,24]*S18)
  FB220_17 = -s.m[20]*C18*(q[20]+s.l[3,20]-s.dpt[2,24]*S19+s.dpt[3,24]*C19)
  FB320_17 = s.m[20]*C18*(s.dpt[2,24]*C19+s.dpt[3,24]*S19)
  CM320_17 = s.In[9,20]*S18*C19
  FB120_18 = s.m[20]*(s.dpt[3,24]+q[20]*C19+s.l[3,20]*C19)
...
# Backward Dynamics 
  ...
  FA222 = -(s.frc[2,22]-s.m[22]*(C21*(AlF217+BS518*s.dpt[2,25]+BeF618*s.dpt[3,25])+S21*(AlF318+BS918*s.dpt[3,25]+BeF818*\
   s.dpt[2,25])))
  ...
  FB222_4 = s.m[22]*(C21*(AlM217_4-OpM118_4*s.dpt[3,25])+S21*(AlM318_4+OpM118_4*s.dpt[2,25]))
  ...
  FB222_5 = s.m[22]*(C21*(AlM217_5-OpM118_5*s.dpt[3,25])+S21*(AlM318_5+OpM118_5*s.dpt[2,25]))
  ...
  FB222_6 = s.m[22]*(C21*(AlM217_6-OpM118_6*s.dpt[3,25])+S21*(AlM318_6+OpM118_6*s.dpt[2,25]))
  ...
  FB222_15 = s.m[22]*(C21*(AlM217_15-OpM118_15*s.dpt[3,25])+S21*(AlM318_15+OpM118_15*s.dpt[2,25]))
  ...
  FB222_16 = s.m[22]*OpM118_16*(s.dpt[2,25]*S21-s.dpt[3,25]*C21)
  ...
  FB222_17 = s.m[22]*C18*(s.dpt[2,25]*S21-s.dpt[3,25]*C21)
...
# Backward Dynamics 
  ...
  FA135 = -(s.frc[1,35]-s.m[35]*(AlF133+q[35]*(OpF234+OM134*OM334)+(2.0)*qd[35]*OM234+BeF233*s.dpt[2,34]+BeF333*s.dpt[3,34]+\
  ...
  FA235 = -(s.frc[2,35]+s.m[35]*(q[35]*(OpF133-OM234*OM334)+(2.0)*qd[35]*OM134+s.l[3,35]*(OpF133-OM234*OM334)-C34*(AlF233+\
   BS533*s.dpt[2,34]+BeF633*s.dpt[3,34])-S34*(AlF332+BS933*s.dpt[3,34]+BeF833*s.dpt[2,34])))
  FA335 = -(s.frc[3,35]-s.m[35]*(C34*(AlF332+BS933*s.dpt[3,34]+BeF833*s.dpt[2,34])-S34*(AlF233+BS533*s.dpt[2,34]+BeF633*\
   s.dpt[3,34])-(q[35]+s.l[3,35])*(OM134*OM134+OM234*OM234)))
  ...
  FB135_4 = s.m[35]*(AlM133_4+q[35]*OpM234_4+OpM233_4*s.dpt[3,34]+OpM234_4*s.l[3,35]-OpM332_4*s.dpt[2,34])
  FB235_4 = -s.m[35]*(OpM133_4*(q[35]+s.l[3,35])-C34*(AlM233_4-OpM133_4*s.dpt[3,34])-S34*(AlM332_4+OpM133_4*s.dpt[2,34])\
   )
  FB335_4 = s.m[35]*(C34*(AlM332_4+OpM133_4*s.dpt[2,34])-S34*(AlM233_4-OpM133_4*s.dpt[3,34]))
  CM335_4 = -s.In[9,35]*(OpM233_4*S34-OpM332_4*C34)
  FB135_5 = s.m[35]*(AlM133_5+q[35]*OpM234_5+OpM233_5*s.dpt[3,34]+OpM234_5*s.l[3,35]-OpM332_5*s.dpt[2,34])
  FB235_5 = -s.m[35]*(OpM133_5*(q[35]+s.l[3,35])-C34*(AlM233_5-OpM133_5*s.dpt[3,34])-S34*(AlM332_5+OpM133_5*s.dpt[2,34])\
   )
  FB335_5 = s.m[35]*(C34*(AlM332_5+OpM133_5*s.dpt[2,34])-S34*(AlM233_5-OpM133_5*s.dpt[3,34]))
  CM335_5 = -s.In[9,35]*(OpM233_5*S34-OpM332_5*C34)
  FB135_6 = s.m[35]*(AlM133_6+q[35]*OpM234_6+OpM233_6*s.dpt[3,34]+OpM234_6*s.l[3,35]-OpM332_6*s.dpt[2,34])
  FB235_6 = -s.m[35]*(OpM133_6*(q[35]+s.l[3,35])-C34*(AlM233_6-OpM133_6*s.dpt[3,34])-S34*(AlM332_6+OpM133_6*s.dpt[2,34])\
   )
  FB335_6 = s.m[35]*(C34*(AlM332_6+OpM133_6*s.dpt[2,34])-S34*(AlM233_6-OpM133_6*s.dpt[3,34]))
  CM335_6 = -s.In[9,35]*(OpM233_6*S34-OpM332_6*C34)
  FB135_29 = s.m[35]*(AlM133_29+q[35]*OpM234_29+OpM233_29*s.dpt[3,34]+OpM234_29*s.l[3,35]-OpM332_29*s.dpt[2,34])
  FB235_29 = -s.m[35]*(OpM133_29*(q[35]+s.l[3,35])-C34*(AlM233_29-OpM133_29*s.dpt[3,34])-S34*(AlM332_29+OpM133_29*\
   s.dpt[2,34]))
  FB335_29 = s.m[35]*(C34*(AlM332_29+OpM133_29*s.dpt[2,34])-S34*(AlM233_29-OpM133_29*s.dpt[3,34]))
  CM335_29 = -s.In[9,35]*(OpM233_29*S34-OpM332_29*C34)
  FB135_30 = s.m[35]*(AlM133_30+q[35]*OpM234_30+OpM233_30*s.dpt[3,34]+OpM234_30*s.l[3,35]-OpM332_30*s.dpt[2,34])
  FB235_30 = -s.m[35]*(OpM133_30*(q[35]+s.l[3,35])-C34*(AlM233_30-OpM133_30*s.dpt[3,34])-S34*(AlM332_30+OpM133_30*\
   s.dpt[2,34]))
  FB335_30 = s.m[35]*(C34*(AlM332_30+OpM133_30*s.dpt[2,34])-S34*(AlM233_30-OpM133_30*s.dpt[3,34]))
  CM335_30 = -s.In[9,35]*(OpM233_30*S34-OpM332_30*C34)
  FB135_31 = s.m[35]*(q[35]*OpM234_31+OpM233_31*s.dpt[3,34]+OpM234_31*s.l[3,35]-s.dpt[2,34]*S32)
  FB235_31 = -s.m[35]*OpM133_31*(q[35]+s.l[3,35]-s.dpt[2,34]*S34+s.dpt[3,34]*C34)
  FB335_31 = s.m[35]*OpM133_31*(s.dpt[2,34]*C34+s.dpt[3,34]*S34)
  CM335_31 = -s.In[9,35]*(OpM233_31*S34-S32*C34)
  FB135_32 = s.m[35]*(OpM234_32*(q[35]+s.l[3,35])+s.dpt[3,34]*C33)
  FB235_32 = -s.m[35]*S33*(q[35]+s.l[3,35]-s.dpt[2,34]*S34+s.dpt[3,34]*C34)
  FB335_32 = s.m[35]*S33*(s.dpt[2,34]*C34+s.dpt[3,34]*S34)
  CM335_32 = -s.In[9,35]*C33*S34
  FB135_33 = -s.m[35]*(s.dpt[2,34]-q[35]*S34-s.l[3,35]*S34)
...
# Backward Dynamics 
  ...
  FA237 = -(s.frc[2,37]-s.m[37]*(C36*(AlF233+BS533*s.dpt[2,35]+BeF633*s.dpt[3,35])+S36*(AlF332+BS933*s.dpt[3,35]+BeF833*\
   s.dpt[2,35])))
  ...
  FB237_4 = s.m[37]*(C36*(AlM233_4-OpM133_4*s.dpt[3,35])+S36*(AlM332_4+OpM133_4*s.dpt[2,35]))
  ...
  FB237_5 = s.m[37]*(C36*(AlM233_5-OpM133_5*s.dpt[3,35])+S36*(AlM332_5+OpM133_5*s.dpt[2,35]))
  ...
  FB237_6 = s.m[37]*(C36*(AlM233_6-OpM133_6*s.dpt[3,35])+S36*(AlM332_6+OpM133_6*s.dpt[2,35]))
  ...
  FB237_29 = s.m[37]*(C36*(AlM233_29-OpM133_29*s.dpt[3,35])+S36*(AlM332_29+OpM133_29*s.dpt[2,35]))
  ...
  FB237_30 = s.m[37]*(C36*(AlM233_30-OpM133_30*s.dpt[3,35])+S36*(AlM332_30+OpM133_30*s.dpt[2,35]))
  ...
  FB237_31 = s.m[37]*OpM133_31*(s.dpt[2,35]*S36-s.dpt[3,35]*C36)
  ...
  FB237_32 = s.m[37]*S33*(s.dpt[2,35]*S36-s.dpt[3,35]*C36)
...
# Backward Dynamics 
  ...
  FA146 = -(s.frc[1,46]-s.m[46]*(AlF144+q[46]*(OpF245+OM145*OM345)+(2.0)*qd[46]*OM245+BeF244*s.dpt[2,45]+BeF344*s.dpt[3,45]+\
  ...
  FA246 = -(s.frc[2,46]+s.m[46]*(q[46]*(OpF144-OM245*OM345)+(2.0)*qd[46]*OM145+s.l[3,46]*(OpF144-OM245*OM345)-C45*(AlF244+\
   BS544*s.dpt[2,45]+BeF644*s.dpt[3,45])-S45*(AlF343+BS944*s.dpt[3,45]+BeF844*s.dpt[2,45])))
  FA346 = -(s.frc[3,46]-s.m[46]*(C45*(AlF343+BS944*s.dpt[3,45]+BeF844*s.dpt[2,45])-S45*(AlF244+BS544*s.dpt[2,45]+BeF644*\
   s.dpt[3,45])-(q[46]+s.l[3,46])*(OM145*OM145+OM245*OM245)))
  ...
  FB146_4 = s.m[46]*(AlM144_4+q[46]*OpM245_4+OpM244_4*s.dpt[3,45]+OpM245_4*s.l[3,46]-OpM343_4*s.dpt[2,45])
  FB246_4 = -s.m[46]*(OpM144_4*(q[46]+s.l[3,46])-C45*(AlM244_4-OpM144_4*s.dpt[3,45])-S45*(AlM343_4+OpM144_4*s.dpt[2,45])\
   )
  FB346_4 = s.m[46]*(C45*(AlM343_4+OpM144_4*s.dpt[2,45])-S45*(AlM244_4-OpM144_4*s.dpt[3,45]))
  CM346_4 = -s.In[9,46]*(OpM244_4*S45-OpM343_4*C45)
  FB146_5 = s.m[46]*(AlM144_5+q[46]*OpM245_5+OpM244_5*s.dpt[3,45]+OpM245_5*s.l[3,46]-OpM343_5*s.dpt[2,45])
  FB246_5 = -s.m[46]*(OpM144_5*(q[46]+s.l[3,46])-C45*(AlM244_5-OpM144_5*s.dpt[3,45])-S45*(AlM343_5+OpM144_5*s.dpt[2,45])\
   )
  FB346_5 = s.m[46]*(C45*(AlM343_5+OpM144_5*s.dpt[2,45])-S45*(AlM244_5-OpM144_5*s.dpt[3,45]))
  CM346_5 = -s.In[9,46]*(OpM244_5*S45-OpM343_5*C45)
  FB146_6 = s.m[46]*(AlM144_6+q[46]*OpM245_6+OpM244_6*s.dpt[3,45]+OpM245_6*s.l[3,46]-OpM343_6*s.dpt[2,45])
  FB246_6 = -s.m[46]*(OpM144_6*(q[46]+s.l[3,46])-C45*(AlM244_6-OpM144_6*s.dpt[3,45])-S45*(AlM343_6+OpM144_6*s.dpt[2,45])\
   )
  FB346_6 = s.m[46]*(C45*(AlM343_6+OpM144_6*s.dpt[2,45])-S45*(AlM244_6-OpM144_6*s.dpt[3,45]))
  CM346_6 = -s.In[9,46]*(OpM244_6*S45-OpM343_6*C45)
  FB146_40 = s.m[46]*(AlM144_40+q[46]*OpM245_40+OpM244_40*s.dpt[3,45]+OpM245_40*s.l[3,46]-OpM343_40*s.dpt[2,45])
  FB246_40 = -s.m[46]*(OpM144_40*(q[46]+s.l[3,46])-C45*(AlM244_40-OpM144_40*s.dpt[3,45])-S45*(AlM343_40+OpM144_40*\
   s.dpt[2,45]))
  FB346_40 = s.m[46]*(C45*(AlM343_40+OpM144_40*s.dpt[2,45])-S45*(AlM244_40-OpM144_40*s.dpt[3,45]))
  CM346_40 = -s.In[9,46]*(OpM244_40*S45-OpM343_40*C45)
  FB146_41 = s.m[46]*(AlM144_41+q[46]*OpM245_41+OpM244_41*s.dpt[3,45]+OpM245_41*s.l[3,46]-OpM343_41*s.dpt[2,45])
  FB246_41 = -s.m[46]*(OpM144_41*(q[46]+s.l[3,46])-C45*(AlM244_41-OpM144_41*s.dpt[3,45])-S45*(AlM343_41+OpM144_41*\
   s.dpt[2,45]))
  FB346_41 = s.m[46]*(C45*(AlM343_41+OpM144_41*s.dpt[2,45])-S45*(AlM244_41-OpM144_41*s.dpt[3,45]))
  CM346_41 = -s.In[9,46]*(OpM244_41*S45-OpM343_41*C45)
  FB146_42 = s.m[46]*(q[46]*OpM245_42+OpM244_42*s.dpt[3,45]+OpM245_42*s.l[3,46]-s.dpt[2,45]*S43)
  FB246_42 = -s.m[46]*OpM144_42*(q[46]+s.l[3,46]-s.dpt[2,45]*S45+s.dpt[3,45]*C45)
  FB346_42 = s.m[46]*OpM144_42*(s.dpt[2,45]*C45+s.dpt[3,45]*S45)
  CM346_42 = -s.In[9,46]*(OpM244_42*S45-S43*C45)
  FB146_43 = s.m[46]*(OpM245_43*(q[46]+s.l[3,46])+s.dpt[3,45]*C44)
  FB246_43 = -s.m[46]*S44*(q[46]+s.l[3,46]-s.dpt[2,45]*S45+s.dpt[3,45]*C45)
  FB346_43 = s.m[46]*S44*(s.dpt[2,45]*C45+s.dpt[3,45]*S45)
  CM346_43 = -s.In[9,46]*C44*S45
  FB146_44 = -s.m[46]*(s.dpt[2,45]-q[46]*S45-s.l[3,46]*S45)
...
# Backward Dynamics 
  ...
  FA248 = -(s.frc[2,48]-s.m[48]*(C47*(AlF244+BS544*s.dpt[2,46]+BeF644*s.dpt[3,46])+S47*(AlF343+BS944*s.dpt[3,46]+BeF844*\
   s.dpt[2,46])))
  ...
  FB248_4 = s.m[48]*(C47*(AlM244_4-OpM144_4*s.dpt[3,46])+S47*(AlM343_4+OpM144_4*s.dpt[2,46]))
  ...
  FB248_5 = s.m[48]*(C47*(AlM244_5-OpM144_5*s.dpt[3,46])+S47*(AlM343_5+OpM144_5*s.dpt[2,46]))
  ...
  FB248_6 = s.m[48]*(C47*(AlM244_6-OpM144_6*s.dpt[3,46])+S47*(AlM343_6+OpM144_6*s.dpt[2,46]))
  ...
  FB248_40 = s.m[48]*(C47*(AlM244_40-OpM144_40*s.dpt[3,46])+S47*(AlM343_40+OpM144_40*s.dpt[2,46]))
  ...
  FB248_41 = s.m[48]*(C47*(AlM244_41-OpM144_41*s.dpt[3,46])+S47*(AlM343_41+OpM144_41*s.dpt[2,46]))
  ...
  FB248_42 = s.m[48]*OpM144_42*(s.dpt[2,46]*S47-s.dpt[3,46]*C47)
  ...
  FB248_43 = s.m[48]*S44*(s.dpt[2,46]*S47-s.dpt[3,46]*C47)
...
# Backward Dynamics 
  ...
  FA151 = -(s.frc[1,51]+s.m[51]*(s.l[2,51]*(OpF351-OM151*OM251)-C50*(AlF149+BeF249*s.dpt[2,50])-S50*(AlF249+BS549*\
   s.dpt[2,50])))
  ...
  FB151_4 = s.m[51]*(AlM249_4*S50-OpM351_4*s.l[2,51]+C50*(AlM149_4-OpM36_4*s.dpt[2,50]))
  ...
  FB151_5 = s.m[51]*(AlM249_5*S50-OpM351_5*s.l[2,51]+C50*(AlM149_5+s.dpt[2,50]*S6))
...
# Backward Dynamics 
  ...
  FA153 = -(s.frc[1,53]+s.m[53]*(s.l[2,53]*(OpF353-OM153*OM253)-C52*(AlF149+BeF249*s.dpt[2,51])-S52*(AlF249+BS549*\
   s.dpt[2,51])))
  ...
  FB153_4 = s.m[53]*(AlM249_4*S52-OpM353_4*s.l[2,53]+C52*(AlM149_4-OpM36_4*s.dpt[2,51]))
  ...
  FB153_5 = s.m[53]*(AlM249_5*S52-OpM353_5*s.l[2,53]+C52*(AlM149_5+s.dpt[2,51]*S6))
...
# Backward Dynamics 
  ...
  FA157 = -(s.frc[1,57]-s.m[57]*(s.l[3,57]*(OpF257+OM157*OM357)+C56*(AlF155+BS155*s.dpt[1,55]+BeF255*s.dpt[2,55])-S56*(\
   AlF355+BeF755*s.dpt[1,55]+BeF855*s.dpt[2,55])))
  ...
  FB157_4 = s.m[57]*(OpM257_4*s.l[3,57]+C56*(AlM155_4-OpM355_4*s.dpt[2,55])-S56*(AlM355_4+OpM155_4*s.dpt[2,55]-OpM26_4*\
   s.dpt[1,55]))
  ...
  FB157_5 = s.m[57]*(OpM257_5*s.l[3,57]+C56*(AlM155_5-OpM355_5*s.dpt[2,55])-S56*(AlM355_5+OpM155_5*s.dpt[2,55]-\
   s.dpt[1,55]*C6))
  ...
  FB157_6 = s.m[57]*(OpM257_6*s.l[3,57]-s.dpt[2,55]*S54p55p56)
  ...
  FB157_54 = s.m[57]*(s.dpt[1,55]*S56+s.l[3,57]*C57)
  CM157_54 = -s.m[57]*AlM356_54*s.l[3,57]*S57
  FB157_55 = s.m[57]*(s.dpt[1,55]*S56+s.l[3,57]*C57)
  ...
  CF155 = -(s.trq[1,55]+s.In[5,55]*OM255*OM355-CF157*C56-CF56_357*S56-FA355*s.l[2,55]+s.dpt[2,55]*(FA157*S56-FF56_357*\
   C56))
  CF255 = -(s.trq[2,55]-CF56_257-s.In[5,55]*OpF26+FA355*s.l[1,55]-s.dpt[1,55]*(FA157*S56-FF56_357*C56))
  CF355 = -(s.trq[3,55]-s.In[5,55]*OM155*OM255+CF157*S56-CF56_357*C56+FA155*s.l[2,55]-FA255*s.l[1,55]-FF56_257*\
   s.dpt[1,55]+s.dpt[2,55]*(FA157*C56+FF56_357*S56))
  ...
  CM155_1 = CM157_1*C56+CM561_357*S56+FB355_1*s.l[2,55]-s.dpt[2,55]*(FB157_1*S56-FM561_357*C56)
  CM255_1 = CM561_257-FB355_1*s.l[1,55]+s.dpt[1,55]*(FB157_1*S56-FM561_357*C56)
  CM355_1 = -(CM157_1*S56-CM561_357*C56+FB155_1*s.l[2,55]-FB255_1*s.l[1,55]-FM561_257*s.dpt[1,55]+s.dpt[2,55]*(FB157_1*\
   C56+FM561_357*S56))
  ...
  CM155_2 = CM157_2*C56+CM562_357*S56+FB355_2*s.l[2,55]-s.dpt[2,55]*(FB157_2*S56-FM562_357*C56)
  CM255_2 = CM562_257-FB355_2*s.l[1,55]+s.dpt[1,55]*(FB157_2*S56-FM562_357*C56)
  CM355_2 = -(CM157_2*S56-CM562_357*C56+FB155_2*s.l[2,55]-FB255_2*s.l[1,55]-FM562_257*s.dpt[1,55]+s.dpt[2,55]*(FB157_2*\
   C56+FM562_357*S56))
  ...
  CM155_3 = CM157_3*C56+CM563_357*S56+FB355_3*s.l[2,55]-s.dpt[2,55]*(FB157_3*S56-FM563_357*C56)
  CM255_3 = CM563_257-FB355_3*s.l[1,55]+s.dpt[1,55]*(FB157_3*S56-FM563_357*C56)
  CM355_3 = -(CM157_3*S56-CM563_357*C56+FB155_3*s.l[2,55]-FB255_3*s.l[1,55]-FM563_257*s.dpt[1,55]+s.dpt[2,55]*(FB157_3*\
   C56+FM563_357*S56))
  ...
  CM155_4 = CM157_4*C56+CM564_357*S56+FB355_4*s.l[2,55]-s.dpt[2,55]*(FB157_4*S56-FM564_357*C56)
  CM255_4 = CM564_257+s.In[5,55]*OpM26_4-FB355_4*s.l[1,55]+s.dpt[1,55]*(FB157_4*S56-FM564_357*C56)
  CM355_4 = -(CM157_4*S56-CM564_357*C56+FB155_4*s.l[2,55]-FB255_4*s.l[1,55]-FM564_257*s.dpt[1,55]+s.dpt[2,55]*(FB157_4*\
   C56+FM564_357*S56))
  ...
  CM155_5 = CM157_5*C56+CM565_357*S56+FB355_5*s.l[2,55]-s.dpt[2,55]*(FB157_5*S56-FM565_357*C56)
  CM255_5 = CM565_257+s.In[5,55]*C6-FB355_5*s.l[1,55]+s.dpt[1,55]*(FB157_5*S56-FM565_357*C56)
  CM355_5 = -(CM157_5*S56-CM565_357*C56+FB155_5*s.l[2,55]-FB255_5*s.l[1,55]-FM565_257*s.dpt[1,55]+s.dpt[2,55]*(FB157_5*\
   C56+FM565_357*S56))
  FB255_6 = -s.m[55]*(s.dpt[3,14]-s.l[1,55]*S54p55)
  FB355_6 = s.m[55]*s.l[2,55]*C54p55
  CM155_6 = CM157_6*C56+CM566_357*S56+FB355_6*s.l[2,55]-s.dpt[2,55]*(FB157_6*S56-FM566_357*C56)
  CM255_6 = CM566_257-FB355_6*s.l[1,55]+s.dpt[1,55]*(FB157_6*S56-FM566_357*C56)
  CM355_6 = s.m[55]*s.l[2,55]*s.l[2,55]*S54p55-CM157_6*S56+CM566_357*C56+FB255_6*s.l[1,55]+FM566_257*s.dpt[1,55]-\
   s.dpt[2,55]*(FB157_6*C56+FM566_357*S56)
  CM255_54 = s.In[5,55]+CM5654_257+s.m[55]*s.l[1,55]*s.l[1,55]-s.dpt[1,55]*(s.m[57]*AlM356_54*C56-FB157_54*S56)
  CM255_55 = s.In[5,55]+CM5655_257+s.m[55]*s.l[1,55]*s.l[1,55]-s.dpt[1,55]*(s.m[57]*AlM356_55*C56-FB157_55*S56)

# = = Block_0_2_0_1_0_23 = = 
 
# Backward Dynamics 

  FA159 = -(s.frc[1,59]-s.m[59]*(s.l[3,59]*(OpF259+OM159*OM359)+C58*(AlF154+BS154*s.dpt[1,54]+BeF254*s.dpt[2,54])-S58*(\
   AlF354+BeF754*s.dpt[1,54]+BeF854*s.dpt[2,54])))
  ...
  FB159_4 = s.m[59]*(OpM259_4*s.l[3,59]+C58*(AlM154_4-OpM354_4*s.dpt[2,54])-S58*(AlM354_4+OpM154_4*s.dpt[2,54]-OpM26_4*\
   s.dpt[1,54]))
  ...
  FB159_5 = s.m[59]*(OpM259_5*s.l[3,59]+C58*(AlM154_5-OpM354_5*s.dpt[2,54])-S58*(AlM354_5+OpM154_5*s.dpt[2,54]-\
   s.dpt[1,54]*C6))
  ...
  FB159_6 = s.m[59]*(OpM259_6*s.l[3,59]-s.dpt[2,54]*S54p58)
  ...
  FB159_54 = s.m[59]*(s.dpt[1,54]*S58+s.l[3,59]*C59)
...
# Backward Dynamics 
  ...
  FA163 = -(s.frc[1,63]-s.m[63]*(s.l[3,63]*(OpF263+OM163*OM363)+C62*(AlF161+BS161*s.dpt[1,59]+BeF261*s.dpt[2,59])-S62*(\
   AlF361+BeF761*s.dpt[1,59]+BeF861*s.dpt[2,59])))
  ...
  FB163_4 = s.m[63]*(OpM263_4*s.l[3,63]+C62*(AlM161_4-OpM361_4*s.dpt[2,59])-S62*(AlM361_4+OpM161_4*s.dpt[2,59]-OpM26_4*\
   s.dpt[1,59]))
  ...
  FB163_5 = s.m[63]*(OpM263_5*s.l[3,63]+C62*(AlM161_5-OpM361_5*s.dpt[2,59])-S62*(AlM361_5+OpM161_5*s.dpt[2,59]-\
   s.dpt[1,59]*C6))
  ...
  FB163_6 = s.m[63]*(OpM263_6*s.l[3,63]-s.dpt[2,59]*S60p61p62)
  ...
  FB163_60 = s.m[63]*(s.dpt[1,59]*S62+s.l[3,63]*C63)
  CM163_60 = -s.m[63]*AlM362_60*s.l[3,63]*S63
  FB163_61 = s.m[63]*(s.dpt[1,59]*S62+s.l[3,63]*C63)
  ...
  CF161 = -(s.trq[1,61]+s.In[5,61]*OM261*OM361-CF163*C62-CF62_363*S62-FA361*s.l[2,61]+s.dpt[2,59]*(FA163*S62-FF62_363*\
   C62))
  CF261 = -(s.trq[2,61]-CF62_263-s.In[5,61]*OpF26+FA361*s.l[1,61]-s.dpt[1,59]*(FA163*S62-FF62_363*C62))
  CF361 = -(s.trq[3,61]-s.In[5,61]*OM161*OM261+CF163*S62-CF62_363*C62+FA161*s.l[2,61]-FA261*s.l[1,61]-FF62_263*\
   s.dpt[1,59]+s.dpt[2,59]*(FA163*C62+FF62_363*S62))
  ...
  CM161_1 = CM163_1*C62+CM621_363*S62+FB361_1*s.l[2,61]-s.dpt[2,59]*(FB163_1*S62-FM621_363*C62)
  CM261_1 = CM621_263-FB361_1*s.l[1,61]+s.dpt[1,59]*(FB163_1*S62-FM621_363*C62)
  CM361_1 = -(CM163_1*S62-CM621_363*C62+FB161_1*s.l[2,61]-FB261_1*s.l[1,61]-FM621_263*s.dpt[1,59]+s.dpt[2,59]*(FB163_1*\
   C62+FM621_363*S62))
  ...
  CM161_2 = CM163_2*C62+CM622_363*S62+FB361_2*s.l[2,61]-s.dpt[2,59]*(FB163_2*S62-FM622_363*C62)
  CM261_2 = CM622_263-FB361_2*s.l[1,61]+s.dpt[1,59]*(FB163_2*S62-FM622_363*C62)
  CM361_2 = -(CM163_2*S62-CM622_363*C62+FB161_2*s.l[2,61]-FB261_2*s.l[1,61]-FM622_263*s.dpt[1,59]+s.dpt[2,59]*(FB163_2*\
   C62+FM622_363*S62))
  ...
  CM161_3 = CM163_3*C62+CM623_363*S62+FB361_3*s.l[2,61]-s.dpt[2,59]*(FB163_3*S62-FM623_363*C62)
  CM261_3 = CM623_263-FB361_3*s.l[1,61]+s.dpt[1,59]*(FB163_3*S62-FM623_363*C62)
  CM361_3 = -(CM163_3*S62-CM623_363*C62+FB161_3*s.l[2,61]-FB261_3*s.l[1,61]-FM623_263*s.dpt[1,59]+s.dpt[2,59]*(FB163_3*\
   C62+FM623_363*S62))
  ...
  CM161_4 = CM163_4*C62+CM624_363*S62+FB361_4*s.l[2,61]-s.dpt[2,59]*(FB163_4*S62-FM624_363*C62)
  CM261_4 = CM624_263+s.In[5,61]*OpM26_4-FB361_4*s.l[1,61]+s.dpt[1,59]*(FB163_4*S62-FM624_363*C62)
  CM361_4 = -(CM163_4*S62-CM624_363*C62+FB161_4*s.l[2,61]-FB261_4*s.l[1,61]-FM624_263*s.dpt[1,59]+s.dpt[2,59]*(FB163_4*\
   C62+FM624_363*S62))
  ...
  CM161_5 = CM163_5*C62+CM625_363*S62+FB361_5*s.l[2,61]-s.dpt[2,59]*(FB163_5*S62-FM625_363*C62)
  CM261_5 = CM625_263+s.In[5,61]*C6-FB361_5*s.l[1,61]+s.dpt[1,59]*(FB163_5*S62-FM625_363*C62)
  CM361_5 = -(CM163_5*S62-CM625_363*C62+FB161_5*s.l[2,61]-FB261_5*s.l[1,61]-FM625_263*s.dpt[1,59]+s.dpt[2,59]*(FB163_5*\
   C62+FM625_363*S62))
  FB261_6 = -s.m[61]*(s.dpt[3,15]-s.l[1,61]*S60p61)
  FB361_6 = s.m[61]*s.l[2,61]*C60p61
  CM161_6 = CM163_6*C62+CM626_363*S62+FB361_6*s.l[2,61]-s.dpt[2,59]*(FB163_6*S62-FM626_363*C62)
  CM261_6 = CM626_263-FB361_6*s.l[1,61]+s.dpt[1,59]*(FB163_6*S62-FM626_363*C62)
  CM361_6 = s.m[61]*s.l[2,61]*s.l[2,61]*S60p61-CM163_6*S62+CM626_363*C62+FB261_6*s.l[1,61]+FM626_263*s.dpt[1,59]-\
   s.dpt[2,59]*(FB163_6*C62+FM626_363*S62)
  CM261_60 = s.In[5,61]+CM6260_263+s.m[61]*s.l[1,61]*s.l[1,61]-s.dpt[1,59]*(s.m[63]*AlM362_60*C62-FB163_60*S62)
  CM261_61 = s.In[5,61]+CM6261_263+s.m[61]*s.l[1,61]*s.l[1,61]-s.dpt[1,59]*(s.m[63]*AlM362_61*C62-FB163_61*S62)

# = = Block_0_2_0_1_0_26 = = 
 
# Backward Dynamics 

  FA165 = -(s.frc[1,65]-s.m[65]*(s.l[3,65]*(OpF265+OM165*OM365)+C64*(AlF160+BS160*s.dpt[1,58]+BeF260*s.dpt[2,58])-S64*(\
   AlF360+BeF760*s.dpt[1,58]+BeF860*s.dpt[2,58])))
  ...
  FB165_4 = s.m[65]*(OpM265_4*s.l[3,65]+C64*(AlM160_4-OpM360_4*s.dpt[2,58])-S64*(AlM360_4+OpM160_4*s.dpt[2,58]-OpM26_4*\
   s.dpt[1,58]))
  ...
  FB165_5 = s.m[65]*(OpM265_5*s.l[3,65]+C64*(AlM160_5-OpM360_5*s.dpt[2,58])-S64*(AlM360_5+OpM160_5*s.dpt[2,58]-\
   s.dpt[1,58]*C6))
  ...
  FB165_6 = s.m[65]*(OpM265_6*s.l[3,65]-s.dpt[2,58]*S60p64)
  ...
  FB165_60 = s.m[65]*(s.dpt[1,58]*S64+s.l[3,65]*C65)
...
# Backward Dynamics 
  ...
  CF110 = -(s.trq[1,10]-CF11_112-CF13_114-s.In[1,10]*OpF110+FA210*s.l[3,10]+OM210*OM310*(s.In[5,10]-s.In[9,10])-\
   s.dpt[2,17]*(FA212*S11+FA312*C11)-s.dpt[2,18]*(FA214*S13+FF13_314*C13)+s.dpt[3,17]*(FA212*C11-FA312*S11)+s.dpt[3,18]*(FA214*\
   C13-FF13_314*S13))
  CF210 = -(s.trq[2,10]-s.In[5,10]*OpF29-CF11_212*C11+CF13_314*S13-CF214*C13+CF312*S11-FA110*s.l[3,10]-FA112*s.dpt[3,17]\
   -FF13_114*s.dpt[3,18]-OM110*OM310*(s.In[1,10]-s.In[9,10]))
  CF310 = -(s.trq[3,10]-s.In[9,10]*OpF310-CF11_212*S11-CF13_314*C13-CF214*S13-CF312*C11+FA112*s.dpt[2,17]+FF13_114*\
   s.dpt[2,18]+OM110*OM210*(s.In[1,10]-s.In[5,10]))
  ...
  CM110_1 = CM111_112-FB210_1*s.l[3,10]+s.dpt[2,17]*(FB212_1*S11+FB312_1*C11)+s.dpt[2,18]*(FB214_1*S13+FM131_314*C13)-\
   s.dpt[3,17]*(FB212_1*C11-FB312_1*S11)-s.dpt[3,18]*(FB214_1*C13-FM131_314*S13)
  CM210_1 = CM111_212*C11+FB110_1*s.l[3,10]+FB112_1*s.dpt[3,17]+FM131_114*s.dpt[3,18]
  CM310_1 = CM111_212*S11-FB112_1*s.dpt[2,17]-FM131_114*s.dpt[2,18]
  ...
  CM110_2 = CM112_112-FB210_2*s.l[3,10]+s.dpt[2,17]*(FB212_2*S11+FB312_2*C11)+s.dpt[2,18]*(FB214_2*S13+FM132_314*C13)-\
   s.dpt[3,17]*(FB212_2*C11-FB312_2*S11)-s.dpt[3,18]*(FB214_2*C13-FM132_314*S13)
  CM210_2 = CM112_212*C11+FB110_2*s.l[3,10]+FB112_2*s.dpt[3,17]+FM132_114*s.dpt[3,18]
  CM310_2 = CM112_212*S11-FB112_2*s.dpt[2,17]-FM132_114*s.dpt[2,18]
  ...
  CM110_3 = CM113_112-FB210_3*s.l[3,10]+s.dpt[2,17]*(FB212_3*S11+FB312_3*C11)+s.dpt[2,18]*(FB214_3*S13+FM133_314*C13)-\
   s.dpt[3,17]*(FB212_3*C11-FB312_3*S11)-s.dpt[3,18]*(FB214_3*C13-FM133_314*S13)
  CM210_3 = CM113_212*C11+FB110_3*s.l[3,10]+FB112_3*s.dpt[3,17]+FM133_114*s.dpt[3,18]
  CM310_3 = CM113_212*S11-FB112_3*s.dpt[2,17]-FM133_114*s.dpt[2,18]
  ...
  CM110_4 = CM114_112+CM134_114+s.In[1,10]*OpM110_4-FB210_4*s.l[3,10]+s.dpt[2,17]*(FB212_4*S11+FB312_4*C11)+s.dpt[2,18]*\
   (FB214_4*S13+FM134_314*C13)-s.dpt[3,17]*(FB212_4*C11-FB312_4*S11)-s.dpt[3,18]*(FB214_4*C13-FM134_314*S13)
  CM210_4 = s.In[5,10]*OpM29_4+CM114_212*C11-CM134_314*S13+CM214_4*C13-CM312_4*S11+FB110_4*s.l[3,10]+FB112_4*s.dpt[3,17]\
   +FM134_114*s.dpt[3,18]
  CM310_4 = s.In[9,10]*OpM310_4+CM114_212*S11+CM134_314*C13+CM214_4*S13+CM312_4*C11-FB112_4*s.dpt[2,17]-FM134_114*\
   s.dpt[2,18]
  ...
  CM110_5 = CM115_112+CM135_114+s.In[1,10]*OpM110_5-FB210_5*s.l[3,10]+s.dpt[2,17]*(FB212_5*S11+FB312_5*C11)+s.dpt[2,18]*\
   (FB214_5*S13+FM135_314*C13)-s.dpt[3,17]*(FB212_5*C11-FB312_5*S11)-s.dpt[3,18]*(FB214_5*C13-FM135_314*S13)
  CM210_5 = s.In[5,10]*OpM29_5+CM115_212*C11-CM135_314*S13+CM214_5*C13-CM312_5*S11+FB110_5*s.l[3,10]+FB112_5*s.dpt[3,17]\
   +FM135_114*s.dpt[3,18]
  CM310_5 = s.In[9,10]*OpM310_5+CM115_212*S11+CM135_314*C13+CM214_5*S13+CM312_5*C11-FB112_5*s.dpt[2,17]-FM135_114*\
   s.dpt[2,18]
  ...
  CM110_6 = CM116_112+CM136_114+s.In[1,10]*OpM110_6-FB210_6*s.l[3,10]+s.dpt[2,17]*(FB212_6*S11+FB312_6*C11)+s.dpt[2,18]*\
   (FB214_6*S13+FM136_314*C13)-s.dpt[3,17]*(FB212_6*C11-FB312_6*S11)-s.dpt[3,18]*(FB214_6*C13-FM136_314*S13)
  CM210_6 = s.In[5,10]*OpM29_6+CM116_212*C11-CM136_314*S13+CM214_6*C13-CM312_6*S11+FB110_6*s.l[3,10]+FB112_6*s.dpt[3,17]\
   +FM136_114*s.dpt[3,18]
  CM310_6 = s.In[9,10]*OpM310_6+CM116_212*S11+CM136_314*C13+CM214_6*S13+CM312_6*C11-FB112_6*s.dpt[2,17]-FM136_114*\
   s.dpt[2,18]
  FB110_7 = s.m[10]*(AlM110_7+OpM29_7*s.l[3,10])
  FB210_7 = s.m[10]*(AlM29_7-OpM110_7*s.l[3,10])
  CM110_7 = CM117_112+CM137_114+s.In[1,10]*OpM110_7-FB210_7*s.l[3,10]+s.dpt[2,17]*(FB212_7*S11+FB312_7*C11)+s.dpt[2,18]*\
   (FB214_7*S13+FM137_314*C13)-s.dpt[3,17]*(FB212_7*C11-FB312_7*S11)-s.dpt[3,18]*(FB214_7*C13-FM137_314*S13)
  CM210_7 = s.In[5,10]*OpM29_7+CM117_212*C11-CM137_314*S13+CM214_7*C13-CM312_7*S11+FB110_7*s.l[3,10]+FB112_7*s.dpt[3,17]\
   +FM137_114*s.dpt[3,18]
  CM310_7 = s.In[9,10]*OpM310_7+CM117_212*S11+CM137_314*C13+CM214_7*S13+CM312_7*C11-FB112_7*s.dpt[2,17]-FM137_114*\
   s.dpt[2,18]
  CM110_8 = CM118_112+CM138_114+s.In[1,10]*OpM110_8+s.m[10]*OpM110_8*s.l[3,10]*s.l[3,10]+s.dpt[2,17]*(FB212_8*S11+\
   FB312_8*C11)+s.dpt[2,18]*(FB214_8*S13+FM138_314*C13)-s.dpt[3,17]*(FB212_8*C11-FB312_8*S11)-s.dpt[3,18]*(FB214_8*C13-\
   FM138_314*S13)
  CM210_8 = CM118_212*C11-CM138_314*S13+CM214_8*C13-CM312_8*S11+FB112_8*s.dpt[3,17]+FM138_114*s.dpt[3,18]+S9*(s.In[5,10]\
   +s.m[10]*s.l[3,10]*s.l[3,10])
  CM310_8 = s.In[9,10]*OpM310_8+CM118_212*S11+CM138_314*C13+CM214_8*S13+CM312_8*C11-FB112_8*s.dpt[2,17]-FM138_114*\
   s.dpt[2,18]
  CM210_9 = CM119_212*C11-CM139_314*S13+CM214_9*C13-CM312_9*S11+FB112_9*s.dpt[3,17]+FM139_114*s.dpt[3,18]
  CM210_10 = s.In[5,10]+s.In[9,12]*S11*S11+s.m[10]*s.l[3,10]*s.l[3,10]+s.m[14]*s.dpt[3,18]*s.dpt[3,18]+CM214_10*C13+\
   FB112_10*s.dpt[3,17]+C11*(q[12]*FB112_10+s.In[5,12]*C11+FB112_10*s.l[3,12])+S13*(CM114_10*S14-CM314_10*C14)
  ...
  CM99_110 = C10*(CM119_112+CM139_114+s.In[1,10]*C10+s.m[10]*s.l[3,10]*s.l[3,10]*C10+s.dpt[2,17]*(FB212_9*S11+FB312_9*\
   C11)+s.dpt[2,18]*(FB214_9*S13+FM139_314*C13)-s.dpt[3,17]*(FB212_9*C11-FB312_9*S11)-s.dpt[3,18]*(FB214_9*C13-FM139_314*S13))+\
   S10*(s.In[9,10]*S10+CM119_212*S11+CM139_314*C13+CM214_9*S13+CM312_9*C11-FB112_9*s.dpt[2,17]-FM139_114*s.dpt[2,18])
  ...
  FF37 = FA37+FF8_39
  CF17 = -(s.trq[1,7]-s.In[1,7]*OpF15+CF8_29*S8-CF9_110*C8-FA37*s.l[2,7]-FF8_39*s.dpt[2,16])
  CF27 = -(s.trq[2,7]-s.In[1,7]*OM17*OM37-CF8_29*C8-CF9_110*S8+FA37*s.l[1,7])
  CF37 = -(s.trq[3,7]-CF8_39+s.In[1,7]*OM17*OM27+FA17*s.l[2,7]-FA27*s.l[1,7]-s.dpt[2,16]*(FF8_29*S8-FF9_110*C8))
  ...
  CM17_1 = -(CM81_29*S8-CM91_110*C8-FB37_1*s.l[2,7]-FM81_39*s.dpt[2,16])
  CM27_1 = CM81_29*C8+CM91_110*S8-FB37_1*s.l[1,7]
  CM37_1 = CM81_39-FB17_1*s.l[2,7]+FB27_1*s.l[1,7]+s.dpt[2,16]*(FM81_29*S8-FM91_110*C8)
  ...
  CM17_2 = -(CM82_29*S8-CM92_110*C8-FB37_2*s.l[2,7]-FM82_39*s.dpt[2,16])
  CM27_2 = CM82_29*C8+CM92_110*S8-FB37_2*s.l[1,7]
  CM37_2 = CM82_39-FB17_2*s.l[2,7]+FB27_2*s.l[1,7]+s.dpt[2,16]*(FM82_29*S8-FM92_110*C8)
  FB17_3 = -s.m[7]*S5
  ...
  CM17_3 = -(CM83_29*S8-CM93_110*C8-FB37_3*s.l[2,7]-FM83_39*s.dpt[2,16])
  CM27_3 = CM83_29*C8+CM93_110*S8-FB37_3*s.l[1,7]
  CM37_3 = CM83_39-FB17_3*s.l[2,7]+FB27_3*s.l[1,7]+s.dpt[2,16]*(FM83_29*S8-FM93_110*C8)
  ...
  CM17_4 = -(s.In[1,7]*S5+CM84_29*S8-CM94_110*C8-FB37_4*s.l[2,7]-FM84_39*s.dpt[2,16])
  CM27_4 = CM84_29*C8+CM94_110*S8-FB37_4*s.l[1,7]
  CM37_4 = CM84_39-FB17_4*s.l[2,7]+FB27_4*s.l[1,7]+s.dpt[2,16]*(FM84_29*S8-FM94_110*C8)
  ...
  CM17_5 = -(CM85_29*S8-CM95_110*C8-FB37_5*s.l[2,7]-FM85_39*s.dpt[2,16])
  CM27_5 = CM85_29*C8+CM95_110*S8-FB37_5*s.l[1,7]
  CM37_5 = CM85_39-FB17_5*s.l[2,7]+FB27_5*s.l[1,7]+s.dpt[2,16]*(FM85_29*S8-FM95_110*C8)
  FB37_6 = s.m[7]*(AlM37_6+s.l[2,7])
  CM17_6 = s.In[1,7]+CM96_110*C8+FB37_6*s.l[2,7]+FM86_39*s.dpt[2,16]-S8*(CM210_6*C9-CM96_310*S9)
  CM17_7 = s.In[1,7]+s.m[7]*s.l[2,7]*s.l[2,7]+CM97_110*C8+s.dpt[2,16]*(C9*(C10*(s.m[10]*AlM310_7+FB212_7*S11+FB214_7*S13\
...
# Backward Dynamics 
  ...
  CF118 = -(s.trq[1,18]-CF19_120-CF21_122-s.In[1,18]*OpF118+FA218*s.l[3,18]+OM218*OM318*(s.In[5,18]-s.In[9,18])-\
   s.dpt[2,24]*(FA220*S19+FA320*C19)-s.dpt[2,25]*(FA222*S21+FF21_322*C21)+s.dpt[3,24]*(FA220*C19-FA320*S19)+s.dpt[3,25]*(FA222*\
   C21-FF21_322*S21))
  CF218 = -(s.trq[2,18]-s.In[5,18]*OpF217-CF19_220*C19+CF21_322*S21-CF222*C21+CF320*S19-FA118*s.l[3,18]-FA120*\
   s.dpt[3,24]-FF21_122*s.dpt[3,25]-OM118*OM318*(s.In[1,18]-s.In[9,18]))
  CF318 = -(s.trq[3,18]-s.In[9,18]*OpF318-CF19_220*S19-CF21_322*C21-CF222*S21-CF320*C19+FA120*s.dpt[2,24]+FF21_122*\
   s.dpt[2,25]+OM118*OM218*(s.In[1,18]-s.In[5,18]))
  ...
  CM118_1 = CM191_120-FB218_1*s.l[3,18]+s.dpt[2,24]*(FB220_1*S19+FB320_1*C19)+s.dpt[2,25]*(FB222_1*S21+FM211_322*C21)-\
   s.dpt[3,24]*(FB220_1*C19-FB320_1*S19)-s.dpt[3,25]*(FB222_1*C21-FM211_322*S21)
  CM218_1 = CM191_220*C19+FB118_1*s.l[3,18]+FB120_1*s.dpt[3,24]+FM211_122*s.dpt[3,25]
  CM318_1 = CM191_220*S19-FB120_1*s.dpt[2,24]-FM211_122*s.dpt[2,25]
  ...
  CM118_2 = CM192_120-FB218_2*s.l[3,18]+s.dpt[2,24]*(FB220_2*S19+FB320_2*C19)+s.dpt[2,25]*(FB222_2*S21+FM212_322*C21)-\
   s.dpt[3,24]*(FB220_2*C19-FB320_2*S19)-s.dpt[3,25]*(FB222_2*C21-FM212_322*S21)
  CM218_2 = CM192_220*C19+FB118_2*s.l[3,18]+FB120_2*s.dpt[3,24]+FM212_122*s.dpt[3,25]
  CM318_2 = CM192_220*S19-FB120_2*s.dpt[2,24]-FM212_122*s.dpt[2,25]
  ...
  CM118_3 = CM193_120-FB218_3*s.l[3,18]+s.dpt[2,24]*(FB220_3*S19+FB320_3*C19)+s.dpt[2,25]*(FB222_3*S21+FM213_322*C21)-\
   s.dpt[3,24]*(FB220_3*C19-FB320_3*S19)-s.dpt[3,25]*(FB222_3*C21-FM213_322*S21)
  CM218_3 = CM193_220*C19+FB118_3*s.l[3,18]+FB120_3*s.dpt[3,24]+FM213_122*s.dpt[3,25]
  CM318_3 = CM193_220*S19-FB120_3*s.dpt[2,24]-FM213_122*s.dpt[2,25]
  ...
  CM118_4 = CM194_120+CM214_122+s.In[1,18]*OpM118_4-FB218_4*s.l[3,18]+s.dpt[2,24]*(FB220_4*S19+FB320_4*C19)+s.dpt[2,25]*\
   (FB222_4*S21+FM214_322*C21)-s.dpt[3,24]*(FB220_4*C19-FB320_4*S19)-s.dpt[3,25]*(FB222_4*C21-FM214_322*S21)
  CM218_4 = s.In[5,18]*OpM217_4+CM194_220*C19-CM214_322*S21+CM222_4*C21-CM320_4*S19+FB118_4*s.l[3,18]+FB120_4*\
   s.dpt[3,24]+FM214_122*s.dpt[3,25]
  CM318_4 = s.In[9,18]*OpM318_4+CM194_220*S19+CM214_322*C21+CM222_4*S21+CM320_4*C19-FB120_4*s.dpt[2,24]-FM214_122*\
   s.dpt[2,25]
  ...
  CM118_5 = CM195_120+CM215_122+s.In[1,18]*OpM118_5-FB218_5*s.l[3,18]+s.dpt[2,24]*(FB220_5*S19+FB320_5*C19)+s.dpt[2,25]*\
   (FB222_5*S21+FM215_322*C21)-s.dpt[3,24]*(FB220_5*C19-FB320_5*S19)-s.dpt[3,25]*(FB222_5*C21-FM215_322*S21)
  CM218_5 = s.In[5,18]*OpM217_5+CM195_220*C19-CM215_322*S21+CM222_5*C21-CM320_5*S19+FB118_5*s.l[3,18]+FB120_5*\
   s.dpt[3,24]+FM215_122*s.dpt[3,25]
  CM318_5 = s.In[9,18]*OpM318_5+CM195_220*S19+CM215_322*C21+CM222_5*S21+CM320_5*C19-FB120_5*s.dpt[2,24]-FM215_122*\
   s.dpt[2,25]
  ...
  CM118_6 = CM196_120+CM216_122+s.In[1,18]*OpM118_6-FB218_6*s.l[3,18]+s.dpt[2,24]*(FB220_6*S19+FB320_6*C19)+s.dpt[2,25]*\
   (FB222_6*S21+FM216_322*C21)-s.dpt[3,24]*(FB220_6*C19-FB320_6*S19)-s.dpt[3,25]*(FB222_6*C21-FM216_322*S21)
  CM218_6 = s.In[5,18]*OpM217_6+CM196_220*C19-CM216_322*S21+CM222_6*C21-CM320_6*S19+FB118_6*s.l[3,18]+FB120_6*\
   s.dpt[3,24]+FM216_122*s.dpt[3,25]
  CM318_6 = s.In[9,18]*OpM318_6+CM196_220*S19+CM216_322*C21+CM222_6*S21+CM320_6*C19-FB120_6*s.dpt[2,24]-FM216_122*\
   s.dpt[2,25]
  FB118_15 = s.m[18]*(AlM118_15+OpM217_15*s.l[3,18])
  FB218_15 = s.m[18]*(AlM217_15-OpM118_15*s.l[3,18])
  CM118_15 = CM1915_120+CM2115_122+s.In[1,18]*OpM118_15-FB218_15*s.l[3,18]+s.dpt[2,24]*(FB220_15*S19+FB320_15*C19)+\
   s.dpt[2,25]*(FB222_15*S21+FM2115_322*C21)-s.dpt[3,24]*(FB220_15*C19-FB320_15*S19)-s.dpt[3,25]*(FB222_15*C21-FM2115_322*S21)
  CM218_15 = s.In[5,18]*OpM217_15+CM1915_220*C19-CM2115_322*S21+CM222_15*C21-CM320_15*S19+FB118_15*s.l[3,18]+FB120_15*\
   s.dpt[3,24]+FM2115_122*s.dpt[3,25]
  CM318_15 = s.In[9,18]*OpM318_15+CM1915_220*S19+CM2115_322*C21+CM222_15*S21+CM320_15*C19-FB120_15*s.dpt[2,24]-\
   FM2115_122*s.dpt[2,25]
  CM118_16 = CM1916_120+CM2116_122+s.In[1,18]*OpM118_16+s.m[18]*OpM118_16*s.l[3,18]*s.l[3,18]+s.dpt[2,24]*(FB220_16*S19+\
   FB320_16*C19)+s.dpt[2,25]*(FB222_16*S21+FM2116_322*C21)-s.dpt[3,24]*(FB220_16*C19-FB320_16*S19)-s.dpt[3,25]*(FB222_16*C21-\
   FM2116_322*S21)
  CM218_16 = CM1916_220*C19-CM2116_322*S21+CM222_16*C21-CM320_16*S19+FB120_16*s.dpt[3,24]+FM2116_122*s.dpt[3,25]+S17*(\
   s.In[5,18]+s.m[18]*s.l[3,18]*s.l[3,18])
  CM318_16 = s.In[9,18]*OpM318_16+CM1916_220*S19+CM2116_322*C21+CM222_16*S21+CM320_16*C19-FB120_16*s.dpt[2,24]-\
   FM2116_122*s.dpt[2,25]
  CM218_17 = CM1917_220*C19-CM2117_322*S21+CM222_17*C21-CM320_17*S19+FB120_17*s.dpt[3,24]+FM2117_122*s.dpt[3,25]
  CM218_18 = s.In[5,18]+s.In[9,20]*S19*S19+s.m[18]*s.l[3,18]*s.l[3,18]+s.m[22]*s.dpt[3,25]*s.dpt[3,25]+CM222_18*C21+\
   FB120_18*s.dpt[3,24]+C19*(q[20]*FB120_18+s.In[5,20]*C19+FB120_18*s.l[3,20])+S21*(CM122_18*S22-CM322_18*C22)
  ...
  CM1717_118 = C18*(CM1917_120+CM2117_122+s.In[1,18]*C18+s.m[18]*s.l[3,18]*s.l[3,18]*C18+s.dpt[2,24]*(FB220_17*S19+\
   FB320_17*C19)+s.dpt[2,25]*(FB222_17*S21+FM2117_322*C21)-s.dpt[3,24]*(FB220_17*C19-FB320_17*S19)-s.dpt[3,25]*(FB222_17*C21-\
   FM2117_322*S21))+S18*(s.In[9,18]*S18+CM1917_220*S19+CM2117_322*C21+CM222_17*S21+CM320_17*C19-FB120_17*s.dpt[2,24]-FM2117_122\
   *s.dpt[2,25])
  ...
  CF115 = -(s.trq[1,15]-s.In[1,15]*OpF15+CF16_217*S16-CF17_118*C16-FA315*s.l[2,15]-FF16_317*s.dpt[2,23])
  CF215 = -(s.trq[2,15]-s.In[1,15]*OM115*OM315-CF16_217*C16-CF17_118*S16+FA315*s.l[1,15])
  CF315 = -(s.trq[3,15]-CF16_317+s.In[1,15]*OM115*OM215+FA115*s.l[2,15]-FA215*s.l[1,15]-s.dpt[2,23]*(FF16_217*S16-\
   FF17_118*C16))
  ...
  CM115_1 = -(CM161_217*S16-CM171_118*C16-FB315_1*s.l[2,15]-FM161_317*s.dpt[2,23])
  CM215_1 = CM161_217*C16+CM171_118*S16-FB315_1*s.l[1,15]
  CM315_1 = CM161_317-FB115_1*s.l[2,15]+FB215_1*s.l[1,15]+s.dpt[2,23]*(FM161_217*S16-FM171_118*C16)
  ...
  CM115_2 = -(CM162_217*S16-CM172_118*C16-FB315_2*s.l[2,15]-FM162_317*s.dpt[2,23])
  CM215_2 = CM162_217*C16+CM172_118*S16-FB315_2*s.l[1,15]
  CM315_2 = CM162_317-FB115_2*s.l[2,15]+FB215_2*s.l[1,15]+s.dpt[2,23]*(FM162_217*S16-FM172_118*C16)
  FB115_3 = -s.m[15]*S5
  ...
  CM115_3 = -(CM163_217*S16-CM173_118*C16-FB315_3*s.l[2,15]-FM163_317*s.dpt[2,23])
  CM215_3 = CM163_217*C16+CM173_118*S16-FB315_3*s.l[1,15]
  CM315_3 = CM163_317-FB115_3*s.l[2,15]+FB215_3*s.l[1,15]+s.dpt[2,23]*(FM163_217*S16-FM173_118*C16)
  ...
  CM115_4 = -(s.In[1,15]*S5+CM164_217*S16-CM174_118*C16-FB315_4*s.l[2,15]-FM164_317*s.dpt[2,23])
  CM215_4 = CM164_217*C16+CM174_118*S16-FB315_4*s.l[1,15]
  CM315_4 = CM164_317-FB115_4*s.l[2,15]+FB215_4*s.l[1,15]+s.dpt[2,23]*(FM164_217*S16-FM174_118*C16)
  ...
  CM115_5 = -(CM165_217*S16-CM175_118*C16-FB315_5*s.l[2,15]-FM165_317*s.dpt[2,23])
  CM215_5 = CM165_217*C16+CM175_118*S16-FB315_5*s.l[1,15]
  CM315_5 = CM165_317-FB115_5*s.l[2,15]+FB215_5*s.l[1,15]+s.dpt[2,23]*(FM165_217*S16-FM175_118*C16)
  FB315_6 = s.m[15]*(AlM315_6+s.l[2,15])
  CM115_6 = s.In[1,15]+CM176_118*C16+FB315_6*s.l[2,15]+FM166_317*s.dpt[2,23]+S16*(CM176_318*S17-CM218_6*C17)
  CM115_15 = s.In[1,15]+s.m[15]*s.l[2,15]*s.l[2,15]+CM1715_118*C16+s.dpt[2,23]*(C17*(C18*(s.m[18]*AlM318_15+FB220_15*S19\
...
# Backward Dynamics 
  ...
  CF133 = -(s.trq[1,33]-CF34_135-CF36_137-s.In[1,33]*OpF133+FA233*s.l[3,33]-FA333*s.l[2,33]+OM233*OM333*(s.In[5,33]-\
   s.In[9,33])-s.dpt[2,34]*(FA235*S34+FA335*C34)-s.dpt[2,35]*(FA237*S36+FF36_337*C36)+s.dpt[3,34]*(FA235*C34-FA335*S34)+\
   s.dpt[3,35]*(FA237*C36-FF36_337*S36))
  CF233 = -(s.trq[2,33]-s.In[5,33]*OpF233-CF237*C36+CF335*S34-CF34_235*C34+CF36_337*S36-FA133*s.l[3,33]-FA135*\
   s.dpt[3,34]-FF36_137*s.dpt[3,35]-OM133*OM333*(s.In[1,33]-s.In[9,33]))
  CF333 = -(s.trq[3,33]-s.In[9,33]*OpF332-CF237*S36-CF335*C34-CF34_235*S34-CF36_337*C36+FA133*s.l[2,33]+FA135*\
   s.dpt[2,34]+FF36_137*s.dpt[2,35]+OM133*OM233*(s.In[1,33]-s.In[5,33]))
  ...
  CM133_1 = CM341_135-FB233_1*s.l[3,33]+FB333_1*s.l[2,33]+s.dpt[2,34]*(FB235_1*S34+FB335_1*C34)+s.dpt[2,35]*(FB237_1*S36\
   +FM361_337*C36)-s.dpt[3,34]*(FB235_1*C34-FB335_1*S34)-s.dpt[3,35]*(FB237_1*C36-FM361_337*S36)
  CM233_1 = CM341_235*C34+FB133_1*s.l[3,33]+FB135_1*s.dpt[3,34]+FM361_137*s.dpt[3,35]
  CM333_1 = CM341_235*S34-FB133_1*s.l[2,33]-FB135_1*s.dpt[2,34]-FM361_137*s.dpt[2,35]
  ...
  CM133_2 = CM342_135-FB233_2*s.l[3,33]+FB333_2*s.l[2,33]+s.dpt[2,34]*(FB235_2*S34+FB335_2*C34)+s.dpt[2,35]*(FB237_2*S36\
   +FM362_337*C36)-s.dpt[3,34]*(FB235_2*C34-FB335_2*S34)-s.dpt[3,35]*(FB237_2*C36-FM362_337*S36)
  CM233_2 = CM342_235*C34+FB133_2*s.l[3,33]+FB135_2*s.dpt[3,34]+FM362_137*s.dpt[3,35]
  CM333_2 = CM342_235*S34-FB133_2*s.l[2,33]-FB135_2*s.dpt[2,34]-FM362_137*s.dpt[2,35]
  ...
  CM133_3 = CM343_135-FB233_3*s.l[3,33]+FB333_3*s.l[2,33]+s.dpt[2,34]*(FB235_3*S34+FB335_3*C34)+s.dpt[2,35]*(FB237_3*S36\
   +FM363_337*C36)-s.dpt[3,34]*(FB235_3*C34-FB335_3*S34)-s.dpt[3,35]*(FB237_3*C36-FM363_337*S36)
  CM233_3 = CM343_235*C34+FB133_3*s.l[3,33]+FB135_3*s.dpt[3,34]+FM363_137*s.dpt[3,35]
  CM333_3 = CM343_235*S34-FB133_3*s.l[2,33]-FB135_3*s.dpt[2,34]-FM363_137*s.dpt[2,35]
  ...
  CM133_4 = CM344_135+CM364_137+s.In[1,33]*OpM133_4-FB233_4*s.l[3,33]+FB333_4*s.l[2,33]+s.dpt[2,34]*(FB235_4*S34+FB335_4\
   *C34)+s.dpt[2,35]*(FB237_4*S36+FM364_337*C36)-s.dpt[3,34]*(FB235_4*C34-FB335_4*S34)-s.dpt[3,35]*(FB237_4*C36-FM364_337*S36)
  CM233_4 = s.In[5,33]*OpM233_4+CM237_4*C36-CM335_4*S34+CM344_235*C34-CM364_337*S36+FB133_4*s.l[3,33]+FB135_4*\
   s.dpt[3,34]+FM364_137*s.dpt[3,35]
  CM333_4 = s.In[9,33]*OpM332_4+CM237_4*S36+CM335_4*C34+CM344_235*S34+CM364_337*C36-FB133_4*s.l[2,33]-FB135_4*\
   s.dpt[2,34]-FM364_137*s.dpt[2,35]
  ...
  CM133_5 = CM345_135+CM365_137+s.In[1,33]*OpM133_5-FB233_5*s.l[3,33]+FB333_5*s.l[2,33]+s.dpt[2,34]*(FB235_5*S34+FB335_5\
   *C34)+s.dpt[2,35]*(FB237_5*S36+FM365_337*C36)-s.dpt[3,34]*(FB235_5*C34-FB335_5*S34)-s.dpt[3,35]*(FB237_5*C36-FM365_337*S36)
  CM233_5 = s.In[5,33]*OpM233_5+CM237_5*C36-CM335_5*S34+CM345_235*C34-CM365_337*S36+FB133_5*s.l[3,33]+FB135_5*\
   s.dpt[3,34]+FM365_137*s.dpt[3,35]
  CM333_5 = s.In[9,33]*OpM332_5+CM237_5*S36+CM335_5*C34+CM345_235*S34+CM365_337*C36-FB133_5*s.l[2,33]-FB135_5*\
   s.dpt[2,34]-FM365_137*s.dpt[2,35]
  ...
  CM133_6 = CM346_135+CM366_137+s.In[1,33]*OpM133_6-FB233_6*s.l[3,33]+FB333_6*s.l[2,33]+s.dpt[2,34]*(FB235_6*S34+FB335_6\
   *C34)+s.dpt[2,35]*(FB237_6*S36+FM366_337*C36)-s.dpt[3,34]*(FB235_6*C34-FB335_6*S34)-s.dpt[3,35]*(FB237_6*C36-FM366_337*S36)
  CM233_6 = s.In[5,33]*OpM233_6+CM237_6*C36-CM335_6*S34+CM346_235*C34-CM366_337*S36+FB133_6*s.l[3,33]+FB135_6*\
   s.dpt[3,34]+FM366_137*s.dpt[3,35]
  CM333_6 = s.In[9,33]*OpM332_6+CM237_6*S36+CM335_6*C34+CM346_235*S34+CM366_337*C36-FB133_6*s.l[2,33]-FB135_6*\
   s.dpt[2,34]-FM366_137*s.dpt[2,35]
  ...
  CM133_29 = CM3429_135+CM3629_137+s.In[1,33]*OpM133_29-FB233_29*s.l[3,33]+FB333_29*s.l[2,33]+s.dpt[2,34]*(FB235_29*S34+\
   FB335_29*C34)+s.dpt[2,35]*(FB237_29*S36+FM3629_337*C36)-s.dpt[3,34]*(FB235_29*C34-FB335_29*S34)-s.dpt[3,35]*(FB237_29*C36-\
   FM3629_337*S36)
  CM233_29 = s.In[5,33]*OpM233_29+CM237_29*C36-CM335_29*S34+CM3429_235*C34-CM3629_337*S36+FB133_29*s.l[3,33]+FB135_29*\
   s.dpt[3,34]+FM3629_137*s.dpt[3,35]
  CM333_29 = s.In[9,33]*OpM332_29+CM237_29*S36+CM335_29*C34+CM3429_235*S34+CM3629_337*C36-FB133_29*s.l[2,33]-FB135_29*\
   s.dpt[2,34]-FM3629_137*s.dpt[2,35]
  ...
  CM133_30 = CM3430_135+CM3630_137+s.In[1,33]*OpM133_30-FB233_30*s.l[3,33]+FB333_30*s.l[2,33]+s.dpt[2,34]*(FB235_30*S34+\
   FB335_30*C34)+s.dpt[2,35]*(FB237_30*S36+FM3630_337*C36)-s.dpt[3,34]*(FB235_30*C34-FB335_30*S34)-s.dpt[3,35]*(FB237_30*C36-\
   FM3630_337*S36)
  CM233_30 = s.In[5,33]*OpM233_30+CM237_30*C36-CM335_30*S34+CM3430_235*C34-CM3630_337*S36+FB133_30*s.l[3,33]+FB135_30*\
   s.dpt[3,34]+FM3630_137*s.dpt[3,35]
  CM333_30 = s.In[9,33]*OpM332_30+CM237_30*S36+CM335_30*C34+CM3430_235*S34+CM3630_337*C36-FB133_30*s.l[2,33]-FB135_30*\
   s.dpt[2,34]-FM3630_137*s.dpt[2,35]
  ...
  CM133_31 = CM3431_135+CM3631_137+s.In[1,33]*OpM133_31+s.m[33]*OpM133_31*s.l[2,33]*s.l[2,33]+s.m[33]*OpM133_31*\
   s.l[3,33]*s.l[3,33]+s.dpt[2,34]*(FB235_31*S34+FB335_31*C34)+s.dpt[2,35]*(FB237_31*S36+FM3631_337*C36)-s.dpt[3,34]*(FB235_31*\
   C34-FB335_31*S34)-s.dpt[3,35]*(FB237_31*C36-FM3631_337*S36)
  CM233_31 = s.In[5,33]*OpM233_31+CM237_31*C36-CM335_31*S34+CM3431_235*C34-CM3631_337*S36+FB133_31*s.l[3,33]+FB135_31*\
   s.dpt[3,34]+FM3631_137*s.dpt[3,35]
  CM333_31 = s.In[9,33]*S32+CM237_31*S36+CM335_31*C34+CM3431_235*S34+CM3631_337*C36-FB133_31*s.l[2,33]-FB135_31*\
   s.dpt[2,34]-FM3631_137*s.dpt[2,35]
  FB133_32 = s.m[33]*s.l[3,33]*C33
  CM333_32 = CM237_32*S36+CM335_32*C34+CM3432_235*S34+CM3632_337*C36-FB133_32*s.l[2,33]-FB135_32*s.dpt[2,34]-FM3632_137*\
   s.dpt[2,35]
  CM333_33 = s.In[9,33]+s.In[9,35]*C34*C34+s.m[33]*s.l[2,33]*s.l[2,33]+s.m[37]*s.dpt[2,35]*s.dpt[2,35]+CM237_33*S36-\
   FB135_33*s.dpt[2,34]+S34*(q[35]*FB135_33+s.In[5,35]*S34+FB135_33*s.l[3,35])-C36*(CM137_33*S37-CM337_33*C37)
  ...
  CM3232_233 = C33*(s.In[5,33]*C33+CM237_32*C36-CM335_32*S34+CM3432_235*C34-CM3632_337*S36+FB133_32*s.l[3,33]+FB135_32*\
   s.dpt[3,34]+FM3632_137*s.dpt[3,35])+S33*(CM3432_135+CM3632_137+s.In[1,33]*S33+s.m[33]*s.l[2,33]*s.l[2,33]*S33+s.m[33]*\
   s.l[3,33]*s.l[3,33]*S33+s.dpt[2,34]*(FB235_32*S34+FB335_32*C34)+s.dpt[2,35]*(FB237_32*S36+FM3632_337*C36)-s.dpt[3,34]*(\
   FB235_32*C34-FB335_32*S34)-s.dpt[3,35]*(FB237_32*C36-FM3632_337*S36))
  ...
  CF130 = -(s.trq[1,30]-CF31_132-s.In[1,30]*OpF130-s.In[9,30]*OM230*OM330-FA330*s.l[2,30]-s.dpt[2,33]*(FF31_332*C31+\
   FF32_233*S31))
  ...
  CM130_1 = CM311_132+FB330_1*s.l[2,30]+s.dpt[2,33]*(FM311_332*C31+FM321_233*S31)
  CM330_1 = CM311_332*C31+CM321_233*S31-FB130_1*s.l[2,30]-FM311_132*s.dpt[2,33]
  ...
  CM130_2 = CM312_132+FB330_2*s.l[2,30]+s.dpt[2,33]*(FM312_332*C31+FM322_233*S31)
  CM330_2 = CM312_332*C31+CM322_233*S31-FB130_2*s.l[2,30]-FM312_132*s.dpt[2,33]
  ...
  CM130_3 = CM313_132+FB330_3*s.l[2,30]+s.dpt[2,33]*(FM313_332*C31+FM323_233*S31)
  CM330_3 = CM313_332*C31+CM323_233*S31-FB130_3*s.l[2,30]-FM313_132*s.dpt[2,33]
  ...
  CM130_4 = CM314_132+s.In[1,30]*OpM130_4+FB330_4*s.l[2,30]+s.dpt[2,33]*(FM314_332*C31+FM324_233*S31)
  CM330_4 = s.In[9,30]*OpM329_4+CM314_332*C31+CM324_233*S31-FB130_4*s.l[2,30]-FM314_132*s.dpt[2,33]
  ...
  CM130_5 = CM315_132+s.In[1,30]*OpM130_5+FB330_5*s.l[2,30]+s.dpt[2,33]*(FM315_332*C31+FM325_233*S31)
  CM330_5 = CM315_332*C31+CM325_233*S31-FM315_132*s.dpt[2,33]-s.In[9,30]*S29p6-FB130_5*s.l[2,30]
  FB130_6 = s.m[30]*AlM130_6
  FB330_6 = s.m[30]*(AlM329_6+s.l[2,30]*C30)
  CM330_6 = CM316_332*C31+CM326_233*S31-FB130_6*s.l[2,30]-FM316_132*s.dpt[2,33]
  CM3029_331 = CM3129_332*C31+CM3229_233*S31-s.dpt[2,33]*(FM3229_133*C32+FM333_29*S32)
  CM330_30 = s.In[9,30]+s.m[30]*s.l[2,30]*s.l[2,30]+CM3230_233*S31-s.dpt[2,33]*(C32*(C33*(FB133_30+FB135_30+FM3630_137)-\
  ...
  CM296_130 = C30*(CM316_132+s.In[1,30]*C30+FB330_6*s.l[2,30]+s.dpt[2,33]*(FM316_332*C31+FM326_233*S31))+S30*(CM316_332*\
   S31-CM326_233*C31)
  CM2929_130 = C30*(CM3129_132+s.In[1,30]*C30+s.m[30]*s.l[2,30]*s.l[2,30]*C30-s.dpt[2,33]*(C31*(FM3229_133*S32-FM333_29*\
...
# Backward Dynamics 
  ...
  CF144 = -(s.trq[1,44]-CF45_146-CF47_148-s.In[1,44]*OpF144+FA244*s.l[3,44]-FA344*s.l[2,44]+OM244*OM344*(s.In[5,44]-\
   s.In[9,44])-s.dpt[2,45]*(FA246*S45+FA346*C45)-s.dpt[2,46]*(FA248*S47+FF47_348*C47)+s.dpt[3,45]*(FA246*C45-FA346*S45)+\
   s.dpt[3,46]*(FA248*C47-FF47_348*S47))
  CF244 = -(s.trq[2,44]-s.In[5,44]*OpF244-CF248*C47+CF346*S45-CF45_246*C45+CF47_348*S47-FA144*s.l[3,44]-FA146*\
   s.dpt[3,45]-FF47_148*s.dpt[3,46]-OM144*OM344*(s.In[1,44]-s.In[9,44]))
  CF344 = -(s.trq[3,44]-s.In[9,44]*OpF343-CF248*S47-CF346*C45-CF45_246*S45-CF47_348*C47+FA144*s.l[2,44]+FA146*\
   s.dpt[2,45]+FF47_148*s.dpt[2,46]+OM144*OM244*(s.In[1,44]-s.In[5,44]))
  ...
  CM144_1 = CM451_146-FB244_1*s.l[3,44]+FB344_1*s.l[2,44]+s.dpt[2,45]*(FB246_1*S45+FB346_1*C45)+s.dpt[2,46]*(FB248_1*S47\
   +FM471_348*C47)-s.dpt[3,45]*(FB246_1*C45-FB346_1*S45)-s.dpt[3,46]*(FB248_1*C47-FM471_348*S47)
  CM244_1 = CM451_246*C45+FB144_1*s.l[3,44]+FB146_1*s.dpt[3,45]+FM471_148*s.dpt[3,46]
  CM344_1 = CM451_246*S45-FB144_1*s.l[2,44]-FB146_1*s.dpt[2,45]-FM471_148*s.dpt[2,46]
  ...
  CM144_2 = CM452_146-FB244_2*s.l[3,44]+FB344_2*s.l[2,44]+s.dpt[2,45]*(FB246_2*S45+FB346_2*C45)+s.dpt[2,46]*(FB248_2*S47\
   +FM472_348*C47)-s.dpt[3,45]*(FB246_2*C45-FB346_2*S45)-s.dpt[3,46]*(FB248_2*C47-FM472_348*S47)
  CM244_2 = CM452_246*C45+FB144_2*s.l[3,44]+FB146_2*s.dpt[3,45]+FM472_148*s.dpt[3,46]
  CM344_2 = CM452_246*S45-FB144_2*s.l[2,44]-FB146_2*s.dpt[2,45]-FM472_148*s.dpt[2,46]
  ...
  CM144_3 = CM453_146-FB244_3*s.l[3,44]+FB344_3*s.l[2,44]+s.dpt[2,45]*(FB246_3*S45+FB346_3*C45)+s.dpt[2,46]*(FB248_3*S47\
   +FM473_348*C47)-s.dpt[3,45]*(FB246_3*C45-FB346_3*S45)-s.dpt[3,46]*(FB248_3*C47-FM473_348*S47)
  CM244_3 = CM453_246*C45+FB144_3*s.l[3,44]+FB146_3*s.dpt[3,45]+FM473_148*s.dpt[3,46]
  CM344_3 = CM453_246*S45-FB144_3*s.l[2,44]-FB146_3*s.dpt[2,45]-FM473_148*s.dpt[2,46]
  ...
  CM144_4 = CM454_146+CM474_148+s.In[1,44]*OpM144_4-FB244_4*s.l[3,44]+FB344_4*s.l[2,44]+s.dpt[2,45]*(FB246_4*S45+FB346_4\
   *C45)+s.dpt[2,46]*(FB248_4*S47+FM474_348*C47)-s.dpt[3,45]*(FB246_4*C45-FB346_4*S45)-s.dpt[3,46]*(FB248_4*C47-FM474_348*S47)
  CM244_4 = s.In[5,44]*OpM244_4+CM248_4*C47-CM346_4*S45+CM454_246*C45-CM474_348*S47+FB144_4*s.l[3,44]+FB146_4*\
   s.dpt[3,45]+FM474_148*s.dpt[3,46]
  CM344_4 = s.In[9,44]*OpM343_4+CM248_4*S47+CM346_4*C45+CM454_246*S45+CM474_348*C47-FB144_4*s.l[2,44]-FB146_4*\
   s.dpt[2,45]-FM474_148*s.dpt[2,46]
  ...
  CM144_5 = CM455_146+CM475_148+s.In[1,44]*OpM144_5-FB244_5*s.l[3,44]+FB344_5*s.l[2,44]+s.dpt[2,45]*(FB246_5*S45+FB346_5\
   *C45)+s.dpt[2,46]*(FB248_5*S47+FM475_348*C47)-s.dpt[3,45]*(FB246_5*C45-FB346_5*S45)-s.dpt[3,46]*(FB248_5*C47-FM475_348*S47)
  CM244_5 = s.In[5,44]*OpM244_5+CM248_5*C47-CM346_5*S45+CM455_246*C45-CM475_348*S47+FB144_5*s.l[3,44]+FB146_5*\
   s.dpt[3,45]+FM475_148*s.dpt[3,46]
  CM344_5 = s.In[9,44]*OpM343_5+CM248_5*S47+CM346_5*C45+CM455_246*S45+CM475_348*C47-FB144_5*s.l[2,44]-FB146_5*\
   s.dpt[2,45]-FM475_148*s.dpt[2,46]
  ...
  CM144_6 = CM456_146+CM476_148+s.In[1,44]*OpM144_6-FB244_6*s.l[3,44]+FB344_6*s.l[2,44]+s.dpt[2,45]*(FB246_6*S45+FB346_6\
   *C45)+s.dpt[2,46]*(FB248_6*S47+FM476_348*C47)-s.dpt[3,45]*(FB246_6*C45-FB346_6*S45)-s.dpt[3,46]*(FB248_6*C47-FM476_348*S47)
  CM244_6 = s.In[5,44]*OpM244_6+CM248_6*C47-CM346_6*S45+CM456_246*C45-CM476_348*S47+FB144_6*s.l[3,44]+FB146_6*\
   s.dpt[3,45]+FM476_148*s.dpt[3,46]
  CM344_6 = s.In[9,44]*OpM343_6+CM248_6*S47+CM346_6*C45+CM456_246*S45+CM476_348*C47-FB144_6*s.l[2,44]-FB146_6*\
   s.dpt[2,45]-FM476_148*s.dpt[2,46]
  ...
  CM144_40 = CM4540_146+CM4740_148+s.In[1,44]*OpM144_40-FB244_40*s.l[3,44]+FB344_40*s.l[2,44]+s.dpt[2,45]*(FB246_40*S45+\
   FB346_40*C45)+s.dpt[2,46]*(FB248_40*S47+FM4740_348*C47)-s.dpt[3,45]*(FB246_40*C45-FB346_40*S45)-s.dpt[3,46]*(FB248_40*C47-\
   FM4740_348*S47)
  CM244_40 = s.In[5,44]*OpM244_40+CM248_40*C47-CM346_40*S45+CM4540_246*C45-CM4740_348*S47+FB144_40*s.l[3,44]+FB146_40*\
   s.dpt[3,45]+FM4740_148*s.dpt[3,46]
  CM344_40 = s.In[9,44]*OpM343_40+CM248_40*S47+CM346_40*C45+CM4540_246*S45+CM4740_348*C47-FB144_40*s.l[2,44]-FB146_40*\
   s.dpt[2,45]-FM4740_148*s.dpt[2,46]
  ...
  CM144_41 = CM4541_146+CM4741_148+s.In[1,44]*OpM144_41-FB244_41*s.l[3,44]+FB344_41*s.l[2,44]+s.dpt[2,45]*(FB246_41*S45+\
   FB346_41*C45)+s.dpt[2,46]*(FB248_41*S47+FM4741_348*C47)-s.dpt[3,45]*(FB246_41*C45-FB346_41*S45)-s.dpt[3,46]*(FB248_41*C47-\
   FM4741_348*S47)
  CM244_41 = s.In[5,44]*OpM244_41+CM248_41*C47-CM346_41*S45+CM4541_246*C45-CM4741_348*S47+FB144_41*s.l[3,44]+FB146_41*\
   s.dpt[3,45]+FM4741_148*s.dpt[3,46]
  CM344_41 = s.In[9,44]*OpM343_41+CM248_41*S47+CM346_41*C45+CM4541_246*S45+CM4741_348*C47-FB144_41*s.l[2,44]-FB146_41*\
   s.dpt[2,45]-FM4741_148*s.dpt[2,46]
  ...
  CM144_42 = CM4542_146+CM4742_148+s.In[1,44]*OpM144_42+s.m[44]*OpM144_42*s.l[2,44]*s.l[2,44]+s.m[44]*OpM144_42*\
   s.l[3,44]*s.l[3,44]+s.dpt[2,45]*(FB246_42*S45+FB346_42*C45)+s.dpt[2,46]*(FB248_42*S47+FM4742_348*C47)-s.dpt[3,45]*(FB246_42*\
   C45-FB346_42*S45)-s.dpt[3,46]*(FB248_42*C47-FM4742_348*S47)
  CM244_42 = s.In[5,44]*OpM244_42+CM248_42*C47-CM346_42*S45+CM4542_246*C45-CM4742_348*S47+FB144_42*s.l[3,44]+FB146_42*\
   s.dpt[3,45]+FM4742_148*s.dpt[3,46]
  CM344_42 = s.In[9,44]*S43+CM248_42*S47+CM346_42*C45+CM4542_246*S45+CM4742_348*C47-FB144_42*s.l[2,44]-FB146_42*\
   s.dpt[2,45]-FM4742_148*s.dpt[2,46]
  FB144_43 = s.m[44]*s.l[3,44]*C44
  CM344_43 = CM248_43*S47+CM346_43*C45+CM4543_246*S45+CM4743_348*C47-FB144_43*s.l[2,44]-FB146_43*s.dpt[2,45]-FM4743_148*\
   s.dpt[2,46]
  CM344_44 = s.In[9,44]+s.In[9,46]*C45*C45+s.m[44]*s.l[2,44]*s.l[2,44]+s.m[48]*s.dpt[2,46]*s.dpt[2,46]+CM248_44*S47-\
   FB146_44*s.dpt[2,45]+S45*(q[46]*FB146_44+s.In[5,46]*S45+FB146_44*s.l[3,46])-C47*(CM148_44*S48-CM348_44*C48)
  ...
  CM4343_244 = C44*(s.In[5,44]*C44+CM248_43*C47-CM346_43*S45+CM4543_246*C45-CM4743_348*S47+FB144_43*s.l[3,44]+FB146_43*\
   s.dpt[3,45]+FM4743_148*s.dpt[3,46])+S44*(CM4543_146+CM4743_148+s.In[1,44]*S44+s.m[44]*s.l[2,44]*s.l[2,44]*S44+s.m[44]*\
   s.l[3,44]*s.l[3,44]*S44+s.dpt[2,45]*(FB246_43*S45+FB346_43*C45)+s.dpt[2,46]*(FB248_43*S47+FM4743_348*C47)-s.dpt[3,45]*(\
   FB246_43*C45-FB346_43*S45)-s.dpt[3,46]*(FB248_43*C47-FM4743_348*S47))
  ...
  CF141 = -(s.trq[1,41]-CF42_143-s.In[1,41]*OpF141-s.In[9,41]*OM241*OM341-FA341*s.l[2,41]-s.dpt[2,42]*(FF42_343*C42+\
   FF43_244*S42))
  ...
  CM141_1 = CM421_143+FB341_1*s.l[2,41]+s.dpt[2,42]*(FM421_343*C42+FM431_244*S42)
  CM341_1 = CM421_343*C42+CM431_244*S42-FB141_1*s.l[2,41]-FM421_143*s.dpt[2,42]
  ...
  CM141_2 = CM422_143+FB341_2*s.l[2,41]+s.dpt[2,42]*(FM422_343*C42+FM432_244*S42)
  CM341_2 = CM422_343*C42+CM432_244*S42-FB141_2*s.l[2,41]-FM422_143*s.dpt[2,42]
  ...
  CM141_3 = CM423_143+FB341_3*s.l[2,41]+s.dpt[2,42]*(FM423_343*C42+FM433_244*S42)
  CM341_3 = CM423_343*C42+CM433_244*S42-FB141_3*s.l[2,41]-FM423_143*s.dpt[2,42]
  ...
  CM141_4 = CM424_143+s.In[1,41]*OpM141_4+FB341_4*s.l[2,41]+s.dpt[2,42]*(FM424_343*C42+FM434_244*S42)
  CM341_4 = s.In[9,41]*OpM340_4+CM424_343*C42+CM434_244*S42-FB141_4*s.l[2,41]-FM424_143*s.dpt[2,42]
  ...
  CM141_5 = CM425_143+s.In[1,41]*OpM141_5+FB341_5*s.l[2,41]+s.dpt[2,42]*(FM425_343*C42+FM435_244*S42)
  CM341_5 = CM425_343*C42+CM435_244*S42-FM425_143*s.dpt[2,42]-s.In[9,41]*S40p6-FB141_5*s.l[2,41]
  FB141_6 = s.m[41]*AlM141_6
  FB341_6 = s.m[41]*(AlM340_6+s.l[2,41]*C41)
  CM341_6 = CM426_343*C42+CM436_244*S42-FB141_6*s.l[2,41]-FM426_143*s.dpt[2,42]
  CM4140_342 = CM4240_343*C42+CM4340_244*S42-s.dpt[2,42]*(FM344_40*S43+FM4340_144*C43)
  CM341_41 = s.In[9,41]+s.m[41]*s.l[2,41]*s.l[2,41]+CM4341_244*S42-s.dpt[2,42]*(C43*(C44*(FB144_41+FB146_41+FM4741_148)-\
  ...
  CM406_141 = C41*(CM426_143+s.In[1,41]*C41+FB341_6*s.l[2,41]+s.dpt[2,42]*(FM426_343*C42+FM436_244*S42))+S41*(CM426_343*\
   S42-CM436_244*C42)
  CM4040_141 = C41*(CM4240_143+s.In[1,41]*C41+s.m[41]*s.l[2,41]*s.l[2,41]*C41+s.dpt[2,42]*(C42*(FM344_40*C43-FM4340_144*\
...
# Backward Dynamics 
  ...
  CF154 = -(s.trq[1,54]+s.In[5,54]*OM254*OM354-CF155*C55-CF159*C58-CF355*S55-CF58_359*S58-FA354*s.l[2,54]+s.dpt[2,54]*(\
   FA159*S58-FF58_359*C58))
  CF254 = -(s.trq[2,54]-CF255-CF58_259-s.In[5,54]*OpF26+FA354*s.l[1,54]-s.dpt[1,54]*(FA159*S58-FF58_359*C58))
  CF354 = -(s.trq[3,54]-s.In[5,54]*OM154*OM254+CF155*S55+CF159*S58-CF355*C55-CF58_359*C58+FA154*s.l[2,54]-FA254*\
   s.l[1,54]-FF58_259*s.dpt[1,54]+s.dpt[2,54]*(FA159*C58+FF58_359*S58))
  ...
  CM154_1 = CM155_1*C55+CM159_1*C58+CM355_1*S55+CM581_359*S58+FB354_1*s.l[2,54]-s.dpt[2,54]*(FB159_1*S58-FM581_359*C58)
  CM254_1 = CM255_1+CM581_259-FB354_1*s.l[1,54]+s.dpt[1,54]*(FB159_1*S58-FM581_359*C58)
  CM354_1 = -(CM155_1*S55+CM159_1*S58-CM355_1*C55-CM581_359*C58+FB154_1*s.l[2,54]-FB254_1*s.l[1,54]-FM581_259*\
   s.dpt[1,54]+s.dpt[2,54]*(FB159_1*C58+FM581_359*S58))
  ...
  CM154_2 = CM155_2*C55+CM159_2*C58+CM355_2*S55+CM582_359*S58+FB354_2*s.l[2,54]-s.dpt[2,54]*(FB159_2*S58-FM582_359*C58)
  CM254_2 = CM255_2+CM582_259-FB354_2*s.l[1,54]+s.dpt[1,54]*(FB159_2*S58-FM582_359*C58)
  CM354_2 = -(CM155_2*S55+CM159_2*S58-CM355_2*C55-CM582_359*C58+FB154_2*s.l[2,54]-FB254_2*s.l[1,54]-FM582_259*\
   s.dpt[1,54]+s.dpt[2,54]*(FB159_2*C58+FM582_359*S58))
  ...
  CM154_3 = CM155_3*C55+CM159_3*C58+CM355_3*S55+CM583_359*S58+FB354_3*s.l[2,54]-s.dpt[2,54]*(FB159_3*S58-FM583_359*C58)
  CM254_3 = CM255_3+CM583_259-FB354_3*s.l[1,54]+s.dpt[1,54]*(FB159_3*S58-FM583_359*C58)
  CM354_3 = -(CM155_3*S55+CM159_3*S58-CM355_3*C55-CM583_359*C58+FB154_3*s.l[2,54]-FB254_3*s.l[1,54]-FM583_259*\
   s.dpt[1,54]+s.dpt[2,54]*(FB159_3*C58+FM583_359*S58))
  ...
  CM154_4 = CM155_4*C55+CM159_4*C58+CM355_4*S55+CM584_359*S58+FB354_4*s.l[2,54]-s.dpt[2,54]*(FB159_4*S58-FM584_359*C58)
  CM254_4 = CM255_4+CM584_259+s.In[5,54]*OpM26_4-FB354_4*s.l[1,54]+s.dpt[1,54]*(FB159_4*S58-FM584_359*C58)
  CM354_4 = -(CM155_4*S55+CM159_4*S58-CM355_4*C55-CM584_359*C58+FB154_4*s.l[2,54]-FB254_4*s.l[1,54]-FM584_259*\
   s.dpt[1,54]+s.dpt[2,54]*(FB159_4*C58+FM584_359*S58))
  ...
  CM154_5 = CM155_5*C55+CM159_5*C58+CM355_5*S55+CM585_359*S58+FB354_5*s.l[2,54]-s.dpt[2,54]*(FB159_5*S58-FM585_359*C58)
  CM254_5 = CM255_5+CM585_259+s.In[5,54]*C6-FB354_5*s.l[1,54]+s.dpt[1,54]*(FB159_5*S58-FM585_359*C58)
  CM354_5 = -(CM155_5*S55+CM159_5*S58-CM355_5*C55-CM585_359*C58+FB154_5*s.l[2,54]-FB254_5*s.l[1,54]-FM585_259*\
   s.dpt[1,54]+s.dpt[2,54]*(FB159_5*C58+FM585_359*S58))
  FB254_6 = -s.m[54]*(s.dpt[3,14]-s.l[1,54]*S54)
  FB354_6 = s.m[54]*s.l[2,54]*C54
  CM254_6 = CM255_6+CM586_259-FB354_6*s.l[1,54]+s.dpt[1,54]*(FB159_6*S58-FM586_359*C58)
  CM254_54 = s.In[5,54]+CM255_54+CM5854_259+s.m[54]*s.l[1,54]*s.l[1,54]-s.dpt[1,54]*(s.m[59]*AlM358_54*C58-FB159_54*S58)
...
# Backward Dynamics 
  ...
  CF160 = -(s.trq[1,60]+s.In[5,60]*OM260*OM360-CF161*C61-CF165*C64-CF361*S61-CF64_365*S64-FA360*s.l[2,60]+s.dpt[2,58]*(\
   FA165*S64-FF64_365*C64))
  CF260 = -(s.trq[2,60]-CF261-CF64_265-s.In[5,60]*OpF26+FA360*s.l[1,60]-s.dpt[1,58]*(FA165*S64-FF64_365*C64))
  CF360 = -(s.trq[3,60]-s.In[5,60]*OM160*OM260+CF161*S61+CF165*S64-CF361*C61-CF64_365*C64+FA160*s.l[2,60]-FA260*\
   s.l[1,60]-FF64_265*s.dpt[1,58]+s.dpt[2,58]*(FA165*C64+FF64_365*S64))
  ...
  CM160_1 = CM161_1*C61+CM165_1*C64+CM361_1*S61+CM641_365*S64+FB360_1*s.l[2,60]-s.dpt[2,58]*(FB165_1*S64-FM641_365*C64)
  CM260_1 = CM261_1+CM641_265-FB360_1*s.l[1,60]+s.dpt[1,58]*(FB165_1*S64-FM641_365*C64)
  CM360_1 = -(CM161_1*S61+CM165_1*S64-CM361_1*C61-CM641_365*C64+FB160_1*s.l[2,60]-FB260_1*s.l[1,60]-FM641_265*\
   s.dpt[1,58]+s.dpt[2,58]*(FB165_1*C64+FM641_365*S64))
  ...
  CM160_2 = CM161_2*C61+CM165_2*C64+CM361_2*S61+CM642_365*S64+FB360_2*s.l[2,60]-s.dpt[2,58]*(FB165_2*S64-FM642_365*C64)
  CM260_2 = CM261_2+CM642_265-FB360_2*s.l[1,60]+s.dpt[1,58]*(FB165_2*S64-FM642_365*C64)
  CM360_2 = -(CM161_2*S61+CM165_2*S64-CM361_2*C61-CM642_365*C64+FB160_2*s.l[2,60]-FB260_2*s.l[1,60]-FM642_265*\
   s.dpt[1,58]+s.dpt[2,58]*(FB165_2*C64+FM642_365*S64))
  ...
  CM160_3 = CM161_3*C61+CM165_3*C64+CM361_3*S61+CM643_365*S64+FB360_3*s.l[2,60]-s.dpt[2,58]*(FB165_3*S64-FM643_365*C64)
  CM260_3 = CM261_3+CM643_265-FB360_3*s.l[1,60]+s.dpt[1,58]*(FB165_3*S64-FM643_365*C64)
  CM360_3 = -(CM161_3*S61+CM165_3*S64-CM361_3*C61-CM643_365*C64+FB160_3*s.l[2,60]-FB260_3*s.l[1,60]-FM643_265*\
   s.dpt[1,58]+s.dpt[2,58]*(FB165_3*C64+FM643_365*S64))
  ...
  CM160_4 = CM161_4*C61+CM165_4*C64+CM361_4*S61+CM644_365*S64+FB360_4*s.l[2,60]-s.dpt[2,58]*(FB165_4*S64-FM644_365*C64)
  CM260_4 = CM261_4+CM644_265+s.In[5,60]*OpM26_4-FB360_4*s.l[1,60]+s.dpt[1,58]*(FB165_4*S64-FM644_365*C64)
  CM360_4 = -(CM161_4*S61+CM165_4*S64-CM361_4*C61-CM644_365*C64+FB160_4*s.l[2,60]-FB260_4*s.l[1,60]-FM644_265*\
   s.dpt[1,58]+s.dpt[2,58]*(FB165_4*C64+FM644_365*S64))
  ...
  CM160_5 = CM161_5*C61+CM165_5*C64+CM361_5*S61+CM645_365*S64+FB360_5*s.l[2,60]-s.dpt[2,58]*(FB165_5*S64-FM645_365*C64)
  CM260_5 = CM261_5+CM645_265+s.In[5,60]*C6-FB360_5*s.l[1,60]+s.dpt[1,58]*(FB165_5*S64-FM645_365*C64)
  CM360_5 = -(CM161_5*S61+CM165_5*S64-CM361_5*C61-CM645_365*C64+FB160_5*s.l[2,60]-FB260_5*s.l[1,60]-FM645_265*\
   s.dpt[1,58]+s.dpt[2,58]*(FB165_5*C64+FM645_365*S64))
  FB260_6 = -s.m[60]*(s.dpt[3,15]-s.l[1,60]*S60)
  FB360_6 = s.m[60]*s.l[2,60]*C60
  CM260_6 = CM261_6+CM646_265-FB360_6*s.l[1,60]+s.dpt[1,58]*(FB165_6*S64-FM646_365*C64)
  CM260_60 = s.In[5,60]+CM261_60+CM6460_265+s.m[60]*s.l[1,60]*s.l[1,60]-s.dpt[1,58]*(s.m[65]*AlM364_60*C64-FB165_60*S64)
...
# Backward Dynamics 
   ...
   *OpF15-CF151*C50-CF153*C52-CF154*C54-CF160*C60-CF354*S54-CF360*S60+CF50_251*S50+CF52_253*S52+FA26*s.l[3,6]+FF254*s.dpt[3,14]\
   +FF260*s.dpt[3,15]-FF50_351*s.dpt[2,50]-FF52_353*s.dpt[2,51]+OM26*OM36*(s.In[5,6]-s.In[9,6])-s.dpt[2,10]*(FF29_230*S29+FF330\
  ...
  CF36 = -(s.trq[3,49]+s.trq[3,6]-CF50_351-CF52_353+q[49]*FF149-s.In[9,6]*OpF36+CF154*S54+CF160*S60-CF215*S15-CF23_224*\
   ...
   S23-FF23_224*C23)+s.dpt[1,8]*(FA326*S25-FF25_226*C25)+s.dpt[1,9]*(FA328*S27-FF27_228*C27)+s.dpt[2,50]*(FA151*C50-FF50_251*\
   S50)+s.dpt[2,51]*(FA153*C52-FF52_253*S52))
  ...
  CM16_1 = CM115_1+CM17_1+CM231_124+CM251_126+CM271_128+CM291_130+CM381_139+CM401_141+q[49]*FM349_1+CM151_1*C50+CM153_1*\
   ...
   s.dpt[3,15]+FM501_351*s.dpt[2,50]+FM521_353*s.dpt[2,51]+s.dpt[2,10]*(FM291_230*S29+FM330_1*C29)+s.dpt[2,11]*(FB339_1*C38+\
  ...
  CM36_1 = CM501_351+CM521_353-q[49]*FM149_1-CM154_1*S54-CM160_1*S60+CM215_1*S15+CM231_224*S23+CM251_226*S25+CM271_228*\
   ...
   FB324_1*S23-FM231_224*C23)-s.dpt[1,8]*(FB326_1*S25-FM251_226*C25)-s.dpt[1,9]*(FB328_1*S27-FM271_228*C27)-s.dpt[2,50]*(\
   FB151_1*C50-FM501_251*S50)-s.dpt[2,51]*(FB153_1*C52-FM521_253*S52)
  ...
  CM16_2 = CM115_2+CM17_2+CM232_124+CM252_126+CM272_128+CM292_130+CM382_139+CM402_141+q[49]*FM349_2+CM151_2*C50+CM153_2*\
   ...
   s.dpt[3,15]+FM502_351*s.dpt[2,50]+FM522_353*s.dpt[2,51]+s.dpt[2,10]*(FM292_230*S29+FM330_2*C29)+s.dpt[2,11]*(FB339_2*C38+\
  ...
  CM36_2 = CM502_351+CM522_353-q[49]*FM149_2-CM154_2*S54-CM160_2*S60+CM215_2*S15+CM232_224*S23+CM252_226*S25+CM272_228*\
   ...
   FB324_2*S23-FM232_224*C23)-s.dpt[1,8]*(FB326_2*S25-FM252_226*C25)-s.dpt[1,9]*(FB328_2*S27-FM272_228*C27)-s.dpt[2,50]*(\
   FB151_2*C50-FM502_251*S50)-s.dpt[2,51]*(FB153_2*C52-FM522_253*S52)
  FB16_3 = -s.m[6]*S5
  ...
  CM16_3 = CM115_3+CM17_3+CM233_124+CM253_126+CM273_128+CM293_130+CM383_139+CM403_141+q[49]*FM349_3+CM151_3*C50+CM153_3*\
   ...
   s.dpt[3,15]+FM503_351*s.dpt[2,50]+FM523_353*s.dpt[2,51]+s.dpt[2,10]*(FM293_230*S29+FM330_3*C29)+s.dpt[2,11]*(FB339_3*C38+\
  ...
  CM36_3 = CM503_351+CM523_353-q[49]*FM149_3-CM154_3*S54-CM160_3*S60+CM215_3*S15+CM233_224*S23+CM253_226*S25+CM273_228*\
   ...
   FB324_3*S23-FM233_224*C23)-s.dpt[1,8]*(FB326_3*S25-FM253_226*C25)-s.dpt[1,9]*(FB328_3*S27-FM273_228*C27)-s.dpt[2,50]*(\
   FB151_3*C50-FM503_251*S50)-s.dpt[2,51]*(FB153_3*C52-FM523_253*S52)
  CM16_4 = CM115_4+CM17_4+CM234_124+CM254_126+CM274_128+CM294_130+CM384_139+CM404_141+q[49]*FM349_4-s.In[1,6]*S5-s.m[6]*\
   ...
   FM254_4*s.dpt[3,14]-FM260_4*s.dpt[3,15]+FM504_351*s.dpt[2,50]+FM524_353*s.dpt[2,51]+s.dpt[2,10]*(FM294_230*S29+FM330_4*C29)+\
  ...
  CM36_4 = CM504_351+CM524_353-q[49]*(s.m[49]*AlM149_4+FB151_4*C50+FB153_4*C52-FM504_251*S50-FM524_253*S52)+s.In[9,6]*\
   ...
   FB115_4-FM164_217*S16+FM174_118*C16)-s.dpt[2,50]*(FB151_4*C50-FM504_251*S50)-s.dpt[2,51]*(FB153_4*C52-FM524_253*S52)
  CM16_5 = CM115_5+CM17_5+CM235_124+CM255_126+CM275_128+CM295_130+CM385_139+CM405_141+q[49]*FM349_5+CM151_5*C50+CM153_5*\
   ...
   FM505_351*s.dpt[2,50]+FM525_353*s.dpt[2,51]+s.dpt[2,10]*(FM295_230*S29+FM330_5*C29)+s.dpt[2,11]*(FB339_5*C38+FM385_239*S38)+\
  ...
  CM16_6 = s.In[1,6]+CM115_6+CM17_6+CM236_124+CM256_126+CM276_128+CM296_130+CM386_139+CM406_141+q[49]*(FM506_351+\
   ...
   s.dpt[2,50]+FM526_353*s.dpt[2,51]+s.dpt[2,10]*(C29*(FB330_6+FM316_332*C31+FM326_233*S31)+S29*(C30*(s.m[30]*AlM230_6-\
   ...
   CM155_6*C55+CM159_6*C58+CM355_6*S55+CM586_359*S58+FB354_6*s.l[2,54]-s.dpt[2,54]*(FB159_6*S58-FM586_359*C58))+S54*(s.m[54]*\
   s.l[2,54]*s.l[2,54]*S54-CM155_6*S55-CM159_6*S58+CM355_6*C55+CM586_359*C58+FB254_6*s.l[1,54]+FM586_259*s.dpt[1,54]-\
   s.dpt[2,54]*(FB159_6*C58+FM586_359*S58))+C60*(CM161_6*C61+CM165_6*C64+CM361_6*S61+CM646_365*S64+FB360_6*s.l[2,60]-\
   s.dpt[2,58]*(FB165_6*S64-FM646_365*C64))+S60*(s.m[60]*s.l[2,60]*s.l[2,60]*S60-CM161_6*S61-CM165_6*S64+CM361_6*C61+CM646_365*\
   C64+FB260_6*s.l[1,60]+FM646_265*s.dpt[1,58]-s.dpt[2,58]*(FB165_6*C64+FM646_365*S64))
  ...
  CM55_26 = C6*(CM254_5+CM260_5+s.In[5,6]*C6+s.m[6]*s.l[3,6]*s.l[3,6]*C6+CM151_5*S50+CM153_5*S52+CM215_5*C15+CM235_224*\
   ...
   s.dpt[2,4]*(FB115_5-FM165_217*S16+FM175_118*C16)-s.dpt[2,50]*(FB151_5*C50-FM505_251*S50)-s.dpt[2,51]*(FB153_5*C52-FM525_253*\
   S52))
