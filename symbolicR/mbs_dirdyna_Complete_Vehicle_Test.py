...
# Forward Kinematics 
  ...
  OpF27 = C7*(OpF25+qd[7]*OM36)+S7*(OpF36-qd[7]*OM26)
  OpF37 = C7*(OpF36-qd[7]*OM26)-S7*(OpF25+qd[7]*OM36)
  ...
  AlF27 = C7*(AlF25+BS56*s.dpt[2,1]+BeF46*s.dpt[1,1]+BeF66*s.dpt[3,1])+S7*(AlF36+BS96*s.dpt[3,1]+BeF76*s.dpt[1,1]+BeF86*\
   s.dpt[2,1])
  AlF37 = C7*(AlF36+BS96*s.dpt[3,1]+BeF76*s.dpt[1,1]+BeF86*s.dpt[2,1])-S7*(AlF25+BS56*s.dpt[2,1]+BeF46*s.dpt[1,1]+BeF66*\
   s.dpt[3,1])
  ...
  AlM17_4 = -(OpM36_4*s.dpt[2,1]-s.dpt[3,1]*S5)
  AlM27_4 = -(C7*(OpM16_4*s.dpt[3,1]-OpM36_4*s.dpt[1,1])-S7*(OpM16_4*s.dpt[2,1]-s.dpt[1,1]*S5))
  AlM37_4 = C7*(OpM16_4*s.dpt[2,1]-s.dpt[1,1]*S5)+S7*(OpM16_4*s.dpt[3,1]-OpM36_4*s.dpt[1,1])
  OpM27_5 = S6*S7
  OpM37_5 = S6*C7
  AlM17_5 = -s.dpt[2,1]*S6
  AlM27_5 = s.dpt[2,1]*C6*S7+C7*(s.dpt[1,1]*S6-s.dpt[3,1]*C6)
  AlM37_5 = s.dpt[2,1]*C6*C7-S7*(s.dpt[1,1]*S6-s.dpt[3,1]*C6)
  AlM27_6 = -s.dpt[1,1]*S7
  AlM37_6 = -s.dpt[1,1]*C7
  ...
  AlM38_4 = AlM37_4+OpM16_4*s.dpt[2,14]
  OpM18_5 = OpM27_5*S8+C6*C8
  AlM18_5 = AlM27_5*S8+C8*(AlM17_5-OpM37_5*s.dpt[2,14])
  AlM28_5 = AlM27_5*C8-S8*(AlM17_5-OpM37_5*s.dpt[2,14])
  AlM38_5 = AlM37_5+s.dpt[2,14]*C6
  OpM18_6 = C7*S8
  AlM18_6 = AlM27_6*S8+C8*(s.dpt[3,1]+s.dpt[2,14]*S7)
  AlM28_6 = AlM27_6*C8-S8*(s.dpt[3,1]+s.dpt[2,14]*S7)
  OM19 = qd[9]+OM18
...
# Forward Kinematics 
  ...
  OpF210 = C10*(OpF25+qd[10]*OM36)+S10*(OpF36-qd[10]*OM26)
  OpF310 = C10*(OpF36-qd[10]*OM26)-S10*(OpF25+qd[10]*OM36)
  ...
  AlF210 = C10*(AlF25+BS56*s.dpt[2,4]+BeF46*s.dpt[1,4]+BeF66*s.dpt[3,4])+S10*(AlF36+BS96*s.dpt[3,4]+BeF76*s.dpt[1,4]+\
   BeF86*s.dpt[2,4])
  AlF310 = C10*(AlF36+BS96*s.dpt[3,4]+BeF76*s.dpt[1,4]+BeF86*s.dpt[2,4])-S10*(AlF25+BS56*s.dpt[2,4]+BeF46*s.dpt[1,4]+\
   BeF66*s.dpt[3,4])
  AlM210_1 = AlM25_1*C10+AlM36_1*S10
  AlM310_1 = -(AlM25_1*S10-AlM36_1*C10)
  AlM210_2 = AlM25_2*C10+AlM36_2*S10
  AlM310_2 = -(AlM25_2*S10-AlM36_2*C10)
  AlM210_3 = AlM36_3*S10+C10*S5
  AlM310_3 = AlM36_3*C10-S10*S5
  OpM210_4 = OpM36_4*S10+C10*S5
  OpM310_4 = OpM36_4*C10-S10*S5
  AlM110_4 = -(OpM36_4*s.dpt[2,4]-s.dpt[3,4]*S5)
  AlM210_4 = -(C10*(OpM16_4*s.dpt[3,4]-OpM36_4*s.dpt[1,4])-S10*(OpM16_4*s.dpt[2,4]-s.dpt[1,4]*S5))
  AlM310_4 = C10*(OpM16_4*s.dpt[2,4]-s.dpt[1,4]*S5)+S10*(OpM16_4*s.dpt[3,4]-OpM36_4*s.dpt[1,4])
  OpM210_5 = S10*S6
  OpM310_5 = C10*S6
  AlM110_5 = -s.dpt[2,4]*S6
  AlM210_5 = s.dpt[2,4]*S10*C6+C10*(s.dpt[1,4]*S6-s.dpt[3,4]*C6)
  AlM310_5 = s.dpt[2,4]*C10*C6-S10*(s.dpt[1,4]*S6-s.dpt[3,4]*C6)
  AlM210_6 = -s.dpt[1,4]*S10
  AlM310_6 = -s.dpt[1,4]*C10
  OM111 = OM110*C11+OM210*S11
  OM211 = -(OM110*S11-OM210*C11)
  OM311 = qd[11]+OM310
  OpF111 = C11*(OpF16+qd[11]*OM210)+S11*(OpF210-qd[11]*OM110)
  AlF111 = C11*(AlF110+BeF210*s.dpt[2,19])+S11*(AlF210+BS510*s.dpt[2,19])
  AlF211 = C11*(AlF210+BS510*s.dpt[2,19])-S11*(AlF110+BeF210*s.dpt[2,19])
  AlF311 = AlF310+BeF810*s.dpt[2,19]
  ...
  AlM111_4 = AlM210_4*S11+C11*(AlM110_4-OpM310_4*s.dpt[2,19])
  AlM211_4 = AlM210_4*C11-S11*(AlM110_4-OpM310_4*s.dpt[2,19])
  AlM311_4 = AlM310_4+OpM16_4*s.dpt[2,19]
  OpM111_5 = OpM210_5*S11+C11*C6
  AlM111_5 = AlM210_5*S11+C11*(AlM110_5-OpM310_5*s.dpt[2,19])
  AlM211_5 = AlM210_5*C11-S11*(AlM110_5-OpM310_5*s.dpt[2,19])
  AlM311_5 = AlM310_5+s.dpt[2,19]*C6
  OpM111_6 = C10*S11
  AlM111_6 = AlM210_6*S11+C11*(s.dpt[3,4]+s.dpt[2,19]*S10)
  AlM211_6 = AlM210_6*C11-S11*(s.dpt[3,4]+s.dpt[2,19]*S10)
  OM112 = qd[12]+OM111
...
# Forward Kinematics 
  ...
  AlF213 = C13*(AlF25+BS56*s.dpt[2,9]+BeF46*s.dpt[1,9]+BeF66*s.dpt[3,9])+S13*(AlF36+BS96*s.dpt[3,9]+BeF76*s.dpt[1,9]+\
   BeF86*s.dpt[2,9])
  AlF313 = C13*(AlF36+BS96*s.dpt[3,9]+BeF76*s.dpt[1,9]+BeF86*s.dpt[2,9])-S13*(AlF25+BS56*s.dpt[2,9]+BeF46*s.dpt[1,9]+\
   BeF66*s.dpt[3,9])
  ...
  AlM113_4 = -(OpM36_4*s.dpt[2,9]-s.dpt[3,9]*S5)
  AlM213_4 = -(C13*(OpM16_4*s.dpt[3,9]-OpM36_4*s.dpt[1,9])-S13*(OpM16_4*s.dpt[2,9]-s.dpt[1,9]*S5))
  AlM313_4 = C13*(OpM16_4*s.dpt[2,9]-s.dpt[1,9]*S5)+S13*(OpM16_4*s.dpt[3,9]-OpM36_4*s.dpt[1,9])
  OpM313_5 = C13*S6
  AlM113_5 = -s.dpt[2,9]*S6
  AlM213_5 = s.dpt[2,9]*S13*C6+C13*(s.dpt[1,9]*S6-s.dpt[3,9]*C6)
  AlM313_5 = s.dpt[2,9]*C13*C6-S13*(s.dpt[1,9]*S6-s.dpt[3,9]*C6)
  OM114 = qd[14]+OM113
  ...
  AlF114 = AlF113+BeF213*s.dpt[2,24]
  AlF214 = C14*(AlF213+BS513*s.dpt[2,24])+S14*(AlF313+BeF813*s.dpt[2,24])
  AlF314 = C14*(AlF313+BeF813*s.dpt[2,24])-S14*(AlF213+BS513*s.dpt[2,24])
  ...
  AlM114_4 = AlM113_4-OpM313_4*s.dpt[2,24]
  AlM214_4 = AlM213_4*C14+S14*(AlM313_4+OpM16_4*s.dpt[2,24])
  AlM314_4 = -(AlM213_4*S14-C14*(AlM313_4+OpM16_4*s.dpt[2,24]))
  OpM214_5 = S13p14*S6
  OpM314_5 = C13p14*S6
  AlM114_5 = AlM113_5-OpM313_5*s.dpt[2,24]
  AlM214_5 = AlM213_5*C14+S14*(AlM313_5+s.dpt[2,24]*C6)
  AlM314_5 = -(AlM213_5*S14-C14*(AlM313_5+s.dpt[2,24]*C6))
  AlM114_6 = s.dpt[3,9]+s.dpt[2,24]*S13
  OM115 = qd[15]+OM114
...
# Forward Kinematics 
  ...
  OpF216 = C16*(OpF25+qd[16]*OM36)+S16*(OpF36-qd[16]*OM26)
  OpF316 = C16*(OpF36-qd[16]*OM26)-S16*(OpF25+qd[16]*OM36)
  ...
  AlF216 = C16*(AlF25+BS56*s.dpt[2,11]+BeF46*s.dpt[1,11]+BeF66*s.dpt[3,11])+S16*(AlF36+BS96*s.dpt[3,11]+BeF76*\
   s.dpt[1,11]+BeF86*s.dpt[2,11])
  AlF316 = C16*(AlF36+BS96*s.dpt[3,11]+BeF76*s.dpt[1,11]+BeF86*s.dpt[2,11])-S16*(AlF25+BS56*s.dpt[2,11]+BeF46*\
   s.dpt[1,11]+BeF66*s.dpt[3,11])
  AlM216_1 = AlM25_1*C16+AlM36_1*S16
  AlM316_1 = -(AlM25_1*S16-AlM36_1*C16)
  AlM216_2 = AlM25_2*C16+AlM36_2*S16
  AlM316_2 = -(AlM25_2*S16-AlM36_2*C16)
  AlM216_3 = AlM36_3*S16+C16*S5
  AlM316_3 = AlM36_3*C16-S16*S5
  OpM216_4 = OpM36_4*S16+C16*S5
  OpM316_4 = OpM36_4*C16-S16*S5
  AlM116_4 = -(OpM36_4*s.dpt[2,11]-s.dpt[3,11]*S5)
  AlM216_4 = -(C16*(OpM16_4*s.dpt[3,11]-OpM36_4*s.dpt[1,11])-S16*(OpM16_4*s.dpt[2,11]-s.dpt[1,11]*S5))
  AlM316_4 = C16*(OpM16_4*s.dpt[2,11]-s.dpt[1,11]*S5)+S16*(OpM16_4*s.dpt[3,11]-OpM36_4*s.dpt[1,11])
  OpM316_5 = C16*S6
  AlM116_5 = -s.dpt[2,11]*S6
  AlM216_5 = s.dpt[2,11]*S16*C6+C16*(s.dpt[1,11]*S6-s.dpt[3,11]*C6)
  AlM316_5 = s.dpt[2,11]*C16*C6-S16*(s.dpt[1,11]*S6-s.dpt[3,11]*C6)
  OM117 = qd[17]+OM116
  ...
  AlF117 = AlF116+BeF216*s.dpt[2,30]
  AlF217 = C17*(AlF216+BS516*s.dpt[2,30])+S17*(AlF316+BeF816*s.dpt[2,30])
  AlF317 = C17*(AlF316+BeF816*s.dpt[2,30])-S17*(AlF216+BS516*s.dpt[2,30])
  ...
  AlM117_4 = AlM116_4-OpM316_4*s.dpt[2,30]
  AlM217_4 = AlM216_4*C17+S17*(AlM316_4+OpM16_4*s.dpt[2,30])
  AlM317_4 = -(AlM216_4*S17-C17*(AlM316_4+OpM16_4*s.dpt[2,30]))
  OpM217_5 = S16p17*S6
  OpM317_5 = C16p17*S6
  AlM117_5 = AlM116_5-OpM316_5*s.dpt[2,30]
  AlM217_5 = AlM216_5*C17+S17*(AlM316_5+s.dpt[2,30]*C6)
  AlM317_5 = -(AlM216_5*S17-C17*(AlM316_5+s.dpt[2,30]*C6))
  AlM117_6 = s.dpt[3,11]+s.dpt[2,30]*S16
  OM118 = qd[18]+OM117
...
# Backward Dynamics 
  ...
  FB18_5 = s.m[8]*(AlM18_5+s.l[3,8]*(OpM27_5*C8-C6*S8))
  ...
  FB18_6 = s.m[8]*(AlM18_6+s.l[3,8]*C7*C8)
  ...
  FF37 = FA37+FF38
  CF17 = -(s.trq[1,7]-s.In[1,7]*OpF16-CF18*C8+CF28*S8-FA37*s.l[2,7]-FF38*s.dpt[2,14])
  CF27 = -(s.trq[2,7]-s.In[1,7]*OM17*OM37-CF18*S8-CF28*C8)
  CF37 = -(s.trq[3,7]-CF38+s.In[1,7]*OM17*OM27+FA17*s.l[2,7]+s.dpt[2,14]*(FF18*C8-FF28*S8))
  ...
  CM17_1 = CM18_1*C8-CM28_1*S8+FB37_1*s.l[2,7]+FM38_1*s.dpt[2,14]
  CM37_1 = -(FB17_1*s.l[2,7]+s.dpt[2,14]*(FM18_1*C8-FM28_1*S8))
  ...
  CM17_2 = CM18_2*C8-CM28_2*S8+FB37_2*s.l[2,7]+FM38_2*s.dpt[2,14]
  CM37_2 = -(FB17_2*s.l[2,7]+s.dpt[2,14]*(FM18_2*C8-FM28_2*S8))
  ...
  CM17_3 = CM18_3*C8-CM28_3*S8+FB37_3*s.l[2,7]+FM38_3*s.dpt[2,14]
  CM37_3 = -(FB17_3*s.l[2,7]+s.dpt[2,14]*(FM18_3*C8-FM28_3*S8))
  ...
  CM17_4 = s.In[1,7]*OpM16_4+CM18_4*C8-CM28_4*S8+FB37_4*s.l[2,7]+FM38_4*s.dpt[2,14]
  CM37_4 = CM38_4-FB17_4*s.l[2,7]-s.dpt[2,14]*(FM18_4*C8-FM28_4*S8)
  FB17_5 = s.m[7]*(AlM17_5-OpM37_5*s.l[2,7])
  FB37_5 = s.m[7]*(AlM37_5+s.l[2,7]*C6)
  FM17_5 = FB17_5+FM18_5*C8-FM28_5*S8
  FM27_5 = s.m[7]*AlM27_5+FM18_5*S8+FM28_5*C8
  FM37_5 = FB37_5+FM38_5
  CM75_28 = CM18_5*S8+CM28_5*C8
  CM17_5 = s.In[1,7]*C6+CM18_5*C8-CM28_5*S8+FB37_5*s.l[2,7]+FM38_5*s.dpt[2,14]
  CM37_5 = CM38_5-FB17_5*s.l[2,7]-s.dpt[2,14]*(FM18_5*C8-FM28_5*S8)
  FB17_6 = s.m[7]*(s.dpt[3,1]+s.l[2,7]*S7)
  FB37_6 = s.m[7]*AlM37_6
  CM17_6 = CM18_6*C8-CM28_6*S8+FB37_6*s.l[2,7]+FM38_6*s.dpt[2,14]
  CM17_7 = s.In[1,7]+s.m[7]*s.l[2,7]*s.l[2,7]+s.m[8]*s.l[3,8]*s.l[3,8]*S8*S8+s.dpt[2,14]*s.dpt[2,14]*(s.m[8]+s.m[9])+C8*\
...
# Backward Dynamics 
  ...
  FB111_5 = s.m[11]*(AlM111_5+s.l[3,11]*(OpM210_5*C11-S11*C6))
  ...
  FB111_6 = s.m[11]*(AlM111_6+s.l[3,11]*C10*C11)
  ...
  FF310 = FA310+FF311
  CF110 = -(s.trq[1,10]-s.In[1,10]*OpF16-CF111*C11+CF211*S11-FA310*s.l[2,10]-FF311*s.dpt[2,19])
  CF210 = -(s.trq[2,10]-s.In[1,10]*OM110*OM310-CF111*S11-CF211*C11)
  CF310 = -(s.trq[3,10]-CF311+s.In[1,10]*OM110*OM210+FA110*s.l[2,10]+s.dpt[2,19]*(FF111*C11-FF211*S11))
  ...
  CM110_1 = CM111_1*C11-CM211_1*S11+FB310_1*s.l[2,10]+FM311_1*s.dpt[2,19]
  CM310_1 = -(FB110_1*s.l[2,10]+s.dpt[2,19]*(FM111_1*C11-FM211_1*S11))
  ...
  CM110_2 = CM111_2*C11-CM211_2*S11+FB310_2*s.l[2,10]+FM311_2*s.dpt[2,19]
  CM310_2 = -(FB110_2*s.l[2,10]+s.dpt[2,19]*(FM111_2*C11-FM211_2*S11))
  ...
  CM110_3 = CM111_3*C11-CM211_3*S11+FB310_3*s.l[2,10]+FM311_3*s.dpt[2,19]
  CM310_3 = -(FB110_3*s.l[2,10]+s.dpt[2,19]*(FM111_3*C11-FM211_3*S11))
  ...
  CM110_4 = s.In[1,10]*OpM16_4+CM111_4*C11-CM211_4*S11+FB310_4*s.l[2,10]+FM311_4*s.dpt[2,19]
  CM310_4 = CM311_4-FB110_4*s.l[2,10]-s.dpt[2,19]*(FM111_4*C11-FM211_4*S11)
  FB110_5 = s.m[10]*(AlM110_5-OpM310_5*s.l[2,10])
  FB310_5 = s.m[10]*(AlM310_5+s.l[2,10]*C6)
  ...
  CM110_5 = s.In[1,10]*C6+CM111_5*C11-CM211_5*S11+FB310_5*s.l[2,10]+FM311_5*s.dpt[2,19]
  CM310_5 = CM311_5-FB110_5*s.l[2,10]-s.dpt[2,19]*(FM111_5*C11-FM211_5*S11)
  FB110_6 = s.m[10]*(s.dpt[3,4]+s.l[2,10]*S10)
  FB310_6 = s.m[10]*AlM310_6
  CM110_6 = CM111_6*C11-CM211_6*S11+FB310_6*s.l[2,10]+FM311_6*s.dpt[2,19]
  CM110_10 = s.In[1,10]+s.m[10]*s.l[2,10]*s.l[2,10]+s.m[11]*s.l[3,11]*s.l[3,11]*S11*S11+s.dpt[2,19]*s.dpt[2,19]*(s.m[11]\
...
# Backward Dynamics 
  ...
  FA215 = -(s.frc[2,15]-s.m[15]*(C15*(AlF214+BeF414*s.dpt[1,26])+S15*(AlF314+BeF714*s.dpt[1,26])))
  FA315 = -(s.frc[3,15]-s.m[15]*(C15*(AlF314+BeF714*s.dpt[1,26])-S15*(AlF214+BeF414*s.dpt[1,26])))
  ...
  FB215_4 = s.m[15]*(C15*(AlM214_4+OpM314_4*s.dpt[1,26])+S15*(AlM314_4-OpM214_4*s.dpt[1,26]))
  FB315_4 = s.m[15]*(C15*(AlM314_4-OpM214_4*s.dpt[1,26])-S15*(AlM214_4+OpM314_4*s.dpt[1,26]))
  CM115_4 = s.In[1,15]*OpM16_4
  FB215_5 = s.m[15]*(C15*(AlM214_5+OpM314_5*s.dpt[1,26])+S15*(AlM314_5-OpM214_5*s.dpt[1,26]))
  FB315_5 = s.m[15]*(C15*(AlM314_5-OpM214_5*s.dpt[1,26])-S15*(AlM214_5+OpM314_5*s.dpt[1,26]))
  CM115_5 = s.In[1,15]*C6
  FB215_6 = -s.m[15]*S13p14p15*(s.dpt[1,26]+s.dpt[1,9])
  FB315_6 = -s.m[15]*C13p14p15*(s.dpt[1,26]+s.dpt[1,9])
  FA214 = -(s.frc[2,14]-s.m[14]*(AlF214+BeF414*s.l[1,14]))
  FA314 = -(s.frc[3,14]-s.m[14]*(AlF314+BeF714*s.l[1,14]))
  FF114 = -(s.frc[1,14]+s.frc[1,15]-s.m[14]*(AlF114+BS114*s.l[1,14])-s.m[15]*(AlF114+BS114*s.dpt[1,26]))
  FF214 = FA214+FA215*C15-FA315*S15
  FF314 = FA314+FA215*S15+FA315*C15
  CF114 = -(s.trq[1,14]-CF115-s.In[1,14]*OpF16)
  CF214 = -(s.trq[2,14]-s.In[1,14]*OM114*OM314-CF215*C15+CF315*S15+FA314*s.l[1,14]+s.dpt[1,26]*(FA215*S15+FA315*C15))
  CF314 = -(s.trq[3,14]+s.In[1,14]*OM114*OM214-CF215*S15-CF315*C15-FA214*s.l[1,14]-s.dpt[1,26]*(FA215*C15-FA315*S15))
  ...
  CM214_1 = -(FB314_1*s.l[1,14]+s.dpt[1,26]*(FB215_1*S15+FB315_1*C15))
  CM314_1 = FB214_1*s.l[1,14]+s.dpt[1,26]*(FB215_1*C15-FB315_1*S15)
  ...
  CM214_2 = -(FB314_2*s.l[1,14]+s.dpt[1,26]*(FB215_2*S15+FB315_2*C15))
  CM314_2 = FB214_2*s.l[1,14]+s.dpt[1,26]*(FB215_2*C15-FB315_2*S15)
  ...
  CM214_3 = -(FB314_3*s.l[1,14]+s.dpt[1,26]*(FB215_3*S15+FB315_3*C15))
  CM314_3 = FB214_3*s.l[1,14]+s.dpt[1,26]*(FB215_3*C15-FB315_3*S15)
  ...
  CM214_4 = -(FB314_4*s.l[1,14]+s.dpt[1,26]*(FB215_4*S15+FB315_4*C15))
  CM314_4 = FB214_4*s.l[1,14]+s.dpt[1,26]*(FB215_4*C15-FB315_4*S15)
  ...
  CM114_5 = C6*(s.In[1,14]+s.In[1,15])
  CM214_5 = -(FB314_5*s.l[1,14]+s.dpt[1,26]*(FB215_5*S15+FB315_5*C15))
  CM314_5 = FB214_5*s.l[1,14]+s.dpt[1,26]*(FB215_5*C15-FB315_5*S15)
  FB214_6 = -s.m[14]*S13p14*(s.dpt[1,9]+s.l[1,14])
  FB314_6 = -s.m[14]*C13p14*(s.dpt[1,9]+s.l[1,14])
  FM114_6 = AlM114_6*(s.m[14]+s.m[15])
  FM214_6 = FB214_6+FB215_6*C15-FB315_6*S15
  FM314_6 = FB314_6+FB215_6*S15+FB315_6*C15
  CM214_6 = s.m[15]*s.dpt[1,26]*C13p14*(s.dpt[1,26]+s.dpt[1,9])-FB314_6*s.l[1,14]
  CM314_6 = FB214_6*s.l[1,14]+s.dpt[1,26]*(FB215_6*C15-FB315_6*S15)
  ...
  CF113 = -(s.trq[1,13]-CF114-s.In[1,13]*OpF16-s.In[9,13]*OM213*OM313-FA313*s.l[2,13]-s.dpt[2,24]*(FF214*S14+FF314*C14))
  CF213 = -(s.trq[2,13]-CF214*C14+CF314*S14-OM113*OM313*(s.In[1,13]-s.In[9,13]))
  CF313 = -(s.trq[3,13]+s.In[1,13]*OM113*OM213-s.In[9,13]*OpF313-CF214*S14-CF314*C14+FA113*s.l[2,13]+FF114*s.dpt[2,24])
  ...
  CM113_1 = FB313_1*s.l[2,13]+s.dpt[2,24]*(FM214_1*S14+FM314_1*C14)
  CM313_1 = CM214_1*S14+CM314_1*C14-FB113_1*s.l[2,13]-FM114_1*s.dpt[2,24]
  ...
  CM113_2 = FB313_2*s.l[2,13]+s.dpt[2,24]*(FM214_2*S14+FM314_2*C14)
  CM313_2 = CM214_2*S14+CM314_2*C14-FB113_2*s.l[2,13]-FM114_2*s.dpt[2,24]
  ...
  CM113_3 = FB313_3*s.l[2,13]+s.dpt[2,24]*(FM214_3*S14+FM314_3*C14)
  CM313_3 = CM214_3*S14+CM314_3*C14-FB113_3*s.l[2,13]-FM114_3*s.dpt[2,24]
  ...
  CM113_4 = CM114_4+s.In[1,13]*OpM16_4+FB313_4*s.l[2,13]+s.dpt[2,24]*(FM214_4*S14+FM314_4*C14)
  CM313_4 = s.In[9,13]*OpM313_4+CM214_4*S14+CM314_4*C14-FB113_4*s.l[2,13]-FM114_4*s.dpt[2,24]
  FB113_5 = s.m[13]*(AlM113_5-OpM313_5*s.l[2,13])
  FB313_5 = s.m[13]*(AlM313_5+s.l[2,13]*C6)
  ...
  CM113_5 = CM114_5+s.In[1,13]*C6+FB313_5*s.l[2,13]+s.dpt[2,24]*(FM214_5*S14+FM314_5*C14)
  CM313_5 = s.In[9,13]*OpM313_5+CM214_5*S14+CM314_5*C14-FB113_5*s.l[2,13]-FM114_5*s.dpt[2,24]
  FB113_6 = s.m[13]*(s.dpt[3,9]+s.l[2,13]*S13)
  FB313_6 = -s.m[13]*s.dpt[1,9]*C13
  CM113_6 = FB313_6*s.l[2,13]+s.dpt[2,24]*(FM214_6*S14+FM314_6*C14)
  CM113_13 = s.In[1,13]+CM114_13+s.m[13]*s.l[2,13]*s.l[2,13]+s.dpt[2,24]*s.dpt[2,24]*(s.m[14]+s.m[15])

# = = Block_0_2_0_1_0_5 = = 
 
# Backward Dynamics 

  FA218 = -(s.frc[2,18]-s.m[18]*(C18*(AlF217+BeF417*s.dpt[1,34])+S18*(AlF317+BeF717*s.dpt[1,34])))
  FA318 = -(s.frc[3,18]-s.m[18]*(C18*(AlF317+BeF717*s.dpt[1,34])-S18*(AlF217+BeF417*s.dpt[1,34])))
  ...
  FB218_4 = s.m[18]*(C18*(AlM217_4+OpM317_4*s.dpt[1,34])+S18*(AlM317_4-OpM217_4*s.dpt[1,34]))
  FB318_4 = s.m[18]*(C18*(AlM317_4-OpM217_4*s.dpt[1,34])-S18*(AlM217_4+OpM317_4*s.dpt[1,34]))
  CM118_4 = s.In[1,18]*OpM16_4
  FB218_5 = s.m[18]*(C18*(AlM217_5+OpM317_5*s.dpt[1,34])+S18*(AlM317_5-OpM217_5*s.dpt[1,34]))
  FB318_5 = s.m[18]*(C18*(AlM317_5-OpM217_5*s.dpt[1,34])-S18*(AlM217_5+OpM317_5*s.dpt[1,34]))
  CM118_5 = s.In[1,18]*C6
  FB218_6 = -s.m[18]*S16p17p18*(s.dpt[1,11]+s.dpt[1,34])
  FB318_6 = -s.m[18]*C16p17p18*(s.dpt[1,11]+s.dpt[1,34])
  FA217 = -(s.frc[2,17]-s.m[17]*(AlF217+BeF417*s.l[1,17]))
  FA317 = -(s.frc[3,17]-s.m[17]*(AlF317+BeF717*s.l[1,17]))
  FF117 = -(s.frc[1,17]+s.frc[1,18]-s.m[17]*(AlF117+BS117*s.l[1,17])-s.m[18]*(AlF117+BS117*s.dpt[1,34]))
  FF217 = FA217+FA218*C18-FA318*S18
  FF317 = FA317+FA218*S18+FA318*C18
  CF117 = -(s.trq[1,17]-CF118-s.In[1,17]*OpF16)
  CF217 = -(s.trq[2,17]-s.In[1,17]*OM117*OM317-CF218*C18+CF318*S18+FA317*s.l[1,17]+s.dpt[1,34]*(FA218*S18+FA318*C18))
  CF317 = -(s.trq[3,17]+s.In[1,17]*OM117*OM217-CF218*S18-CF318*C18-FA217*s.l[1,17]-s.dpt[1,34]*(FA218*C18-FA318*S18))
  ...
  CM217_1 = -(FB317_1*s.l[1,17]+s.dpt[1,34]*(FB218_1*S18+FB318_1*C18))
  CM317_1 = FB217_1*s.l[1,17]+s.dpt[1,34]*(FB218_1*C18-FB318_1*S18)
  ...
  CM217_2 = -(FB317_2*s.l[1,17]+s.dpt[1,34]*(FB218_2*S18+FB318_2*C18))
  CM317_2 = FB217_2*s.l[1,17]+s.dpt[1,34]*(FB218_2*C18-FB318_2*S18)
  ...
  CM217_3 = -(FB317_3*s.l[1,17]+s.dpt[1,34]*(FB218_3*S18+FB318_3*C18))
  CM317_3 = FB217_3*s.l[1,17]+s.dpt[1,34]*(FB218_3*C18-FB318_3*S18)
  ...
  CM217_4 = -(FB317_4*s.l[1,17]+s.dpt[1,34]*(FB218_4*S18+FB318_4*C18))
  CM317_4 = FB217_4*s.l[1,17]+s.dpt[1,34]*(FB218_4*C18-FB318_4*S18)
  ...
  CM117_5 = C6*(s.In[1,17]+s.In[1,18])
  CM217_5 = -(FB317_5*s.l[1,17]+s.dpt[1,34]*(FB218_5*S18+FB318_5*C18))
  CM317_5 = FB217_5*s.l[1,17]+s.dpt[1,34]*(FB218_5*C18-FB318_5*S18)
  FB217_6 = -s.m[17]*S16p17*(s.dpt[1,11]+s.l[1,17])
  FB317_6 = -s.m[17]*C16p17*(s.dpt[1,11]+s.l[1,17])
  FM117_6 = AlM117_6*(s.m[17]+s.m[18])
  FM217_6 = FB217_6+FB218_6*C18-FB318_6*S18
  FM317_6 = FB317_6+FB218_6*S18+FB318_6*C18
  CM217_6 = s.m[18]*s.dpt[1,34]*C16p17*(s.dpt[1,11]+s.dpt[1,34])-FB317_6*s.l[1,17]
  CM317_6 = FB217_6*s.l[1,17]+s.dpt[1,34]*(FB218_6*C18-FB318_6*S18)
  ...
  CF116 = -(s.trq[1,16]-CF117-s.In[1,16]*OpF16-s.In[9,16]*OM216*OM316-FA316*s.l[2,16]-s.dpt[2,30]*(FF217*S17+FF317*C17))
  CF216 = -(s.trq[2,16]-CF217*C17+CF317*S17-OM116*OM316*(s.In[1,16]-s.In[9,16]))
  CF316 = -(s.trq[3,16]+s.In[1,16]*OM116*OM216-s.In[9,16]*OpF316-CF217*S17-CF317*C17+FA116*s.l[2,16]+FF117*s.dpt[2,30])
  ...
  CM116_1 = FB316_1*s.l[2,16]+s.dpt[2,30]*(FM217_1*S17+FM317_1*C17)
  CM316_1 = CM217_1*S17+CM317_1*C17-FB116_1*s.l[2,16]-FM117_1*s.dpt[2,30]
  ...
  CM116_2 = FB316_2*s.l[2,16]+s.dpt[2,30]*(FM217_2*S17+FM317_2*C17)
  CM316_2 = CM217_2*S17+CM317_2*C17-FB116_2*s.l[2,16]-FM117_2*s.dpt[2,30]
  ...
  CM116_3 = FB316_3*s.l[2,16]+s.dpt[2,30]*(FM217_3*S17+FM317_3*C17)
  CM316_3 = CM217_3*S17+CM317_3*C17-FB116_3*s.l[2,16]-FM117_3*s.dpt[2,30]
  ...
  CM116_4 = CM117_4+s.In[1,16]*OpM16_4+FB316_4*s.l[2,16]+s.dpt[2,30]*(FM217_4*S17+FM317_4*C17)
  CM316_4 = s.In[9,16]*OpM316_4+CM217_4*S17+CM317_4*C17-FB116_4*s.l[2,16]-FM117_4*s.dpt[2,30]
  FB116_5 = s.m[16]*(AlM116_5-OpM316_5*s.l[2,16])
  FB316_5 = s.m[16]*(AlM316_5+s.l[2,16]*C6)
  ...
  CM116_5 = CM117_5+s.In[1,16]*C6+FB316_5*s.l[2,16]+s.dpt[2,30]*(FM217_5*S17+FM317_5*C17)
  CM316_5 = s.In[9,16]*OpM316_5+CM217_5*S17+CM317_5*C17-FB116_5*s.l[2,16]-FM117_5*s.dpt[2,30]
  FB116_6 = s.m[16]*(s.dpt[3,11]+s.l[2,16]*S16)
  FB316_6 = -s.m[16]*s.dpt[1,11]*C16
  CM116_6 = FB316_6*s.l[2,16]+s.dpt[2,30]*(FM217_6*S17+FM317_6*C17)
  CM116_16 = s.In[1,16]+CM117_16+s.m[16]*s.l[2,16]*s.l[2,16]+s.dpt[2,30]*s.dpt[2,30]*(s.m[17]+s.m[18])
...
# Backward Dynamics 
  ...
  FA26 = -(s.frc[2,6]-s.m[6]*(AlF25+BeF66*s.l[3,6]))
  FF16 = FA16+FF110+FF113+FF116+FF17
  FF26 = FA26+FF210*C10+FF213*C13+FF216*C16+FF27*C7-FF310*S10-FF313*S13-FF316*S16-FF37*S7
  FF36 = -(s.frc[3,6]-s.m[6]*(AlF36+BS96*s.l[3,6])-FF210*S10-FF213*S13-FF216*S16-FF27*S7-FF310*C10-FF313*C13-FF316*C16-\
   FF37*C7)
  CF16 = -(s.trq[1,6]-CF110-CF113-CF116-CF17-s.In[1,6]*OpF16+FA26*s.l[3,6]+OM26*OM36*(s.In[5,6]-s.In[9,6])-s.dpt[2,11]*(\
   ...
   S13))
  CF26 = -(s.trq[2,6]-s.In[5,6]*OpF25-CF210*C10-CF213*C13-CF216*C16-CF27*C7+CF310*S10+CF313*S13+CF316*S16+CF37*S7-FA16*\
  ...
  CF36 = -(s.trq[3,6]-s.In[9,6]*OpF36-CF210*S10-CF213*S13-CF216*S16-CF27*S7-CF310*C10-CF313*C13-CF316*C16-CF37*C7+FF110*\
  ...
  FM36_1 = s.m[6]*AlM36_1+FM210_1*S10+FM213_1*S13+FM216_1*S16+FM27_1*S7+FM310_1*C10+FM313_1*C13+FM316_1*C16+FM37_1*C7
  ...
  FM36_2 = s.m[6]*AlM36_2+FM210_2*S10+FM213_2*S13+FM216_2*S16+FM27_2*S7+FM310_2*C10+FM313_2*C13+FM316_2*C16+FM37_2*C7
  ...
  CM26_4 = CM104_211*C10+CM134_214*C13+CM164_217*C16-CM310_4*S10-CM313_4*S13-CM316_4*S16-CM37_4*S7+CM74_28*C7+FM110_4*\
   s.dpt[3,4]+FM113_4*s.dpt[3,9]+FM116_4*s.dpt[3,11]+FM17_4*s.dpt[3,1]-s.dpt[1,11]*(FM216_4*S16+FM316_4*C16)-s.dpt[1,1]*(FM27_4\
   *S7+FM37_4*C7)-s.dpt[1,4]*(FM210_4*S10+FM310_4*C10)-s.dpt[1,9]*(FM213_4*S13+FM313_4*C13)+S5*(s.In[5,6]+s.m[6]*s.l[3,6]*\
   s.l[3,6])
  CM36_4 = s.In[9,6]*OpM36_4+CM104_211*S10+CM134_214*S13+CM164_217*S16+CM310_4*C10+CM313_4*C13+CM316_4*C16+CM37_4*C7+\
   CM74_28*S7-FM110_4*s.dpt[2,4]-FM113_4*s.dpt[2,9]-FM116_4*s.dpt[2,11]-FM17_4*s.dpt[2,1]+s.dpt[1,11]*(FM216_4*C16-FM316_4*S16)\
   +s.dpt[1,1]*(FM27_4*C7-FM37_4*S7)+s.dpt[1,4]*(FM210_4*C10-FM310_4*S10)+s.dpt[1,9]*(FM213_4*C13-FM313_4*S13)
  CM26_5 = CM105_211*C10+CM135_214*C13+CM165_217*C16-CM310_5*S10-CM313_5*S13-CM316_5*S16-CM37_5*S7+CM75_28*C7+FM110_5*\
   s.dpt[3,4]+FM113_5*s.dpt[3,9]+FM116_5*s.dpt[3,11]+FM17_5*s.dpt[3,1]-s.dpt[1,11]*(FM216_5*S16+FM316_5*C16)-s.dpt[1,1]*(FM27_5\
   *S7+FM37_5*C7)-s.dpt[1,4]*(FM210_5*S10+FM310_5*C10)-s.dpt[1,9]*(FM213_5*S13+FM313_5*C13)
  CM26_6 = s.In[5,6]+s.m[6]*s.l[3,6]*s.l[3,6]-s.dpt[1,11]*(C16*(FB316_6+FM217_6*S17+FM317_6*C17)-S16*(s.m[16]*\
   s.dpt[1,11]*S16-FM217_6*C17+FM317_6*S17))-s.dpt[1,1]*(C7*(FB37_6+FM38_6)+S7*(s.m[7]*AlM27_6+FM18_6*S8+FM28_6*C8))-s.dpt[1,4]\
   *(C10*(FB310_6+FM311_6)+S10*(s.m[10]*AlM210_6+FM111_6*S11+FM211_6*C11))-s.dpt[1,9]*(C13*(FB313_6+FM214_6*S14+FM314_6*C14)-\
   S13*(s.m[13]*s.dpt[1,9]*S13-FM214_6*C14+FM314_6*S14))+s.dpt[3,11]*(FB116_6+FM117_6)+s.dpt[3,1]*(FB17_6+FM18_6*C8-FM28_6*S8)+\
   s.dpt[3,4]*(FB110_6+FM111_6*C11-FM211_6*S11)+s.dpt[3,9]*(FB113_6+FM114_6)+C10*(CM111_6*S11+CM211_6*C11)-S10*(CM311_6-FB110_6\
   *s.l[2,10]-s.dpt[2,19]*(FM111_6*C11-FM211_6*S11))+C13*(CM214_6*C14-CM314_6*S14)+S13*(s.In[9,13]*S13-CM214_6*S14-CM314_6*C14+\
   FB113_6*s.l[2,13]+FM114_6*s.dpt[2,24])+C16*(CM217_6*C17-CM317_6*S17)+S16*(s.In[9,16]*S16-CM217_6*S17-CM317_6*C17+FB116_6*\
   s.l[2,16]+FM117_6*s.dpt[2,30])+C7*(CM18_6*S8+CM28_6*C8)-S7*(CM38_6-FB17_6*s.l[2,7]-s.dpt[2,14]*(FM18_6*C8-FM28_6*S8))
  ...
  CM55_16 = C6*(CM110_5+CM113_5+CM116_5+CM17_5+s.In[1,6]*C6+s.m[6]*s.l[3,6]*s.l[3,6]*C6+s.dpt[2,11]*(FM216_5*S16+FM316_5\
   *C16)+s.dpt[2,1]*(FM27_5*S7+FM37_5*C7)+s.dpt[2,4]*(FM210_5*S10+FM310_5*C10)+s.dpt[2,9]*(FM213_5*S13+FM313_5*C13)-s.dpt[3,11]\
   *(FM216_5*C16-FM316_5*S16)-s.dpt[3,1]*(FM27_5*C7-FM37_5*S7)-s.dpt[3,4]*(FM210_5*C10-FM310_5*S10)-s.dpt[3,9]*(FM213_5*C13-\
   FM313_5*S13))+S6*(s.In[9,6]*S6+CM105_211*S10+CM135_214*S13+CM165_217*S16+CM310_5*C10+CM313_5*C13+CM316_5*C16+CM37_5*C7+\
   CM75_28*S7-FM110_5*s.dpt[2,4]-FM113_5*s.dpt[2,9]-FM116_5*s.dpt[2,11]-FM17_5*s.dpt[2,1]+s.dpt[1,11]*(FM216_5*C16-FM316_5*S16)\
   +s.dpt[1,1]*(FM27_5*C7-FM37_5*S7)+s.dpt[1,4]*(FM210_5*C10-FM310_5*S10)+s.dpt[1,9]*(FM213_5*C13-FM313_5*S13))
  ...
  FM43_35 = C5*(C6*(s.m[6]*AlM36_3+FM210_3*S10+FM213_3*S13+FM216_3*S16+FM27_3*S7+FM310_3*C10+FM313_3*C13+FM316_3*C16+\
   FM37_3*C7)-S6*(FB16_3+FM110_3+FM113_3+FM116_3+FM17_3))+S5*(FB26_3+FM210_3*C10+FM213_3*C13+FM216_3*C16+FM27_3*C7-FM310_3*S10-\
   FM313_3*S13-FM316_3*S16-FM37_3*S7)
