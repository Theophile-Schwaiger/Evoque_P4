...
# Forward Kinematics 
  ...
  ALPHA210 = C10*(ALPHA26+BETA46*s.dpt[1,4]+BETA66*s.dpt[3,4]+BS56*s.dpt[2,4])+S10*(ALPHA35+BETA76*s.dpt[1,4]+BETA86*\
   s.dpt[2,4]+BS96*s.dpt[3,4])
  ALPHA310 = C10*(ALPHA35+BETA76*s.dpt[1,4]+BETA86*s.dpt[2,4]+BS96*s.dpt[3,4])-S10*(ALPHA26+BETA46*s.dpt[1,4]+BETA66*\
  ...
  ALPHA111 = C11*(ALPHA110+BETA210*s.dpt[2,17])+S11*(ALPHA210+BS510*s.dpt[2,17])
  ALPHA211 = C11*(ALPHA210+BS510*s.dpt[2,17])-S11*(ALPHA110+BETA210*s.dpt[2,17])
  ALPHA311 = ALPHA310+BETA810*s.dpt[2,17]
  OM112 = qd[12]+OM111
  OM113 = qd[13]+OM16
  ...
  ALPHA213 = C13*(ALPHA26+BETA46*s.dpt[1,9]+BETA66*s.dpt[3,9]+BS56*s.dpt[2,9])+S13*(ALPHA35+BETA76*s.dpt[1,9]+BETA86*\
   s.dpt[2,9]+BS96*s.dpt[3,9])
  ALPHA313 = C13*(ALPHA35+BETA76*s.dpt[1,9]+BETA86*s.dpt[2,9]+BS96*s.dpt[3,9])-S13*(ALPHA26+BETA46*s.dpt[1,9]+BETA66*\
  ...
  ALPHA114 = ALPHA113+BETA213*s.dpt[2,21]
  ALPHA214 = C14*(ALPHA213+BS513*s.dpt[2,21])+S14*(ALPHA313+BETA813*s.dpt[2,21])
  ALPHA314 = C14*(ALPHA313+BETA813*s.dpt[2,21])-S14*(ALPHA213+BS513*s.dpt[2,21])
  OM115 = qd[15]+OM114
  OM116 = qd[16]+OM16
  ...
  ALPHA216 = C16*(ALPHA26+BETA46*s.dpt[1,11]+BETA66*s.dpt[3,11]+BS56*s.dpt[2,11])+S16*(ALPHA35+BETA76*s.dpt[1,11]+BETA86\
   *s.dpt[2,11]+BS96*s.dpt[3,11])
  ALPHA316 = C16*(ALPHA35+BETA76*s.dpt[1,11]+BETA86*s.dpt[2,11]+BS96*s.dpt[3,11])-S16*(ALPHA26+BETA46*s.dpt[1,11]+BETA66\
  ...
  ALPHA117 = ALPHA116+BETA216*s.dpt[2,27]
  ALPHA217 = C17*(ALPHA216+BS516*s.dpt[2,27])+S17*(ALPHA316+BETA816*s.dpt[2,27])
  ALPHA317 = C17*(ALPHA316+BETA816*s.dpt[2,27])-S17*(ALPHA216+BS516*s.dpt[2,27])
  OM118 = qd[18]+OM117
 
# Backward Dynamics 

  Fs218 = -(s.frc[2,18]-s.m[18]*(C18*(ALPHA217+BETA417*s.dpt[1,31])+S18*(ALPHA317+BETA717*s.dpt[1,31])))
  Fs318 = -(s.frc[3,18]-s.m[18]*(C18*(ALPHA317+BETA717*s.dpt[1,31])-S18*(ALPHA217+BETA417*s.dpt[1,31])))
  ...
  Fq117 = -(s.frc[1,17]+s.frc[1,18]-s.m[17]*(ALPHA117+BS117*s.l[1,17])-s.m[18]*(ALPHA117+BS117*s.dpt[1,31]))
  Fq217 = Fs217+Fs218*C18-Fs318*S18
  Fq317 = Fs317+Fs218*S18+Fs318*C18
  Cq117 = -(s.trq[1,17]-Cq118-s.In[1,17]*OMp117)
  Cq217 = -(s.trq[2,17]-s.In[1,17]*OM117*OM317-Cq218*C18+Cq318*S18+Fs317*s.l[1,17]+s.dpt[1,31]*(Fs218*S18+Fs318*C18))
  Cq317 = -(s.trq[3,17]+s.In[1,17]*OM117*OM217-Cq218*S18-Cq318*C18-Fs217*s.l[1,17]-s.dpt[1,31]*(Fs218*C18-Fs318*S18))
  ...
  Cq116 = -(s.trq[1,16]-Cq117-s.In[1,16]*OMp116-s.In[9,16]*OM216*OM316-Fs316*s.l[2,16]-s.dpt[2,27]*(Fq217*S17+Fq317*C17)\
   )
  Cq216 = -(s.trq[2,16]-Cq217*C17+Cq317*S17-OM116*OM316*(s.In[1,16]-s.In[9,16]))
  Cq316 = -(s.trq[3,16]+s.In[1,16]*OM116*OM216-s.In[9,16]*OMp316-Cq217*S17-Cq317*C17+Fq117*s.dpt[2,27]+Fs116*s.l[2,16])
  Fs215 = -(s.frc[2,15]-s.m[15]*(C15*(ALPHA214+BETA414*s.dpt[1,23])+S15*(ALPHA314+BETA714*s.dpt[1,23])))
  Fs315 = -(s.frc[3,15]-s.m[15]*(C15*(ALPHA314+BETA714*s.dpt[1,23])-S15*(ALPHA214+BETA414*s.dpt[1,23])))
  ...
  Fq114 = -(s.frc[1,14]+s.frc[1,15]-s.m[14]*(ALPHA114+BS114*s.l[1,14])-s.m[15]*(ALPHA114+BS114*s.dpt[1,23]))
  Fq214 = Fs214+Fs215*C15-Fs315*S15
  Fq314 = Fs314+Fs215*S15+Fs315*C15
  Cq114 = -(s.trq[1,14]-Cq115-s.In[1,14]*OMp114)
  Cq214 = -(s.trq[2,14]-s.In[1,14]*OM114*OM314-Cq215*C15+Cq315*S15+Fs314*s.l[1,14]+s.dpt[1,23]*(Fs215*S15+Fs315*C15))
  Cq314 = -(s.trq[3,14]+s.In[1,14]*OM114*OM214-Cq215*S15-Cq315*C15-Fs214*s.l[1,14]-s.dpt[1,23]*(Fs215*C15-Fs315*S15))
  ...
  Cq113 = -(s.trq[1,13]-Cq114-s.In[1,13]*OMp113-s.In[9,13]*OM213*OM313-Fs313*s.l[2,13]-s.dpt[2,21]*(Fq214*S14+Fq314*C14)\
   )
  Cq213 = -(s.trq[2,13]-Cq214*C14+Cq314*S14-OM113*OM313*(s.In[1,13]-s.In[9,13]))
  Cq313 = -(s.trq[3,13]+s.In[1,13]*OM113*OM213-s.In[9,13]*OMp313-Cq214*S14-Cq314*C14+Fq114*s.dpt[2,21]+Fs113*s.l[2,13])
  ...
  Fq310 = Fq311+Fs310
  Cq110 = -(s.trq[1,10]-s.In[1,10]*OMp110-Cq111*C11+Cq211*S11-Fq311*s.dpt[2,17]-Fs310*s.l[2,10])
  Cq210 = -(s.trq[2,10]-s.In[1,10]*OM110*OM310-Cq111*S11-Cq211*C11)
  Cq310 = -(s.trq[3,10]-Cq311+s.In[1,10]*OM110*OM210+Fs110*s.l[2,10]+s.dpt[2,17]*(Fq111*C11-Fq211*S11))
  ...
  Fq36 = -(s.frc[3,6]-s.m[6]*(ALPHA35+BS96*s.l[3,6])-Fq210*S10-Fq213*S13-Fq216*S16-Fq27*S7-Fq310*C10-Fq313*C13-Fq316*C16\
   -Fq37*C7)
