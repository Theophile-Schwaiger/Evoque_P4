...
# Sensor Kinematics 
    ...
    RLcp7_18 = ROcp7_47*s.dpt[2,18]
    RLcp7_28 = ROcp7_57*s.dpt[2,18]
    RLcp7_38 = ROcp7_67*s.dpt[2,18]
...
# Sensor Kinematics 
    ...
    RLcp10_111 = ROcp10_49*s.dpt[2,19]+ROcp10_710*s.dpt[3,19]
    RLcp10_211 = ROcp10_59*s.dpt[2,19]+ROcp10_810*s.dpt[3,19]
    RLcp10_311 = ROcp10_69*s.dpt[2,19]+ROcp10_910*s.dpt[3,19]
...
# Sensor Kinematics 
    ...
    RLcp11_111 = ROcp11_49*s.dpt[2,19]+ROcp11_710*s.dpt[3,19]
    RLcp11_211 = ROcp11_59*s.dpt[2,19]+ROcp11_810*s.dpt[3,19]
    RLcp11_311 = ROcp11_69*s.dpt[2,19]+ROcp11_910*s.dpt[3,19]
...
# Sensor Kinematics 
    ...
    RLcp12_18 = ROcp12_47*s.dpt[2,18]
    RLcp12_28 = ROcp12_57*s.dpt[2,18]
    RLcp12_38 = ROcp12_67*s.dpt[2,18]
...
# Sensor Kinematics 
    ...
    RLcp12_113 = ROcp12_49*s.dpt[2,20]+ROcp12_710*s.dpt[3,20]
    RLcp12_213 = ROcp12_59*s.dpt[2,20]+ROcp12_810*s.dpt[3,20]
    RLcp12_313 = ROcp12_69*s.dpt[2,20]+ROcp12_910*s.dpt[3,20]
...
# Sensor Kinematics 
    ...
    RLcp13_18 = ROcp13_47*s.dpt[2,18]
    RLcp13_28 = ROcp13_57*s.dpt[2,18]
    RLcp13_38 = ROcp13_67*s.dpt[2,18]
...
# Sensor Kinematics 
    ...
    RLcp13_113 = ROcp13_49*s.dpt[2,20]+ROcp13_710*s.dpt[3,20]
    RLcp13_213 = ROcp13_59*s.dpt[2,20]+ROcp13_810*s.dpt[3,20]
    RLcp13_313 = ROcp13_69*s.dpt[2,20]+ROcp13_910*s.dpt[3,20]
...
# Sensor Kinematics 
    ...
    RLcp15_116 = ROcp15_415*s.dpt[2,25]
    RLcp15_216 = ROcp15_515*s.dpt[2,25]
    RLcp15_316 = ROcp15_615*s.dpt[2,25]
...
# Sensor Kinematics 
    ...
    RLcp16_116 = ROcp16_415*s.dpt[2,25]
    RLcp16_216 = ROcp16_515*s.dpt[2,25]
    RLcp16_316 = ROcp16_615*s.dpt[2,25]
...
# Sensor Kinematics 
    ...
    RLcp17_116 = ROcp17_415*s.dpt[2,25]
    RLcp17_216 = ROcp17_515*s.dpt[2,25]
    RLcp17_316 = ROcp17_615*s.dpt[2,25]
...
# Sensor Kinematics 
    ...
    RLcp18_116 = ROcp18_415*s.dpt[2,25]
    RLcp18_216 = ROcp18_515*s.dpt[2,25]
    RLcp18_316 = ROcp18_615*s.dpt[2,25]
...
# Sensor Kinematics 
    ...
    RLcp18_119 = ROcp18_417*s.dpt[2,26]+ROcp18_718*s.dpt[3,26]
    RLcp18_219 = ROcp18_517*s.dpt[2,26]+ROcp18_818*s.dpt[3,26]
    RLcp18_319 = ROcp18_617*s.dpt[2,26]+ROcp18_918*s.dpt[3,26]
...
# Sensor Kinematics 
    ...
    RLcp19_116 = ROcp19_415*s.dpt[2,25]
    RLcp19_216 = ROcp19_515*s.dpt[2,25]
    RLcp19_316 = ROcp19_615*s.dpt[2,25]
...
# Sensor Kinematics 
    ...
    RLcp19_119 = ROcp19_417*s.dpt[2,26]+ROcp19_718*s.dpt[3,26]
    RLcp19_219 = ROcp19_517*s.dpt[2,26]+ROcp19_818*s.dpt[3,26]
    RLcp19_319 = ROcp19_617*s.dpt[2,26]+ROcp19_918*s.dpt[3,26]
...
# Sensor Kinematics 
    ...
    RLcp20_116 = ROcp20_415*s.dpt[2,25]
    RLcp20_216 = ROcp20_515*s.dpt[2,25]
    RLcp20_316 = ROcp20_615*s.dpt[2,25]
...
# Sensor Kinematics 
    ...
    RLcp20_121 = ROcp20_417*s.dpt[2,27]+ROcp20_718*s.dpt[3,27]
    RLcp20_221 = ROcp20_517*s.dpt[2,27]+ROcp20_818*s.dpt[3,27]
    RLcp20_321 = ROcp20_617*s.dpt[2,27]+ROcp20_918*s.dpt[3,27]
...
# Sensor Kinematics 
    ...
    RLcp21_116 = ROcp21_415*s.dpt[2,25]
    RLcp21_216 = ROcp21_515*s.dpt[2,25]
    RLcp21_316 = ROcp21_615*s.dpt[2,25]
...
# Sensor Kinematics 
    ...
    RLcp21_121 = ROcp21_417*s.dpt[2,27]+ROcp21_718*s.dpt[3,27]
    RLcp21_221 = ROcp21_517*s.dpt[2,27]+ROcp21_818*s.dpt[3,27]
    RLcp21_321 = ROcp21_617*s.dpt[2,27]+ROcp21_918*s.dpt[3,27]
...
# Sensor Kinematics 
   ...
   OMcp30_129*ROcp30_829-OMcp30_229*ROcp30_729)
    RLcp30_131 = ROcp30_430*s.dpt[2,35]
    RLcp30_231 = ROcp30_530*s.dpt[2,35]
    RLcp30_331 = ROcp30_630*s.dpt[2,35]
...
# Sensor Kinematics 
   ...
   OMcp31_129*ROcp31_829-OMcp31_229*ROcp31_729)
    RLcp31_131 = ROcp31_430*s.dpt[2,35]
    RLcp31_231 = ROcp31_530*s.dpt[2,35]
    RLcp31_331 = ROcp31_630*s.dpt[2,35]
...
# Sensor Kinematics 
   ...
   OMcp32_129*ROcp32_829-OMcp32_229*ROcp32_729)
    RLcp32_131 = ROcp32_430*s.dpt[2,35]
    RLcp32_231 = ROcp32_530*s.dpt[2,35]
    RLcp32_331 = ROcp32_630*s.dpt[2,35]
...
# Sensor Kinematics 
   ...
   OMcp33_129*ROcp33_829-OMcp33_229*ROcp33_729)
    RLcp33_131 = ROcp33_430*s.dpt[2,35]
    RLcp33_231 = ROcp33_530*s.dpt[2,35]
    RLcp33_331 = ROcp33_630*s.dpt[2,35]
...
# Sensor Kinematics 
    ...
    RLcp33_134 = ROcp33_433*s.dpt[2,36]+ROcp33_732*s.dpt[3,36]
    RLcp33_234 = ROcp33_533*s.dpt[2,36]+ROcp33_832*s.dpt[3,36]
    RLcp33_334 = ROcp33_633*s.dpt[2,36]+ROcp33_932*s.dpt[3,36]
...
# Sensor Kinematics 
   ...
   OMcp34_129*ROcp34_829-OMcp34_229*ROcp34_729)
    RLcp34_131 = ROcp34_430*s.dpt[2,35]
    RLcp34_231 = ROcp34_530*s.dpt[2,35]
    RLcp34_331 = ROcp34_630*s.dpt[2,35]
...
# Sensor Kinematics 
    ...
    RLcp34_134 = ROcp34_433*s.dpt[2,36]+ROcp34_732*s.dpt[3,36]
    RLcp34_234 = ROcp34_533*s.dpt[2,36]+ROcp34_832*s.dpt[3,36]
    RLcp34_334 = ROcp34_633*s.dpt[2,36]+ROcp34_932*s.dpt[3,36]
...
# Sensor Kinematics 
   ...
   OMcp35_129*ROcp35_829-OMcp35_229*ROcp35_729)
    RLcp35_131 = ROcp35_430*s.dpt[2,35]
    RLcp35_231 = ROcp35_530*s.dpt[2,35]
    RLcp35_331 = ROcp35_630*s.dpt[2,35]
...
# Sensor Kinematics 
    ...
    RLcp35_136 = ROcp35_433*s.dpt[2,37]+ROcp35_732*s.dpt[3,37]
    RLcp35_236 = ROcp35_533*s.dpt[2,37]+ROcp35_832*s.dpt[3,37]
    RLcp35_336 = ROcp35_633*s.dpt[2,37]+ROcp35_932*s.dpt[3,37]
...
# Sensor Kinematics 
   ...
   OMcp36_129*ROcp36_829-OMcp36_229*ROcp36_729)
    RLcp36_131 = ROcp36_430*s.dpt[2,35]
    RLcp36_231 = ROcp36_530*s.dpt[2,35]
    RLcp36_331 = ROcp36_630*s.dpt[2,35]
...
# Sensor Kinematics 
    ...
    RLcp36_136 = ROcp36_433*s.dpt[2,37]+ROcp36_732*s.dpt[3,37]
    RLcp36_236 = ROcp36_533*s.dpt[2,37]+ROcp36_832*s.dpt[3,37]
    RLcp36_336 = ROcp36_633*s.dpt[2,37]+ROcp36_932*s.dpt[3,37]
...
# Sensor Kinematics 
   ...
   OMcp41_140*ROcp41_840-OMcp41_240*ROcp41_740)
    RLcp41_142 = ROcp41_441*s.dpt[2,44]
    RLcp41_242 = ROcp41_541*s.dpt[2,44]
    RLcp41_342 = ROcp41_641*s.dpt[2,44]
...
# Sensor Kinematics 
   ...
   OMcp42_140*ROcp42_840-OMcp42_240*ROcp42_740)
    RLcp42_142 = ROcp42_441*s.dpt[2,44]
    RLcp42_242 = ROcp42_541*s.dpt[2,44]
    RLcp42_342 = ROcp42_641*s.dpt[2,44]
...
# Sensor Kinematics 
   ...
   OMcp43_140*ROcp43_840-OMcp43_240*ROcp43_740)
    RLcp43_142 = ROcp43_441*s.dpt[2,44]
    RLcp43_242 = ROcp43_541*s.dpt[2,44]
    RLcp43_342 = ROcp43_641*s.dpt[2,44]
...
# Sensor Kinematics 
   ...
   OMcp44_140*ROcp44_840-OMcp44_240*ROcp44_740)
    RLcp44_142 = ROcp44_441*s.dpt[2,44]
    RLcp44_242 = ROcp44_541*s.dpt[2,44]
    RLcp44_342 = ROcp44_641*s.dpt[2,44]
...
# Sensor Kinematics 
    ...
    RLcp44_145 = ROcp44_444*s.dpt[2,47]+ROcp44_743*s.dpt[3,47]
    RLcp44_245 = ROcp44_544*s.dpt[2,47]+ROcp44_843*s.dpt[3,47]
    RLcp44_345 = ROcp44_644*s.dpt[2,47]+ROcp44_943*s.dpt[3,47]
...
# Sensor Kinematics 
   ...
   OMcp45_140*ROcp45_840-OMcp45_240*ROcp45_740)
    RLcp45_142 = ROcp45_441*s.dpt[2,44]
    RLcp45_242 = ROcp45_541*s.dpt[2,44]
    RLcp45_342 = ROcp45_641*s.dpt[2,44]
...
# Sensor Kinematics 
    ...
    RLcp45_145 = ROcp45_444*s.dpt[2,47]+ROcp45_743*s.dpt[3,47]
    RLcp45_245 = ROcp45_544*s.dpt[2,47]+ROcp45_843*s.dpt[3,47]
    RLcp45_345 = ROcp45_644*s.dpt[2,47]+ROcp45_943*s.dpt[3,47]
...
# Sensor Kinematics 
   ...
   OMcp46_140*ROcp46_840-OMcp46_240*ROcp46_740)
    RLcp46_142 = ROcp46_441*s.dpt[2,44]
    RLcp46_242 = ROcp46_541*s.dpt[2,44]
    RLcp46_342 = ROcp46_641*s.dpt[2,44]
...
# Sensor Kinematics 
    ...
    RLcp46_147 = ROcp46_444*s.dpt[2,48]+ROcp46_743*s.dpt[3,48]
    RLcp46_247 = ROcp46_544*s.dpt[2,48]+ROcp46_843*s.dpt[3,48]
    RLcp46_347 = ROcp46_644*s.dpt[2,48]+ROcp46_943*s.dpt[3,48]
...
# Sensor Kinematics 
   ...
   OMcp47_140*ROcp47_840-OMcp47_240*ROcp47_740)
    RLcp47_142 = ROcp47_441*s.dpt[2,44]
    RLcp47_242 = ROcp47_541*s.dpt[2,44]
    RLcp47_342 = ROcp47_641*s.dpt[2,44]
...
# Sensor Kinematics 
    ...
    RLcp47_147 = ROcp47_444*s.dpt[2,48]+ROcp47_743*s.dpt[3,48]
    RLcp47_247 = ROcp47_544*s.dpt[2,48]+ROcp47_843*s.dpt[3,48]
    RLcp47_347 = ROcp47_644*s.dpt[2,48]+ROcp47_943*s.dpt[3,48]
...
# Sensor Kinematics 
    ...
    RLcp49_150 = ROcp49_46*s.dpt[2,52]
    RLcp49_250 = ROcp49_56*s.dpt[2,52]
    RLcp49_350 = ROcp49_66*s.dpt[2,52]
...
# Sensor Kinematics 
    ...
    RLcp50_150 = ROcp50_46*s.dpt[2,52]
    RLcp50_250 = ROcp50_56*s.dpt[2,52]
    RLcp50_350 = ROcp50_66*s.dpt[2,52]
...
# Sensor Kinematics 
    ...
    RLcp51_152 = ROcp51_46*s.dpt[2,53]
    RLcp51_252 = ROcp51_56*s.dpt[2,53]
    RLcp51_352 = ROcp51_66*s.dpt[2,53]
...
# Sensor Kinematics 
    ...
    RLcp52_152 = ROcp52_46*s.dpt[2,53]
    RLcp52_252 = ROcp52_56*s.dpt[2,53]
    RLcp52_352 = ROcp52_66*s.dpt[2,53]
...
# Sensor Kinematics 
   ...
   OMcp55_154*ROcp55_56-OMcp55_254*ROcp55_46)
    RLcp55_156 = ROcp55_155*s.dpt[1,57]+ROcp55_46*s.dpt[2,57]
    RLcp55_256 = ROcp55_255*s.dpt[1,57]+ROcp55_56*s.dpt[2,57]
    RLcp55_356 = ROcp55_355*s.dpt[1,57]+ROcp55_66*s.dpt[2,57]
...
# Sensor Kinematics 
   ...
   OMcp56_154*ROcp56_56-OMcp56_254*ROcp56_46)
    RLcp56_156 = ROcp56_155*s.dpt[1,57]+ROcp56_46*s.dpt[2,57]
    RLcp56_256 = ROcp56_255*s.dpt[1,57]+ROcp56_56*s.dpt[2,57]
    RLcp56_356 = ROcp56_355*s.dpt[1,57]+ROcp56_66*s.dpt[2,57]
...
# Sensor Kinematics 
    ...
    RLcp57_158 = ROcp57_154*s.dpt[1,56]+ROcp57_46*s.dpt[2,56]
    RLcp57_258 = ROcp57_254*s.dpt[1,56]+ROcp57_56*s.dpt[2,56]
    RLcp57_358 = ROcp57_354*s.dpt[1,56]+ROcp57_66*s.dpt[2,56]
...
# Sensor Kinematics 
    ...
    RLcp58_158 = ROcp58_154*s.dpt[1,56]+ROcp58_46*s.dpt[2,56]
    RLcp58_258 = ROcp58_254*s.dpt[1,56]+ROcp58_56*s.dpt[2,56]
    RLcp58_358 = ROcp58_354*s.dpt[1,56]+ROcp58_66*s.dpt[2,56]
...
# Sensor Kinematics 
   ...
   OMcp61_160*ROcp61_56-OMcp61_260*ROcp61_46)
    RLcp61_162 = ROcp61_161*s.dpt[1,61]+ROcp61_46*s.dpt[2,61]
    RLcp61_262 = ROcp61_261*s.dpt[1,61]+ROcp61_56*s.dpt[2,61]
    RLcp61_362 = ROcp61_361*s.dpt[1,61]+ROcp61_66*s.dpt[2,61]
...
# Sensor Kinematics 
   ...
   OMcp62_160*ROcp62_56-OMcp62_260*ROcp62_46)
    RLcp62_162 = ROcp62_161*s.dpt[1,61]+ROcp62_46*s.dpt[2,61]
    RLcp62_262 = ROcp62_261*s.dpt[1,61]+ROcp62_56*s.dpt[2,61]
    RLcp62_362 = ROcp62_361*s.dpt[1,61]+ROcp62_66*s.dpt[2,61]
...
# Sensor Kinematics 
    ...
    RLcp63_164 = ROcp63_160*s.dpt[1,60]+ROcp63_46*s.dpt[2,60]
    RLcp63_264 = ROcp63_260*s.dpt[1,60]+ROcp63_56*s.dpt[2,60]
    RLcp63_364 = ROcp63_360*s.dpt[1,60]+ROcp63_66*s.dpt[2,60]
...
# Sensor Kinematics 
    ...
    RLcp64_164 = ROcp64_160*s.dpt[1,60]+ROcp64_46*s.dpt[2,60]
    RLcp64_264 = ROcp64_260*s.dpt[1,60]+ROcp64_56*s.dpt[2,60]
    RLcp64_364 = ROcp64_360*s.dpt[1,60]+ROcp64_66*s.dpt[2,60]
